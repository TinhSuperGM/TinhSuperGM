...
task.spawn(function()
	while task.wait(0.5) do
		...
		pcall(function()
			...
			-- Nếu quà trong balo thì trang bị rồi mở
...
local mobDisplayMap = {
    ...
    ["Arctic Warrior"] = "Chiến Binh Cực Bắc",
    ["Snow Lurker"] = "Lẩn Trốn Tuyết",
    ["Sea Soldier"] = "Binh Sĩ Biển",
    ["Water Fighter"] = "Chiến Binh Nước",
    ["Pirate Millionaire"] = "Triệu Phú Cướp Biển",
    ["Dragon Crew Warrior"] = "Chiến Binh Phi Đội Rồng",
    ["Dragon Crew Archer"] = "Xạ Thủ Phi Đội Rồng",
    ["Female Islander"] = "Người Đảo Nữ",
    ["Giant Islander"] = "Người Đảo Khổng Lồ",
    ["Marine Commodore"] = "Chuẩn Đô Đốc Hải Quân",
    ["Marine Rear Admiral"] = "Phó Đô Đốc Hải Quân",
    ["Fishman Raider"] = "Kẻ Xâm Lược Người Cá",
    ["Fishman Captain"] = "Thuyền Trưởng Người Cá",
    ["Forest Pirate"] = "Cướp Rừng",
    ["Mythological Pirate"] = "Cướp Thần Thoại",
    ["Jungle Pirate"] = "Cướp Rừng Nhiệt Đới",
    ["Musketeer Pirate"] = "Cướp Pháo Thủ",
    ["Reborn Skeleton"] = "Bộ Xương Hồi Sinh",
    ["Living Zombie"] = "Xác Sống Phục Sinh",
    ["Demonic Soul"] = "Linh Hồn Quỷ",
    ["Posessed Mummy"] = "Xác Ướp Bị Nhập",
    ...
    ["Cookie Crafter"] = "Người Làm Bánh Quy",
    ["Cake Guard"] = "Vệ Binh Bánh Ngọt",
    ["Baking Staff"] = "Nhân Viên Làm Bánh",
    ["Head Baker"] = "Bếp Trưởng",
    ["Cocoa Warrior"] = "Chiến Binh Ca Cao",
    ["Chocolate Bar Battle"] = "Chiến Binh Thanh Socola",
    ["Sweet Thief"] = "Kẻ Trộm Kẹo",
    ["Candy Rebel"] = "Nổi Loạn Kẹo",
    ["Candy Pirate"] = "Cướp Kẹo",
    ["Snow Demon"] = "Ác Quỷ Tuyết",
    ["Isle Outlaw"] = "Ngoại Lệ Đảo",
    ["Island Boy"] = "Cậu Bé Đảo",
    ["Sun-kissed Warrior"] = "Chiến Binh Nắng",
