...
do
	ply = game["Người chơi"]
	plr = ply["Người chơi cục bộ"]
	Root = plr["Character"]["HumanoidRootPart"]
	replicated = game:GetService("ReplicatedStorage")
	Lv = game["Người chơi"]["Người chơi cục bộ"]["Data"]["Cấp"]["Giá trị"]
	TeleportService = game:GetService("TeleportService")
	TW = game:GetService("TweenService")
	Lighting = game:GetService("Lighting")
	Enemies = workspace["Kẻ thù"]
	vim1 = game:GetService("VirtualInputManager")
	vim2 = game:GetService("VirtualUser")
	TeamSelf = plr["Đội"]
	RunSer = game:GetService("RunService")
	Stats = game:GetService("Stats")
	Energy = plr["Character"]["Energy"]["Giá trị"]
	BringConnections = {}
	BossList = {}
	MaterialList = {}
	NPCList = {}
...
repeat
	local L_2_ = {}
	L_2_[2] = (plr["PlayerGui"]:WaitForChild("Chính")):WaitForChild("Đang tải") and game:IsLoaded()
	wait()
until L_2_[2]
...
L_1_[24] = {
	["Mob"] = "Mythological Hải tặc",
	["Mob2"] = "Cursed Bộ xương",
	"Hell's Messenger";
	["Mob3"] = "Cursed Bộ xương";
	"Heaven's Guardian"
}
L_1_[26] = {
	"Part",
...
L_1_[22] = {
	["Hải tặc Triệu phú"] = CFrame["new"](-712.82727050781, 98.577049255371, 5711.9541015625);
	["Pistol Billionaire"] = CFrame["new"](-723.43316650391, 147.42906188965, 5931.9931640625);
	["Rồng Đội Chiến binh"] = CFrame["new"](7021.5043945312, 55.762702941895, -730.12908935547);
	["Rồng Đội Xạ thủ"] = CFrame["new"](6625, 378, 244);
	["Nữ Người đảo"] = CFrame["new"](4692.7939453125, 797.97668457031, 858.84802246094),
	["Độc Kẻ tấn công"] = CFrame["new"](4902, 670, 39),
	["Hải quân Chuẩn đô đốc"] = CFrame["new"](2401, 123, -7589);
	["Hải quân Rear Admiral"] = CFrame["new"](3588, 229, -7085);
	["Fishman Raider"] = CFrame["new"](-10941, 332, -8760);
	["Fishman Captain"] = CFrame["new"](-11035, 332, -9087);
	["Forest Hải tặc"] = CFrame["new"](-13446, 413, -7760),
	["Mythological Hải tặc"] = CFrame["new"](-13510, 584, -6987);
	["Jungle Hải tặc"] = CFrame["new"](-11778, 426, -10592);
	["Musketeer Hải tặc"] = CFrame["new"](-13282, 496, -9565);
	["Tái sinh Bộ xương"] = CFrame["new"](-8764, 142, 5963);
	...
	["Bánh quy Thợ làm"] = CFrame["new"](-2021, 38, -12028);
	["Cake Guard"] = CFrame["new"](-2024, 38, -12026),
	["Baking Staff"] = CFrame["new"](-1932, 38, -12848),
	["Head Baker"] = CFrame["new"](-1932, 38, -12848);
	["Cocoa Chiến binh"] = CFrame["new"](95, 73, -12309);
	[L_1_[2]({
...
L_1_[4]["Alive"] = function(L_10_arg0)
	...
	return L_11_[3] and L_11_[3]["Máu"] > 0
end
...
L_1_[4]["Giết"] = function(L_21_arg0, L_22_arg1)
	local L_23_ = {}
	...
	if L_23_[1] and L_23_[3] then
		...
		L_24_[2] = game["Người chơi"]["Người chơi cục bộ"]["Character"]:FindFirstChildOfClass("Tool")
...
L_1_[4]["Giết2"] = function(L_25_arg0, L_26_arg1)
	local L_27_ = {}
	...
	if L_27_[1] and L_27_[2] then
		...
		BringEnemy()
		EquipWeapon(_G["SelectWeapon"])
		L_28_[1] = game["Người chơi"]["Người chơi cục bộ"]["Character"]:FindFirstChildOfClass("Tool")
...
L_1_[4]["KillSea"] = function(L_29_arg0, L_30_arg1)
	...
	if L_31_[2] and L_31_[1] then
		...
		BringEnemy()
		EquipWeapon(_G["SelectWeapon"])
		L_32_[1] = game["Người chơi"]["Người chơi cục bộ"]["Character"]:FindFirstChildOfClass("Tool")
...
L_1_[4]["Mas"] = function(L_36_arg0, L_37_arg1)
	...
	if L_38_[2] and L_38_[3] then
		...
		BringEnemy()
		if L_38_[2]["Humanoid"]["Máu"] <= HealthM then
...
L_1_[4]["Masgun"] = function(L_39_arg0, L_40_arg1)
	...
	if L_41_[3] and L_41_[1] then
		...
		BringEnemy()
		if L_41_[3]["Humanoid"]["Máu"] <= HealthM then
...
statsSetings = function(L_42_arg0, L_43_arg1)
	...
	if L_44_[3] == "Melee" then
		if plr["Data"]["Points"]["Giá trị"] ~= 0 then
			replicated["Remotes"]["CommF_"]:InvokeServer("AddPoint", "Melee", L_44_[2])
		end
	elseif L_44_[3] == "Phòng thủ" then
		if plr["Data"]["Points"]["Giá trị"] ~= 0 then
			replicated["Remotes"]["CommF_"]:InvokeServer("AddPoint", "Phòng thủ", L_44_[2])
		end
...
BringEnemy = function()
	...
	L_45_[4] = game["Người chơi"]["Người chơi cục bộ"]
	...
	L_45_[1] = 0
	L_45_[2] = {}
	for L_46_forvar0, L_47_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
		local L_48_ = {}
		...
		if not(L_48_[2] and (L_48_[3] and L_48_[2]["Máu"] > 0)) then
			continue
		end
		if (L_48_[3]["Position"] - L_45_[5]["Position"])["Magnitude"] <= L_45_[8] then
			...
			L_52_[3] = 0
			for L_53_forvar0, L_54_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
				local L_55_ = {}
				...
				if L_55_[4] and (L_55_[1] and (L_55_[4]["Máu"] > 0 and L_55_[5]["Name"] == L_48_[1]["Name"])) then
	...
	if tostring(L_61_[2]) == "FireServer" then
		if tostring(L_61_[1][1]) == "RemoteEvent" then
			if tostring(L_61_[1][2]) ~= "true" and tostring(L_61_[1][2]) ~= "false" then
				if _G["FarmMastery_G"] and not SoulGuitar or _G["FarmMastery_Dev"] or _G["FarmBlazeEM"] or _G["Prehis_Skills"] or _G["SeaBeast1"] or _G["FishBoat"] or _G["PGB"] or _G["Leviathan1"] or _G["Complete_Trials"] or _G["AimMethod"] and ABmethod == "Aim Người chơi" or _G["AimMethod"] and ABmethod == "Nearest Aim" then
					L_61_[1][2] = MousePos
...
GetConnectionEnemies = function(L_62_arg0)
	...
	for L_64_forvar0, L_65_forvar1 in pairs(replicated:GetChildren()) do
		...
		if L_66_[1]:IsA("Model") and ((typeof(L_63_[1]) == "table" and table["find"](L_63_[1], L_66_[1]["Name"]) or L_66_[1]["Name"] == L_63_[1]) and (L_66_[1]:FindFirstChild("Humanoid") and L_66_[1]["Humanoid"]["Máu"] > 0)) then
			return L_66_[1]
		end
	end
	for L_67_forvar0, L_68_forvar1 in next, game["Workspace"]["Kẻ thù"]:GetChildren() do
		local L_69_ = {}
		L_69_[2], L_69_[3] = L_67_forvar0, L_68_forvar1
		if L_69_[3]:IsA("Model") and ((typeof(L_63_[1]) == "table" and table["find"](L_63_[1], L_69_[3]["Name"]) or L_69_[3]["Name"] == L_63_[1]) and (L_69_[3]:FindFirstChild("Humanoid") and L_69_[3]["Humanoid"]["Máu"] > 0)) then
			return L_69_[3]
		end
	end
end
LowCpu = function()
	...
	(settings())["Rendering"]["QualityLevel"] = "Cấp01"
...
CheckF = function()
	if GetBP("Rồng-Rồng") or GetBP("Gas-Gas") or GetBP("Yeti-Yeti") or GetBP("Kitsune-Kitsune") or GetBP("T-Rex-T-Rex") then
		return true
	end
end
CheckBoat = function()
	for L_77_forvar0, L_78_forvar1 in pairs(workspace["Boats"]:GetChildren()) do
		...
		if tostring(L_79_[3]["Chủ sở hữu"]["Giá trị"]) == tostring(plr["Name"]) then
			return L_79_[3]
		end
	end
	return false
...
CheckEnemiesBoat = function()
	for L_80_forvar0, L_81_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
		local L_82_ = {}
		L_82_[1], L_82_[2] = L_80_forvar0, L_81_forvar1
		if L_82_[2]["Name"] == "FishBoat" and (L_82_[2]:FindFirstChild("Máu"))["Giá trị"] > 0 then
			return true
		end
	end
	return false
...
CheckPirateGrandBrigade = function()
	for L_83_forvar0, L_84_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
		local L_85_ = {}
		L_85_[2], L_85_[1] = L_83_forvar0, L_84_forvar1
		if (L_85_[1]["Name"] == "PirateGrandBrigade" or L_85_[1]["Name"] == "PirateBrigade") and (L_85_[1]:FindFirstChild("Máu"))["Giá trị"] > 0 then
			return true
		end
	end
	return false
...
CheckShark = function()
	for L_86_forvar0, L_87_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
		local L_88_ = {}
...
CheckTerrorShark = function()
	for L_89_forvar0, L_90_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
		local L_91_ = {}
...
CheckPiranha = function()
	for L_92_forvar0, L_93_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
		local L_94_ = {}
...
CheckFishCrew = function()
	for L_95_forvar0, L_96_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
		local L_97_ = {}
		L_97_[3], L_97_[2] = L_95_forvar0, L_96_forvar1
		if (L_97_[2]["Name"] == "Fish Đội Member" or L_97_[2]["Name"] == "Haunted Đội Member") and L_1_[4]["Alive"](L_97_[2]) then
			return true
		end
	end
	return false
...
CheckHauntedCrew = function()
	for L_98_forvar0, L_99_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
		local L_100_ = {}
		L_100_[3], L_100_[2] = L_98_forvar0, L_99_forvar1
		if L_100_[2]["Name"] == "Haunted Đội Member" and L_1_[4]["Alive"](L_100_[2]) then
			return true
		end
	end
	return false
...
DropFruits = function()
	for L_110_forvar0, L_111_forvar1 in next, plr["Backpack"]:GetChildren() do
		...
		if string["find"](L_112_[2]["Name"], "Fruit") then
			...
			wait(.1)
			if plr["PlayerGui"]["Chính"]["Dialogue"]["Visible"] == true then
				plr["PlayerGui"]["Chính"]["Dialogue"]["Visible"] = false
			end
			EquipWeapon(L_112_[2]["Name"]);
					...
					for L_139_forvar0, L_140_forvar1 in next, getupvalues(L_138_[3]) do
						...
						if typeof(L_141_[1]) == "table" then
							repeat
								wait(Sec)
								L_141_[1]["LastUse"] = 0
							until not L_135_[1] or plr["Character"]["Humanoid"]["Máu"] <= 0
						end
					end
				end
			end
...
task["sinh"](function()
	local L_148_ = {}
	L_148_[1] = game["Người chơi"]["Người chơi cục bộ"]
	repeat
		task["wait"]()
...
spawn(function()
	while task["wait"]() do
		pcall(function()
			if _G["SailBoat_Hydra"] or _G["WardenBoss"] or _G["AutoFactory"] or _G["HighestMirage"] or _G["HCM"] or _G["PGB"] or _G["Leviathan1"] or _G["UPGDrago"] or _G["Complete_Trials"] or _G["TpDrago_Prehis"] or _G["BuyDrago"] or _G["AutoFireFlowers"] or _G["DT_Uzoth"] or _G["AutoBerry"] or _G["Prefully"] or _G["Prehis_Find"] or _G["Prehis_Skills"] or _G["Prehis_DB"] or _G["Prehis_DE"] or _G["FarmBlazeEM"] or _G["Dojoo"] or _G["CollectPresent"] or _G["AutoLawKak"] or _G["TpLab"] or _G["AutoPhoenixF"] or _G["AutoFarmChest"] or _G["AutoHytHallow"] or _G["LongsWord"] or _G["BlackSpikey"] or _G["AutoHolyTorch"] or _G["TrainDrago"] or _G["AutoSaber"] or _G["FarmMastery_Dev"] or _G["CitizenQuest"] or _G["AutoEctoplasm"] or _G["KeysRen"] or _G["Tự động_Rainbow_Haki"] or _G["obsFarm"] or _G["AutoBigmom"] or _G["Doughv2"] or _G["AuraBoss"] or _G["Raiding"] or _G["Tự động_Cavender"] or _G["TpPly"] or _G["Bartilo_Nhiệm vụ"] or _G["Cấp"] or _G["FarmEliteHunt"] or _G["AutoZou"] or _G["AutoFarm_Bone"] or (getgenv())["AutoMaterial"] or _G["CraftVM"] or _G["FrozenTP"] or _G["TPDoor"] or _G["AcientOne"] or _G["AutoFarmNear"] or _G["AutoRaidCastle"] or _G["DarkBladev3"] or _G["AutoFarmRaid"] or _G["Tự động_Cake_Prince"] or _G["Addealer"] or _G["TPNpc"] or _G["TwinHook"] or _G["FindMirage"] or _G["FarmChestM"] or _G["Shark"] or _G["TerrorShark"] or _G["Piranha"] or _G["MobCrew"] or _G["SeaBeast1"] or _G["FishBoat"] or _G["AutoPole"] or _G["AutoPoleV2"] or _G["Tự động_SuperHuman"] or _G["AutoDeathStep"] or _G["Tự động_SharkMan_Karate"] or _G["Tự động_Electric_Claw"] or _G["AutoDragonTalon"] or _G["Tự động_Def_DarkCoat"] or _G["Tự động_God_Human"] or _G["Tự động_Tushita"] or _G["AutoMatSoul"] or _G["AutoKenVTWO"] or _G["AutoSerpentBow"] or _G["AutoFMon"] or _G["Tự động_Soul_Guitar"] or _G["TPGEAR"] or _G["AutoSaw"] or _G["AutoTridentW2"] or _G["AutoEvoRace"] or _G["AutoGetQuestBounty"] or _G["MarinesCoat"] or _G["TravelDres"] or _G["Defeating"] or _G["DummyMan"] or _G["Tự động_Yama"] or _G["Tự động_SwanGG"] or _G["SwanCoat"] or _G["AutoEcBoss"] or _G["Tự động_Mink"] or _G["Tự động_Human"] or _G["Tự động_Skypiea"] or _G["Tự động_Fish"] or _G["CDK_TS"] or _G["CDK_YM"] or _G["CDK"] or _G["AutoFarmGodChalice"] or _G["AutoFistDarkness"] or _G["AutoMiror"] or _G["Dịch chuyển"] or _G["AutoKilo"] or _G["AutoGetUsoap"] or _G["Praying"] or _G["TryLucky"] or _G["AutoColShad"] or _G["AutoUnHaki"] or _G["Tự động_DonAcces"] or _G["AutoRipIngay"] or _G["DragoV3"] or _G["DragoV1"] or _G["SailBoats"] or NextIs or _G["FarmGodChalice"] or _G["IceBossRen"] or senth or senth2 or _G["Lvthan"] or _G["beasthunter"] or _G["DangerLV"] or _G["Relic123"] or _G["tweenKitsune"] or _G["Collect_Ember"] or _G["AutofindKitIs"] or _G["snaguine"] or _G["TwFruits"] or _G["tweenKitShrine"] or _G["Tp_LgS"] or _G["Tp_MasterA"] or _G["tweenShrine"] or _G["FarmMastery_G"] or _G["FarmMastery_S"] or _G["FarmBoss"] or _G["AutoFarmAllBoss"] or _G["AutoFishSlap"] or _G["FarmTyrant"] or _G["FarmPhaBinh"] or _G["AutoSpawnCP"] or _G["AutoBerryH"] or _G["AutoChestBP"] or _G["FarmEliteHop"] or _G["AutoHop_Dough"] or _G["AutoDoughKing"] or _G["AutoAttackDoughKing"] or _G["AutoChipFruit"] or _G["AutoChipBeli"] or _G["StartEvent"] or _G["AutoMysticIsland"] or _G["AutoPlayerHunter"] or _G["SafeMode"] or _G["AutoKillMob"] or _G["AutoStartPrehistoric"] or _G["AutoUnHaki"] or _G["AutoAttackRipIndra"] or _G["AutoFarmIsland"] or _G["AutoFarmDungeon"] or _G["AutoFarmCandy"] or _G["AutoTP_Gift"] or _G["AutoTPGift"] or _G["AutoTPAndCollect"] or _G["MasterAutoLevel"] or _G["MasterAutoCandy"] or _G["TPFloor1"] or _G["TPFloor2"] or _G["TPFloor3"] or _G["TPFloor4"] then
				shouldTween = true
...
QuestB = function()
	...
	if World3 then
		...
		elseif _G["FindBoss"] == "Beautiful Hải tặc" then
			bMon = "Beautiful Hải tặc"
...
QuestCheck = function()
	local L_172_ = {}
	L_172_[2] = game["Người chơi"]["Người chơi cục bộ"]["Data"]["Cấp"]["Giá trị"]
	if World1 then
		...
		elseif L_172_[2] == 375 or L_172_[2] <= 399 then
			Mon = "Fishman Chiến binh"
			Qdata = 1
			Qname = "FishmanQuest"
			NameMon = "Fishman Chiến binh"
			...
			if _G["Cấp"] and (PosQ["Position"] - game["Người chơi"]["Người chơi cục bộ"]["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] > 10000 then
	...
	elseif World2 then
		...
		elseif L_172_[2] == 875 or L_172_[2] <= 899 then
			Mon = "Hải quân Lieutenant"
			Qdata = 1
			Qname = "MarineQuest3"
			NameMon = "Hải quân Lieutenant"
		...
		elseif L_172_[2] == 900 or L_172_[2] <= 949 then
			Mon = "Hải quân Captain"
			Qdata = 2
			Qname = "MarineQuest3"
			NameMon = "Hải quân Captain"
			PosQ = CFrame["new"](-2440.79639, 71.7140732, -3216.06812, .866007268, 0, .500031412, 0, 1, 0, -0.500031412, 0, .866007268)
		...
		elseif L_172_[2] == 1050 or L_172_[2] <= 1099 then
			Mon = "Winter Chiến binh"
			Qdata = 2
			Qname = "SnowMountainQuest"
			NameMon = "Winter Chiến binh"
			PosQ = CFrame["new"](609.858826, 400.119904, -5372.25928, -0.374604106, 0, .92718488, 0, 1, 0, -0.92718488, 0, -0.374604106)
		...
		elseif L_172_[2] == 1125 or L_172_[2] <= 1174 then
			Mon = "Horned Chiến binh"
			Qdata = 2
			Qname = "IceSideQuest"
			NameMon = "Horned Chiến binh"
			PosQ = CFrame["new"](-6064.06885, 15.2422857, -4902.97852, .453972578, 0, -0.891015649, 0, 1, 0, .891015649, 0, .453972578)
		...
		elseif L_172_[2] == 1250 or L_172_[2] <= 1274 then
			...
			if _G["Cấp"] and (PosQ["Position"] - game["Người chơi"]["Người chơi cục bộ"]["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] > 500 then
		...
		elseif L_172_[2] == 1350 or L_172_[2] <= 1374 then
			Mon = "Arctic Chiến binh"
			Qdata = 1
			Qname = "FrostQuest"
			NameMon = "Arctic Chiến binh"
			...
			if _G["Cấp"] and (PosQ["Position"] - game["Người chơi"]["Người chơi cục bộ"]["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] > 1000 then
				BTP(PosM)
			end
	...
	elseif World3 then
		if L_172_[2] == 1500 or L_172_[2] <= 1524 then
			Mon = "Hải tặc Triệu phú"
			Qdata = 1
			Qname = "PiratePortQuest"
			NameMon = "Hải tặc Triệu phú"
		...
		elseif L_172_[2] == 1575 or L_172_[2] <= 1599 then
			Mon = "Rồng Đội Chiến binh"
			Qdata = 1
			Qname = "DragonCrewQuest"
			NameMon = "Rồng Đội Chiến binh"
		...
		elseif L_172_[2] == 1700 or L_172_[2] <= 1724 then
			Mon = "Hải quân Chuẩn đô đốc"
			Qdata = 1
			Qname = "MarineTreeIsland"
			NameMon = "Hải quân Chuẩn đô đốc"
		...
		elseif L_172_[2] == 1725 or L_172_[2] <= 1774 then
			Mon = "Hải quân Rear Admiral"
			NameMon = "Hải quân Rear Admiral"
			Qname = "MarineTreeIsland"
			Qdata = 2
		...
		elseif L_172_[2] == 1850 or L_172_[2] <= 1899 then
			Mon = "Mythological Hải tặc"
			Qdata = 2
			Qname = "DeepForestIsland"
			NameMon = "Mythological Hải tặc"
			PosQ = CFrame["new"](-13234.04, 331.488495, -7625.40137, .707134247, 0, -0.707079291, 0, 1, 0, .707079291, 0, .707134247)
		...
		elseif L_172_[2] == 2200 or L_172_[2] <= 2224 then
			Mon = "Bánh quy Thợ làm"
			Qdata = 1
			Qname = "CakeQuest1"
			NameMon = "Bánh quy Thợ làm"
		...
		elseif L_172_[2] == 2300 or L_172_[2] <= 2324 then
			Mon = "Cocoa Chiến binh"
			Qdata = 1
			Qname = "ChocQuest1"
			NameMon = "Cocoa Chiến binh"
		...
		elseif L_172_[2] == 2500 or L_172_[2] <= 2524 then
			Mon = "Sun-kissed Chiến binh"
			Qdata = 1
			Qname = "TikiQuest2"
			NameMon = "kissed Chiến binh"
...
MaterialMon = function()
	local L_173_ = {}
	L_173_[2] = game["Người chơi"]["Người chơi cục bộ"]
	...
	elseif World3 then
		...
		elseif SelectMaterial == "Conjured Cocoa" then
			...
			SP = "Default"
		elseif SelectMaterial == "Rồng Scale" then
			MMon = {
				"Rồng Đội Xạ thủ";
				"Rồng Đội Chiến binh"
			}
...
L_1_[16] = (loadstring(game:HttpGet(L_1_[2]({
	...
	"s/chính/UiRedzHub.lua"
}))))()
L_1_[38] = L_1_[16]:MakeWindow({
	["Title"] = "TinhSuper Trung Tâm";
	["SubTitle"] = "by TinhSuper",
	["SaveFolder"] = "TinhSuper_Trung Tâm.json"
})
...
L_1_[93] = {
	["Thông tin"] = L_1_[38]:MakeTab({
		["Title"] = "Tab Chính";
		["Icon"] = "Thông tin"
	});
	["Chính"] = L_1_[38]:MakeTab({
		["Title"] = "Tab Cày cấp";
		["Icon"] = L_1_[2]({
			"rbxassetid://7733960";
			"981"
...
L_1_[93]["Thông tin"]:AddSection("Information")
L_1_[93]["Thông tin"]:AddDiscordInvite({
	["Name"] = "TinhSuper Trung tâm",
	["Description"] = L_1_[2]({
		"Release Date [6/1/";
		"2026]"
	}),
...
L_1_[93]["Thông tin"]:AddSection("Status Máy chủ")
Time = L_1_[93]["Thông tin"]:AddParagraph({
	["Title"] = "Time Zone";
	["Content"] = ""
})
function UpdateOS()
	...
	L_190_[8] = string["format"]("%02i:%02i:%02i %s", (L_190_[4] - 1) % 12 + 1, L_190_[6]["tối thiểu"], L_190_[6]["sec"], L_190_[3])
	...
	L_190_[1] = game:GetService("Người chơi")
	L_190_[10] = L_190_[1]["Người chơi cục bộ"]
...
Timmessss = L_1_[93]["Thông tin"]:AddParagraph({
	["Title"] = "Time",
	["Content"] = ""
})
function UpdateTime()
...
Miragecheck = L_1_[93]["Thông tin"]:AddParagraph({
	["Title"] = "Mirage Island";
	["Content"] = "Status: "
})
L_1_[77] = ""
...
Kitsunecheck = L_1_[93]["Thông tin"]:AddParagraph({
...
CPrehistoriccheck = L_1_[93]["Thông tin"]:AddParagraph({
...
FrozenIsland = L_1_[93]["Thông tin"]:AddParagraph({
...
MobCakePrince = L_1_[93]["Thông tin"]:AddParagraph({
	["Title"] = "Dimension Đã bị giết",
	["Content"] = ""
})
spawn(function()
	while wait(1) do
		...
		if string["len"](L_199_[2]) >= 86 then
			...
			L_199_[3] = "Giết: " .. L_200_[1]
		end
		MobCakePrince:SetDesc(L_199_[3])
	end
end)
CheckRip = L_1_[93]["Thông tin"]:AddParagraph({
	["Title"] = "Rip_Indra";
	["Content"] = "Status: "
})
spawn(function()
	...
	while wait(1) do
		local L_202_ = {}
		L_202_[1] = (game:GetService("ReplicatedStorage")):FindFirstChild("rip_indra True Form") or (game:GetService("Workspace"))["Kẻ thù"]:FindFirstChild("rip_indra") and "✅️" or "❌️"
...
CheckDoughKing = L_1_[93]["Thông tin"]:AddParagraph({
	["Title"] = "Dough King";
	["Content"] = "Status: "
})
spawn(function()
	...
	while wait(1) do
		local L_204_ = {}
		L_204_[2] = (game:GetService("ReplicatedStorage")):FindFirstChild("Dough King") or (game:GetService("Workspace"))["Kẻ thù"]:FindFirstChild("Dough King") and "✅️" or "❌️"
...
EliteHunter = L_1_[93]["Thông tin"]:AddParagraph({
	["Title"] = "Elite Hunter";
	["Content"] = "Status: "
})
spawn(function()
	...
	while wait(1) do
		local L_206_ = {}
		L_206_[3] = ((game:GetService("ReplicatedStorage")):FindFirstChild("Diablo") or (game:GetService("ReplicatedStorage")):FindFirstChild("Deandre") or (game:GetService("ReplicatedStorage")):FindFirstChild("Urban") or (game:GetService("Workspace"))["Kẻ thù"]:FindFirstChild("Diablo") or (game:GetService("Workspace"))["Kẻ thù"]:FindFirstChild("Deandre") or (game:GetService("Workspace"))["Kẻ thù"]:FindFirstChild("Urban")) and "✅️" or "❌️"
		L_206_[1] = (game:GetService("ReplicatedStorage"))["Remotes"]["CommF_"]:InvokeServer("EliteHunter", "Progress")
		if L_206_[3] ~= L_205_[1] then
			EliteHunter:SetDesc("Status: " .. (L_206_[3] .. (" | Đã bị giết: " .. L_206_[1])))
			L_205_[1] = L_206_[3]
		end
	end
end)
FM = L_1_[93]["Thông tin"]:AddParagraph({
	["Title"] = "Full Moon",
	["Content"] = ""
})
task["sinh"](function()
...
LegendarySword = L_1_[93]["Thông tin"]:AddParagraph({
...
StatusBone = L_1_[93]["Thông tin"]:AddParagraph({
	["Title"] = "Bone";
	["Content"] = ""
})
spawn(function()
...
WeaponDropdown = L_1_[93]["Chính"]:AddDropdown({
	["Name"] = "Chọn Weapon",
	["Options"] = {
		"Melee";
		"Sword",
...
AttackDropdown = L_1_[93]["Chính"]:AddDropdown({
	["Name"] = "Chọn Fast Delay";
	["Options"] = {
		"Normal Tấn công",
		"Fast Tấn công",
		"Super Fast Tấn công";
...
L_1_[54] = {
	["Normal Tấn công"] = .25,
	["Fast Tấn công"] = .15;
	["Super Fast Tấn công"] = .05,
	["TinhSuper Tấn công"] = .1
}
spawn(function()
	while task["wait"](.1) do
		pcall(function()
...
L_1_[93]["Chính"]:AddSection({
	"Farming"
})
FarmLevel = L_1_[93]["Chính"]:AddToggle({
	...
	while task["wait"](Sec) do
		if _G["Cấp"] then
			pcall(function()
				...
				L_229_[7] = plr["Data"]["Cấp"]["Giá trị"]
				L_229_[2] = L_1_[112]()
				L_229_[1] = plr["PlayerGui"]["Chính"]["Nhiệm vụ"]
				...
				if L_229_[7] >= 2600 and (not L_229_[2] and (not L_1_[133] and not L_1_[44])) then
					...
					repeat
						...
						_tp(L_230_[1])
						L_230_[3] = L_230_[3] + 1
					until not _G["Cấp"] or (L_229_[6]["Position"] - L_230_[1]["Position"])["Magnitude"] <= 8 or L_230_[3] > 20
					if not _G["Cấp"] then
						L_1_[133] = false
						return
					end
					...
					until not _G["Cấp"] or tick() - L_230_[4] > 15
					task["wait"](2)
					L_1_[44] = true
					L_1_[133] = false
				elseif L_229_[2] or L_229_[7] < 2600 then
					...
					if not L_229_[1]["Visible"] then
						...
						L_234_[2] = false
						for L_235_forvar0, L_236_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
							local L_237_ = {}
							...
							if L_1_[4]["Alive"](L_237_[1]) and L_237_[1]["Name"] == L_234_[3] then
								...
								repeat
									...
									L_1_[4]["Giết"](L_237_[1], _G["Cấp"])
								until not _G["Cấp"] or not L_237_[1]["Parent"] or L_237_[1]["Humanoid"]["Máu"] <= 0 or not L_229_[1]["Visible"]
								break
							end
						end
...
ClosetMons = L_1_[93]["Chính"]:AddToggle({
	["Name"] = "Tự động Cày Nearest";
	["Description"] = "",
	["Default"] = false,
	...
	while wait() do
		pcall(function()
			if _G["AutoFarmNear"] then
				for L_240_forvar0, L_241_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
					local L_242_ = {}
					...
					if L_242_[1]:FindFirstChild("Humanoid") or L_242_[1]:FindFirstChild("HumanoidRootPart") then
						if L_242_[1]["Humanoid"]["Máu"] > 0 then
							repeat
								wait()
								L_1_[4]["Giết"](L_242_[1], _G["AutoFarmNear"])
							until not _G["AutoFarmNear"] or not L_242_[1]["Parent"] or L_242_[1]["Humanoid"]["Máu"] <= 0
						end
					end
				end
			end
...
FactoryRaids = L_1_[93]["Chính"]:AddToggle({
	["Name"] = "Tự động Factory Raid";
	["Description"] = "",
	["Default"] = false,
	...
	while wait(Sec) do
		pcall(function()
			if _G["AutoFactory"] then
				local L_245_ = {}
				L_245_[2] = GetConnectionEnemies("Lõi")
				if L_245_[2] then
					repeat
						wait()
						EquipWeapon(_G["SelectWeapon"])
						_tp(CFrame["new"](448.46756, 199.356781, -441.389252))
					until L_245_[2]["Humanoid"]["Máu"] <= 0 or _G["AutoFactory"] == false
				else
					_tp(CFrame["new"](448.46756, 199.356781, -441.389252))
				end
			end
...
CastleRaids = L_1_[93]["Chính"]:AddToggle({
	["Name"] = "Tự động Hải tặc Raid",
	["Description"] = "";
	["Default"] = false;
		...
		if _G["AutoRaidCastle"] then
			pcall(function()
				...
				if ((CFrame["new"](-5539.3115234375, 313.80053710938, -2972.3723144531))["Position"] - Root["Position"])["Magnitude"] <= 500 then
					for L_249_forvar0, L_250_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
						local L_251_ = {}
						L_251_[3], L_251_[2] = L_249_forvar0, L_250_forvar1
						if L_251_[2]:FindFirstChild("HumanoidRootPart") and (L_251_[2]:FindFirstChild("Humanoid") and L_251_[2]["Humanoid"]["Máu"] > 0) then
							if L_251_[2]["Name"] then
								if (L_251_[2]["HumanoidRootPart"]["Position"] - Root["Position"])["Magnitude"] <= 2000 then
									repeat
										wait()
										L_1_[4]["Giết"](L_251_[2], _G["AutoRaidCastle"])
									until not _G["AutoRaidCastle"] or not L_251_[2]["Parent"] or L_251_[2]["Humanoid"]["Máu"] <= 0 or not workspace["Kẻ thù"]:FindFirstChild(L_251_[2]["Name"])
								end
							end
						end
					end
		...
		pcall(function()
			if _G["AutoEctoplasm"] then
				...
				if L_1_[4]["Alive"](L_260_[2]) then
					repeat
						wait()
						L_1_[4]["Giết"](L_260_[2], _G["AutoEctoplasm"])
					until not _G["AutoEctoplasm"] or not L_260_[2]["Parent"] or L_260_[2]["Humanoid"]["Máu"] <= 0
				else
					replicated["Remotes"]["CommF_"]:InvokeServer("requestEntrance", Vector3["new"](923.21252441406, 126.9760055542, 32852.83203125))
				end
			end
...
L_1_[125] = function()
	...
	pcall(function()
		if plr["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] then
			replicated["Remotes"]["CommF_"]:InvokeServer("AbandonQuest")
			task["wait"](.5)
		end
		...
		elseif L_261_[1] == "GiftMap3" then
			task["sinh"](function()
				local L_264_ = {}
				L_264_[1] = (game:GetService("Người chơi"))["Người chơi cục bộ"]
...
L_1_[136] = (game:GetService("Người chơi"))["Người chơi cục bộ"]
	...
	while task["wait"](.1) do
		if _G["MasterAutoCandy"] and _G["AutoFarmCandy"] then
			pcall(function()
				...
				L_281_[1] = L_1_[136]["Data"]["Cấp"]["Giá trị"]
				L_281_[5] = L_1_[124]()
				...
				elseif L_281_[5] or L_281_[1] < 2600 then
					...
					L_284_[3] = nil
					L_284_[2] = 1000
					for L_285_forvar0, L_286_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
						local L_287_ = {}
						L_287_[1], L_287_[2] = L_285_forvar0, L_286_forvar1
						if L_287_[2]:FindFirstChild("Humanoid") and (L_287_[2]["Humanoid"]["Máu"] > 0 and L_287_[2]:FindFirstChild("HumanoidRootPart")) then
							local L_288_ = {}
					...
					if L_284_[3] then
						repeat
							...
							L_1_[4]["Giết"](L_284_[3], _G["AutoFarmCandy"])
						until not _G["AutoFarmCandy"] or not L_284_[3]["Parent"] or L_284_[3]["Humanoid"]["Máu"] <= 0 or (L_281_[4]["Position"] - L_284_[3]["HumanoidRootPart"]["Position"])["Magnitude"] > 1100
					else
						local L_289_ = {}
...
Countdown = L_1_[93]["Chính"]:AddParagraph({
	...
	while wait(Sec) do
		if _G["AutoFarmCandy"] then
			pcall(function()
				...
				L_294_[2] = L_1_[136]["Data"]["Cấp"]["Giá trị"]
				L_294_[4] = L_1_[124]()
				...
				elseif L_294_[4] or L_294_[2] < 2600 then
					...
					L_298_[3] = nil
					L_298_[2] = 1000
					for L_299_forvar0, L_300_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
						local L_301_ = {}
						L_301_[2], L_301_[3] = L_299_forvar0, L_300_forvar1
						if L_301_[3]:FindFirstChild("Humanoid") and (L_301_[3]["Humanoid"]["Máu"] > 0 and L_301_[3]:FindFirstChild("HumanoidRootPart")) then
							local L_302_ = {}
					...
					if L_298_[3] then
						repeat
							...
							L_1_[4]["Giết"](L_298_[3], _G["AutoFarmCandy"])
						until not _G["AutoFarmCandy"] or not L_298_[3]["Parent"] or L_298_[3]["Humanoid"]["Máu"] <= 0 or (L_294_[5]["Position"] - L_298_[3]["HumanoidRootPart"]["Position"])["Magnitude"] > 1100
					else
						local L_303_ = {}
...
L_1_[93]["Chính"]:AddToggle({
	["Name"] = "Tự động Collect Gift",
	["Description"] = "Chọn Map",
	["Default"] = false;
...
task["sinh"](function()
	...
	while task["wait"](.3) do
		...
		L_314_[3] = game["Người chơi"]["Người chơi cục bộ"]
...
task["sinh"](function()
	while task["wait"](.5) do
		...
		pcall(function()
			local L_322_ = {}
			L_322_[3] = (game:GetService("Người chơi"))["Người chơi cục bộ"]
...
AutoStoreGift = L_1_[93]["Chính"]:AddToggle({
	["Name"] = "Tự động Store Gift",
	["Description"] = "",
	["Default"] = false,
...
L_1_[93]["Chính"]:AddButton({
	["Name"] = "Mua 200 Frangments",
...
ChestTW = L_1_[93]["Chính"]:AddToggle({
	["Name"] = "Tự động Cày Rương",
	["Description"] = "";
	["Default"] = false,
	...
	while wait(Sec) do
		if _G["AutoFarmChest"] then
			pcall(function()
				...
				L_349_[2] = game:GetService("Người chơi")
				L_349_[5] = L_349_[2]["Người chơi cục bộ"]
...
ChestBP = L_1_[93]["Chính"]:AddToggle({
	["Name"] = "Tự động Rương Bypass";
	["Description"] = "",
	["Default"] = false;
	["Callback"] = function(L_352_arg0)
		...
		if L_353_[1] then
			local L_354_ = {}
			L_354_[5] = (game:GetService("Người chơi"))["Người chơi cục bộ"]
			L_354_[1] = false
			L_354_[3] = {}
			L_354_[2] = true
			L_354_[8] = function()
			...
			L_354_[6] = function()
				...
				if L_354_[2] then
					...
					for L_356_forvar0, L_357_forvar1 in pairs(game:GetDescendants()) do
						...
						if L_358_[3]["Name"]:find("Rương") and L_358_[3]["ClassName"] == "Part" then
				...
				table["sắp xếp"](L_355_[3], function(L_362_arg0, L_363_arg1)
					local L_364_ = {}
...
Berry = L_1_[93]["Chính"]:AddToggle({
	["Name"] = "Tự động Cày Berry";
	["Description"] = "";
	["Default"] = false;
...
spawn(function()
	while wait(Sec) do
		if _G["AutoBerry"] then
			...
			L_371_[1] = game:GetService("Người chơi")
			L_371_[3] = L_371_[1]["Người chơi cục bộ"]
...
BerryH = L_1_[93]["Chính"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động Cày Berry + Ho",
		"p"
	}),
	["Description"] = "";
	["Default"] = false,
...
spawn(function()
	while wait(Sec) do
		if _G["AutoBerryH"] then
			...
			L_384_[1] = game:GetService("Người chơi")
			L_384_[4] = L_384_[1]["Người chơi cục bộ"]
...
if World3 then
	L_1_[93]["Chính"]:AddDropdown({
		...
		["Options"] = {
			...
			"Nữ Người đảo",
			"Giant Người đảo";
			"Hải quân Chuẩn đô đốc";
			"Hải quân Rear Admiral",
			"Fishman Raider",
			"Fishman Captain",
			"Forest Hải tặc",
			"Mythological Hải tặc",
...
spawn(function()
	while wait() do
		if _G["AutoKillMob"] then
			pcall(function()
				if (game:GetService("Workspace"))["Kẻ thù"]:FindFirstChild((getgenv())["SelectMob"]) then
					for L_407_forvar0, L_408_forvar1 in pairs((game:GetService("Workspace"))["Kẻ thù"]:GetChildren()) do
						local L_409_ = {}
						L_409_[3], L_409_[1] = L_407_forvar0, L_408_forvar1
						if L_409_[1]["Name"] == (getgenv())["SelectMob"] then
							if L_409_[1]:FindFirstChild("Humanoid") and (L_409_[1]:FindFirstChild("HumanoidRootPart") and L_409_[1]["Humanoid"]["Máu"] > 0) then
								repeat
									(game:GetService("RunService"))["Heartbeat"]:Wait()
									L_1_[4]["Giết"](L_409_[1], _G["AutoKillMob"])
								until not _G["AutoKillMob"] or not L_409_[1]["Parent"] or L_409_[1]["Humanoid"]["Máu"] <= 0
							end
						end
					end
				end
...
task["sinh"](function()
	while task["wait"](.2) do
		...
		L_418_[4] = false
		for L_422_forvar0, L_423_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
			local L_424_ = {}
			L_424_[3], L_424_[2] = L_422_forvar0, L_423_forvar1
			if L_418_[5][L_424_[2]["Name"]] and (L_424_[2]:FindFirstChild("Humanoid") and (L_424_[2]:FindFirstChild("HumanoidRootPart") and L_424_[2]["Humanoid"]["Máu"] > 0)) then
				L_418_[4] = true
				repeat
					task["wait"]()
					_tp(L_424_[2]["HumanoidRootPart"]["CFrame"] * CFrame["new"](0, 10, 0))
					L_1_[4]["Giết"](L_424_[2], true)
				until not _G["AutoFarmIsland"] or not L_424_[2]["Parent"] or L_424_[2]["Humanoid"]["Máu"] <= 0
			end
		end
...
Process = L_1_[93]["Chính"]:AddParagraph({
...
EliteHunter = L_1_[93]["Chính"]:AddParagraph({
	["Title"] = "Elite Sinh";
	["Content"] = "Status: "
})
spawn(function()
	...
	while wait(1) do
		local L_426_ = {}
		L_426_[3] = ((game:GetService("ReplicatedStorage")):FindFirstChild("Diablo") or (game:GetService("ReplicatedStorage")):FindFirstChild("Deandre") or (game:GetService("ReplicatedStorage")):FindFirstChild("Urban") or (game:GetService("Workspace"))["Kẻ thù"]:FindFirstChild("Diablo") or (game:GetService("Workspace"))["Kẻ thù"]:FindFirstChild("Deandre") or (game:GetService("Workspace"))["Kẻ thù"]:FindFirstChild("Urban")) and "✅️" or "❌️"
		L_426_[1] = (game:GetService("ReplicatedStorage"))["Remotes"]["CommF_"]:InvokeServer("EliteHunter", "Progress")
		if L_426_[3] ~= L_425_[2] then
			EliteHunter:SetDesc("Status: " .. (L_426_[3] .. (" | Đã bị giết: " .. L_426_[1])))
			L_425_[2] = L_426_[3]
		end
	end
end)
EliteQ = L_1_[93]["Chính"]:AddToggle({
	["Name"] = "Tự động Cày Elite";
	["Description"] = "",
	["Default"] = false,
	...
	while wait(1) do
		pcall(function()
			if _G["FarmEliteHunt"] then
				local L_429_ = {}
				L_429_[2] = L_1_[136]["PlayerGui"]["Chính"]["Nhiệm vụ"]
				...
				if not L_429_[2]["Visible"] then
					...
					if L_431_[2] then
						...
						if L_435_[2] and L_435_[2]:FindFirstChild("HumanoidRootPart") then
							...
							repeat
								wait()
								L_1_[4]["Giết"](L_435_[2], _G["FarmEliteHunt"])
							until not _G["FarmEliteHunt"] or not L_435_[2]["Parent"] or L_435_[2]["Humanoid"]["Máu"] <= 0 or not L_429_[2]["Visible"]
						else
							wait(5)
						end
					else
...
EliteH = L_1_[93]["Chính"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động Cày Elite + Ho";
		"p"
	}),
	["Description"] = "";
	["Default"] = false;
	...
	while task["wait"](1) do
		pcall(function()
			if _G["FarmEliteH"] then
				local L_450_ = {}
				L_450_[2] = L_1_[136]["PlayerGui"]["Chính"]["Nhiệm vụ"]
				...
				if not L_450_[2]["Visible"] then
					...
					if L_452_[1] then
						...
						for L_460_forvar0, L_461_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
							local L_462_ = {}
						...
						if L_456_[1] and L_456_[1]:FindFirstChild("HumanoidRootPart") then
							...
							repeat
								wait()
								L_1_[4]["Giết"](L_456_[1], _G["FarmEliteH"])
							until not _G["FarmEliteH"] or not L_456_[1]["Parent"] or L_456_[1]["Humanoid"]["Máu"] <= 0 or not L_450_[2]["Visible"]
						else
							task["wait"](5)
							L_1_[35]()
						end
	...
	while wait(Sec) do
		pcall(function()
			if _G["AutoRipIngay"] then
				...
				if not GetWP("Tối Dagger") or not GetIn("Valkyrie") and L_465_[2] then
					repeat
						wait()
						L_1_[4]["Giết"](L_465_[2], _G["AutoRipIngay"])
					until not _G["AutoRipIngay"] or not L_465_[2]["Parent"] or L_465_[2]["Humanoid"]["Máu"] <= 0
				else
...
MobKilled = L_1_[93]["Chính"]:AddParagraph({
	["Title"] = "Cake Princes :";
	["Content"] = ""
})
spawn(function()
	while wait(.2) do
		pcall(function()
			...
			if L_479_[1] then
				MobKilled:SetDesc(" Đã bị giết : " .. 500 - L_479_[1])
			end
		end)
	end
end)
Cake = L_1_[93]["Chính"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động Cày Cake Princ",
		"e"
	}),
	["Description"] = "",
	["Default"] = false,
	["Callback"] = function(L_480_arg0)
		local L_481_ = {}
		L_481_[2] = L_480_arg0
		_G["Tự động_Cake_Prince"] = L_481_[2]
	end
})
spawn(function()
	while task["wait"]() do
		if _G["Tự động_Cake_Prince"] and not _G["AutoRaidCastle"] then
			pcall(function()
				local L_482_ = {}
				L_482_[4] = game["Người chơi"]["Người chơi cục bộ"]
				L_482_[6] = L_482_[4]["Character"] and L_482_[4]["Character"]:FindFirstChild("HumanoidRootPart")
				L_482_[3] = L_482_[4]["PlayerGui"]["Chính"]["Nhiệm vụ"]
				L_482_[5] = workspace["Kẻ thù"]
				...
				if L_482_[7] and (L_482_[7]["Other"]["Transparency"] == 0 or L_482_[5]:FindFirstChild("Cake Prince")) then
					...
					if L_484_[1] then
						repeat
							task["wait"]()
							L_1_[4]["Giết2"](L_484_[1], _G["Tự động_Cake_Prince"])
						until not _G["Tự động_Cake_Prince"] or not L_484_[1]["Parent"] or L_484_[1]["Humanoid"]["Máu"] <= 0
					else
					...
					if L_485_[2] then
						repeat
							task["wait"]()
							L_1_[4]["Giết"](L_485_[2], _G["Tự động_Cake_Prince"])
						until not _G["Tự động_Cake_Prince"] or not L_485_[2]["Parent"] or L_485_[2]["Humanoid"]["Máu"] <= 0 or L_482_[7] and L_482_[7]["Other"]["Transparency"] == 0
					else
						_tp(CFrame["new"](-2077, 252, -12373))
					end
				end
...
CakeQ = L_1_[93]["Chính"]:AddToggle({
	["Name"] = "Accept Nhiệm vụ";
	["Description"] = "";
	["Default"] = false;
...
CakeSM = L_1_[93]["Chính"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động Summon Cake Pri",
		"nce"
	}),
	["Description"] = "";
	["Default"] = false;
			...
			pcall(function()
				...
				elseif GetConnectionEnemies("Dough King") then
					...
					if L_493_[1] then
						repeat
							task["wait"]()
							L_1_[4]["Giết"](L_493_[1], _G["AutoDoughKing"])
						until not _G["AutoDoughKing"] or not L_493_[1]["Parent"] or L_493_[1]["Humanoid"]["Máu"] <= 0
					else
				...
				if GetM("Conjured Cocoa") <= 10 then
					...
					if L_494_[2] then
						repeat
							task["wait"]()
							L_1_[4]["Giết"](L_494_[2], _G["AutoDoughKing"])
						until _G["AutoDoughKing"] == false or not L_494_[2]["Parent"] or L_494_[2]["Humanoid"]["Máu"] <= 0
					else
		...
		if _G["AutoAttackDoughKing"] then
			pcall(function()
				...
				if L_497_[1] then
					repeat
						task["wait"]()
						L_1_[4]["Giết"](L_497_[1], _G["AutoAttackDoughKing"])
					until not _G["AutoAttackDoughKing"] or not L_497_[1]["Parent"] or L_497_[1]["Humanoid"]["Máu"] <= 0
				else
...
L_1_[116] = function()
	pcall(function()
		...
		if #L_500_[1] > 0 then
			(game:GetService("TeleportService")):TeleportToPlaceInstance(game["PlaceId"], L_500_[1][math["random"](1, #L_500_[1])], game["Người chơi"]["Người chơi cục bộ"])
		end
	end)
end
spawn(function()
		...
		if _G["AutoHop_Dough"] then
			pcall(function()
				...
				if L_504_[2] then
					repeat
						task["wait"]()
						L_1_[4]["Giết"](L_504_[2], _G["AutoHop_Dough"])
					until not _G["AutoHop_Dough"] or not L_504_[2]["Parent"] or L_504_[2]["Humanoid"]["Máu"] <= 0
				else
					local L_505_ = {}
					_tp(CFrame["new"](-1943.6765, 251.5095, -12337.8809))
					task["wait"](2)
...
DouD = L_1_[93]["Chính"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động Unlock Dough du";
		"ngeon"
	}),
	["Description"] = "";
	["Default"] = false;
			...
			pcall(function()
				...
				elseif GetConnectionEnemies("Dough King") then
					...
					if L_508_[2] then
						repeat
							wait()
							L_1_[4]["Giết"](L_508_[2], _G["Doughv2"])
						until not _G["Doughv2"] or not L_508_[2]["Parent"] or L_508_[2]["Humanoid"]["Máu"] <= 0
					else
						_tp(CFrame["new"](-1943.6765136719, 251.50956726074, -12337.880859375))
					end
				end
				...
				if GetM("Conjured Cocoa") <= 10 then
					...
					if L_509_[3] then
						repeat
							wait()
							L_1_[4]["Giết"](L_509_[3], _G["Doughv2"])
						until _G["Doughv2"] == false or not L_509_[3]["Parent"] or L_509_[3]["Humanoid"]["Máu"] <= 0
					else
						_tp(CFrame["new"](402.71890258789, 81.060501098633, -12259.54296875))
					end
				end
...
PhoD = L_1_[93]["Chính"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động Unlock Phoenix ";
		"dungeon"
	});
	["Description"] = "",
	["Default"] = false;
		...
		if _G["AutoPhoenixF"] then
			pcall(function()
				if GetBP("Bird-Bird: Phoenix") then
					if L_1_[136]["Backpack"]:FindFirstChild(L_1_[136]["Data"]["DevilFruit"]["Giá trị"]) then
						if (L_1_[136]["Backpack"]:FindFirstChild(L_1_[136]["Data"]["DevilFruit"]["Giá trị"]))["Cấp"]["Giá trị"] >= 400 then
					...
					elseif L_1_[136]["Character"]:FindFirstChild(L_1_[136]["Data"]["DevilFruit"]["Giá trị"]) then
						if (L_1_[136]["Character"]:FindFirstChild(L_1_[136]["Data"]["DevilFruit"]["Giá trị"]))["Cấp"]["Giá trị"] >= 400 then
							_tp(CFrame["new"](-2812.7670898438, 254.80346679688, -12595.560546875))
							if ((CFrame["new"](-2812.7670898438, 254.80346679688, -12595.560546875))["Position"] - L_1_[136]["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] <= 10 then
								L_1_[18]["Remotes"]["CommF_"]:InvokeServer("SickScientist", "Check")
								L_1_[18]["Remotes"]["CommF_"]:InvokeServer("SickScientist", "Heal")
...
CheckingBone = L_1_[93]["Chính"]:AddParagraph({
	["Title"] = " Bones :",
	["Content"] = ""
})
spawn(function()
...
spawn(function()
	local L_514_ = {}
	L_514_[1] = game["Người chơi"]["Người chơi cục bộ"]
	L_514_[3] = {
		"Tái sinh Bộ xương";
		"Living Zombie",
		"Demonic Soul",
	...
	while wait(.5) do
		...
		pcall(function()
			...
			L_515_[1] = L_514_[1]["PlayerGui"]:FindFirstChild("Chính") and L_514_[1]["PlayerGui"]["Chính"]:FindFirstChild("Nhiệm vụ")
			...
			if L_515_[2] then
				repeat
					wait()
					L_1_[4]["Giết"](L_515_[2], true)
				until not _G["AutoFarm_Bone"] or not L_515_[2]["Parent"] or L_515_[2]["Humanoid"]["Máu"] <= 0
			else
		...
		if _G["AutoHytHallow"] then
			pcall(function()
				...
				if L_521_[2] then
					repeat
						task["wait"]()
						L_1_[4]["Giết"](L_521_[2], _G["AutoHytHallow"])
					until L_521_[2]["Humanoid"]["Máu"] <= 0 or _G["AutoHytHallow"] == false
				else
					if not GetBP("Hallow Essence") then
						repeat
							task["wait"](.1)
							L_1_[18]["Remotes"]["CommF_"]:InvokeServer("Bones", "Mua", 1, 1)
...
RanBone = L_1_[93]["Chính"]:AddToggle({
	["Name"] = "Tự động Random Bones",
	["Description"] = "",
	["Default"] = false;
	["Callback"] = function(L_522_arg0)
		local L_523_ = {}
		L_523_[1] = L_522_arg0
		_G["Tự động_Random_Bone"] = L_523_[1]
	end
})
spawn(function()
	while wait(Sec) do
		pcall(function()
			if _G["Tự động_Random_Bone"] then
				repeat
					task["wait"]()
					L_1_[18]["Remotes"]["CommF_"]:InvokeServer("Bones", "Mua", 1, 1)
				until not _G["Tự động_Random_Bone"]
			end
		end)
	end
end)
Lucky = L_1_[93]["Chính"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động Try Luck Graves",
		"tone"
	}),
	["Description"] = "";
	["Default"] = false;
...
Pray = L_1_[93]["Chính"]:AddToggle({
	["Name"] = "Tự động Pray Gravestone";
	["Description"] = "",
	["Default"] = false;
...
TyrantStatus = L_1_[93]["Chính"]:AddParagraph({
	["Title"] = "Trùm Sinh",
	["Content"] = ""
})
spawn(function()
	pcall(function()
		while wait(1) do
			if workspace["Kẻ thù"]:FindFirstChild("Tyrant of the Skies") then
...
EyeStatus = L_1_[93]["Chính"]:AddParagraph({
...
FarmTyrant = L_1_[93]["Chính"]:AddToggle({
	["Name"] = "Tự động Cày Trùm";
	["Description"] = "",
	["Default"] = false,
	...
	while wait(Sec) do
		if _G["FarmTyrant"] then
			pcall(function()
				...
				L_538_[4] = workspace["Kẻ thù"]:FindFirstChild("Tyrant of the Skies")
				if L_538_[4] and (L_538_[4]:FindFirstChild("Humanoid") and L_538_[4]["Humanoid"]["Máu"] > 0) then
					repeat
						if not _G["FarmTyrant"] then
							break
						end
						if L_1_[4] and L_1_[4]["Giết"] then
							L_1_[4]["Giết"](L_538_[4], _G["FarmTyrant"])
						end
						wait()
					until not _G["FarmTyrant"] or not L_538_[4]["Parent"] or L_538_[4]["Humanoid"]["Máu"] <= 0
					return
				end
				L_538_[5] = {
					"Serpent Hunter";
				...
				for L_539_forvar0, L_540_forvar1 in ipairs(L_538_[5]) do
					...
					for L_542_forvar0, L_543_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
						local L_544_ = {}
						L_544_[2], L_544_[3] = L_542_forvar0, L_543_forvar1
						if not _G["FarmTyrant"] then
							break
						end
						if L_544_[3] and (L_544_[3]["Name"] == L_541_[2] and (L_544_[3]:FindFirstChild("HumanoidRootPart") and (L_544_[3]:FindFirstChild("Humanoid") and L_544_[3]["Humanoid"]["Máu"] > 0))) then
							...
							repeat
								...
								if L_1_[4] and L_1_[4]["Giết"] then
									L_1_[4]["Giết"](L_544_[3], _G["FarmTyrant"])
								end
								wait()
							until not _G["FarmTyrant"] or not L_544_[3]["Parent"] or L_544_[3]["Humanoid"]["Máu"] <= 0
						end
					end
				end
			end)
...
FarmPhaBinh = L_1_[93]["Chính"]:AddToggle({
	["Name"] = "Tự động Summon Trùm";
	["Description"] = "",
	["Default"] = false;
...
L_1_[3] = function(L_550_arg0)
	...
	if not(L_551_[2] and (L_551_[2]:FindFirstChild("Humanoid") and L_551_[2]["Humanoid"]["Máu"] > 0)) then
		return
	end
...
spawn(function()
	while wait(Sec) do
		if _G["FarmPhaBinh"] then
			pcall(function()
				if not(L_1_[136] and (L_1_[136]["Character"] and (L_1_[136]["Character"]:FindFirstChild("HumanoidRootPart") and (L_1_[136]["Character"]:FindFirstChild("Humanoid") and L_1_[136]["Character"]["Humanoid"]["Máu"] > 0)))) then
					return
				end
...
Test = L_1_[93]["Chính"]:AddDropdown({
...
Toggle = L_1_[93]["Chính"]:AddToggle({
...
spawn(function()
	...
	L_566_[1] = function(L_567_arg0, L_568_arg1)
		...
		if L_569_[3]:FindFirstChild("Humanoid") and (L_569_[3]:FindFirstChild("HumanoidRootPart") and L_569_[3]["Humanoid"]["Máu"] > 0) then
			if L_569_[3]["Name"] == L_569_[1] then
				repeat
					wait()
					L_1_[4]["Giết"](L_569_[3], (getgenv())["AutoMaterial"])
				until not(getgenv())["AutoMaterial"] or not L_569_[3]["Parent"] or L_569_[3]["Humanoid"]["Máu"] <= 0
			end
		end
	end
	L_566_[2] = function()
		for L_570_forvar0, L_571_forvar1 in pairs((game:GetService("Workspace"))["_WorldOrigin"]["EnemySpawns"]:GetChildren()) do
			...
			for L_573_forvar0, L_574_forvar1 in ipairs(MMon) do
				...
				if string["find"](L_572_[2]["Name"], L_575_[2]) then
					if (game["Người chơi"]["Người chơi cục bộ"]["Character"]["HumanoidRootPart"]["Position"] - L_572_[2]["Position"])["Magnitude"] >= 10 then
		...
		if (getgenv())["AutoMaterial"] then
			pcall(function()
				...
				for L_576_forvar0, L_577_forvar1 in ipairs(MMon) do
					...
					for L_579_forvar0, L_580_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
						local L_581_ = {}
...
BossDropdown = L_1_[93]["Chính"]:AddDropdown({
	["Name"] = "Chọn Trùm";
	["Description"] = "";
	["Options"] = BossList,
	["Default"] = false;
...
FarmBoss = L_1_[93]["Chính"]:AddToggle({
	["Name"] = "Tự động Cày Trùm";
	["Description"] = "";
	["Default"] = false,
			...
			while wait(Sec) do
				if _G["FarmBoss"] then
					pcall(function()
						...
						L_586_[2] = L_1_[136]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Container"]["QuestTitle"]["Title"]["Text"]
						if _G["AcceptQuestBoss"] and L_586_[1] then
							if not string["find"](L_586_[2], (QuestBeta())[0]) then
								L_1_[18]["Remotes"]["CommF_"]:InvokeServer("AbandonQuest")
							end
							if L_1_[136]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == false then
								_tp((QuestBeta())[5])
							...
							elseif L_1_[136]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == true then
								if workspace["Kẻ thù"]:FindFirstChild((QuestBeta())[1]) then
									for L_587_forvar0, L_588_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
										local L_589_ = {}
										...
										if L_1_[4]["Alive"](L_589_[1]) and L_589_[1]["Name"] == (QuestBeta())[1] then
											if string["find"](L_586_[2], (QuestBeta())[0]) then
												repeat
													wait()
													L_1_[4]["Giết"](L_589_[1], _G["FarmBoss"])
												until not _G["FarmBoss"] or L_589_[1]["Humanoid"]["Máu"] <= 0 or not L_589_[1]["Parent"] or L_1_[136]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == false
											else
												L_1_[18]["Remotes"]["CommF_"]:InvokeServer("AbandonQuest")
											end
										end
							...
							if workspace["Kẻ thù"]:FindFirstChild((QuestBeta())[1]) then
								for L_590_forvar0, L_591_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
									local L_592_ = {}
									L_592_[3], L_592_[1] = L_590_forvar0, L_591_forvar1
									if L_1_[4]["Alive"](L_592_[1]) and L_592_[1]["Name"] == (QuestBeta())[1] then
										repeat
											wait()
											L_1_[4]["Giết"](L_592_[1], _G["FarmBoss"])
										until not _G["FarmBoss"] or L_592_[1]["Humanoid"]["Máu"] <= 0 or not L_592_[1]["Parent"]
									end
								end
							else
								_tp((QuestBeta())[4])
...
FarmAllBoss = L_1_[93]["Chính"]:AddToggle({
	["Name"] = "Tự động Cày All Trùm",
	["Default"] = false;
...
task["sinh"](function()
	while task["wait"](.3) do
		if _G["AutoFarmAllBoss"] then
			pcall(function()
				local L_597_ = {}
				L_597_[5] = game["Người chơi"]["Người chơi cục bộ"]
				...
				for L_598_forvar0, L_599_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
					local L_600_ = {}
					L_600_[3], L_600_[1] = L_598_forvar0, L_599_forvar1
					if L_600_[1]:FindFirstChild("HumanoidRootPart") and (L_600_[1]:FindFirstChild("Humanoid") and L_600_[1]["Humanoid"]["Máu"] > 0) then
				...
				if L_597_[1] and L_597_[1]:FindFirstChild("HumanoidRootPart") then
					...
					repeat
						...
						if L_1_[4] and typeof(L_1_[4]["Giết"]) == "function" then
							L_1_[4]["Giết"](L_597_[1], true)
						end
					until not L_597_[1]["Parent"] or L_602_[2]["Máu"] <= 0 or not _G["AutoFarmAllBoss"]
				end
			end)
		end
	end
...
L_1_[74] = L_1_[93]["Chính"]:AddDropdown({
	["Name"] = "Choose Island";
	["Description"] = "",
	["Options"] = L_1_[17],
	["Default"] = false;
...
L_1_[137] = L_1_[93]["Chính"]:AddToggle({
	["Name"] = "Tự động Mastery Fruits";
	["Description"] = "",
	["Default"] = false,
			...
			pcall(function()
				if SelectIsland == "Cake" then
					...
					if L_611_[2] then
						...
						until _G["FarmMastery_Dev"] == false or L_611_[2]["Humanoid"]["Máu"] <= 0 or not L_611_[2]["Parent"]
					else
						_tp(CFrame["new"](-1943.6765136719, 251.50956726074, -12337.880859375))
					end
				elseif SelectIsland == "Bone" then
					...
					if L_612_[1] then
						...
						until _G["FarmMastery_Dev"] == false or L_612_[1]["Humanoid"]["Máu"] <= 0 or not L_612_[1]["Parent"]
					else
						_tp(CFrame["new"](-9495.6806640625, 453.58624267578, 5977.3486328125))
					end
				end
...
L_1_[46] = L_1_[93]["Chính"]:AddToggle({
	["Name"] = "Tự động Mastery Gun",
	["Description"] = "";
	["Default"] = false;
			...
			pcall(function()
				if SelectIsland == "Cake" then
					...
					if L_615_[2] then
						...
						until _G["FarmMastery_G"] == false or L_615_[2]["Humanoid"]["Máu"] <= 0 or not L_615_[2]["Parent"]
						SoulGuitar = false
					else
						_tp(CFrame["new"](-1943.6765136719, 251.50956726074, -12337.880859375))
					end
				elseif SelectIsland == "Bone" then
					...
					if L_617_[2] then
						...
						until _G["FarmMastery_G"] == false or L_617_[2]["Humanoid"]["Máu"] <= 0 or not L_617_[2]["Parent"]
						SoulGuitar = false
					else
						_tp(CFrame["new"](-9495.6806640625, 453.58624267578, 5977.3486328125))
					end
...
L_1_[29] = L_1_[93]["Chính"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động Mastery All Swo",
		"rd"
	}),
	["Description"] = "",
	["Default"] = false;
								...
								if tonumber(L_623_[2]["Mastery"]) >= 1 or tonumber(L_623_[2]["Mastery"]) <= 599 then
									...
									if GetBP(SwordName) then
										if L_624_[2] then
											...
											until _G["FarmMastery_S"] == false or not L_624_[2]["Parent"] or L_624_[2]["Humanoid"]["Máu"] <= 0
										else
											_tp(CFrame["new"](-1943.6765136719, 251.50956726074, -12337.880859375))
										end
									else
								...
								if tonumber(L_627_[1]["Mastery"]) >= 1 or tonumber(L_627_[1]["Mastery"]) <= 599 then
									...
									if GetBP(SwordName) then
										if L_628_[2] then
											...
											until _G["FarmMastery_S"] == false or not L_628_[2]["Parent"] or L_628_[2]["Humanoid"]["Máu"] <= 0
										else
											_tp(CFrame["new"](-9495.6806640625, 453.58624267578, 5977.3486328125))
										end
									else
...
L_1_[93]["Cài đặt"]:AddSection({
	"Cài đặt / Configure"
})
Initialize = L_1_[93]["Cài đặt"]:AddToggle({
	["Name"] = "Fast Tấn công",
	["Description"] = "",
	["Default"] = true,
...
Bringmob = L_1_[93]["Cài đặt"]:AddToggle({
	["Name"] = "Bring Mobs";
	["Description"] = "",
	["Default"] = true,
...
L_1_[93]["Cài đặt"]:AddDropdown({
	["Name"] = "Bring Mob Tốc độ";
	["Description"] = "Adjust Tốc độ";
	["Default"] = "300";
	["Options"] = {
		"250";
		"300",
...
L_1_[93]["Cài đặt"]:AddToggle({
	["Name"] = "Tự động Hop Máy chủ",
	["Default"] = false;
		...
		if _G["AutoHopServer"] then
			pcall(function()
				...
				if tick() - _G["HopTimer"] >= _G["HopDelay"] then
					_G["HopTimer"] = tick()
					if syn and syn["queue_bật_dịch chuyển"] then
						syn["queue_bật_dịch chuyển"](L_1_[2]({
					...
					(game:GetService("TeleportService")):Teleport(game["PlaceId"], game["Người chơi"]["Người chơi cục bộ"])
				end
			end)
		end
	end
end)
L_1_[93]["Cài đặt"]:AddSlider({
...
BusuAura = L_1_[93]["Cài đặt"]:AddToggle({
	["Name"] = "Tự động Turn bật Buso",
	["Description"] = "",
	["Default"] = true;
...
RaceV3Aura = L_1_[93]["Cài đặt"]:AddToggle({
	["Name"] = "Tự động Turn bật Race V3";
	["Description"] = "",
	["Default"] = false;
...
RaceV4Aura = L_1_[93]["Cài đặt"]:AddToggle({
	["Name"] = "Tự động Turn bật Race V4",
	["Description"] = "",
	["Default"] = false;
		...
		pcall(function()
			if _G["RaceClickAutov4"] then
				if L_1_[136]["Character"]:FindFirstChild("RaceEnergy") then
					if (L_1_[136]["Character"]:FindFirstChild("RaceEnergy"))["Giá trị"] == 1 then
						Useskills("nil", "Y")
					end
				end
			end
...
L_1_[45] = game["Người chơi"]["Người chơi cục bộ"];
...
RandomAround = L_1_[93]["Cài đặt"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động Turn bật Spin Po";
		"sition"
	});
	["Description"] = "",
	["Default"] = false;
...
Byp = L_1_[93]["Cài đặt"]:AddToggle({
	["Name"] = L_1_[2]({
		"Turn bật Bypass Telep";
		"ort"
	}),
	["Description"] = "",
	["Default"] = false,
...
SafeModes = L_1_[93]["Cài đặt"]:AddToggle({
	["Name"] = "Panic Mode";
	["Description"] = "",
	["Default"] = false,
...
spawn(function()
	while task["wait"](Sec) do
		pcall(function()
			if _G["Safemode"] then
				local L_675_ = {}
				L_675_[1] = (L_1_[45]["Character"]["Humanoid"]["Máu"] / L_1_[45]["Character"]["Humanoid"]["MaxHealth"]) * 100
...
DisableHitVFX = L_1_[93]["Cài đặt"]:AddToggle({
	["Name"] = "Remove Hit VFX";
	["Description"] = L_1_[2]({
...
RmvVFX = L_1_[93]["Cài đặt"]:AddToggle({
	["Name"] = L_1_[2]({
		"Remove Death & Respa",
		"wned VFX"
	});
...
DisblesNotify = L_1_[93]["Cài đặt"]:AddToggle({
	["Name"] = "Tắt Notify";
	["Description"] = "",
	["Default"] = false,
	...
	["Callback"] = function(L_685_arg0)
		...
		if L_686_[1] then
			...
			repeat
				wait()
			until game:IsLoaded();
			(game:GetService("Người chơi"))["Người chơi cục bộ"]["Idled"]:Connect(function()
	...
	while wait() do
		pcall(function()
			if (getgenv())["HopServerAdmin"] then
				for L_690_forvar0, L_691_forvar1 in pairs(game["Người chơi"]:GetPlayers()) do
					local L_692_ = {}
	...
	pcall(function()
		(game:GetService("RunService"))["Stepped"]:Connect(function()
			if (getgenv())["NoClip"] then
				for L_695_forvar0, L_696_forvar1 in pairs(game["Người chơi"]["Người chơi cục bộ"]["Character"]:GetDescendants()) do
					local L_697_ = {}
...
StatsUpg = L_1_[93]["Esp"]:AddToggle({
	...
	["Callback"] = function(L_700_arg0)
		local L_701_ = {}
		L_701_[2] = L_700_arg0
		_G["Tự động_Melee"] = L_701_[2]
	end
})
spawn(function()
	while wait(Sec) do
		pcall(function()
			if _G["Tự động_Melee"] then
...
StatsUpg = L_1_[93]["Esp"]:AddToggle({
	...
	["Callback"] = function(L_702_arg0)
		local L_703_ = {}
		L_703_[2] = L_702_arg0
		_G["Tự động_Sword"] = L_703_[2]
	end
})
spawn(function()
	while wait(Sec) do
		pcall(function()
			if _G["Tự động_Sword"] then
...
StatsUpg = L_1_[93]["Esp"]:AddToggle({
	...
	["Callback"] = function(L_704_arg0)
		local L_705_ = {}
		L_705_[1] = L_704_arg0
		_G["Tự động_Gun"] = L_705_[1]
	end
})
spawn(function()
	while wait(Sec) do
		pcall(function()
			if _G["Tự động_Gun"] then
...
StatsUpg = L_1_[93]["Esp"]:AddToggle({
	["Name"] = "Tự động Blox Fruit",
	["Description"] = "",
	["Default"] = false,
	["Callback"] = function(L_706_arg0)
		local L_707_ = {}
		L_707_[2] = L_706_arg0
		_G["Tự động_DevilFruit"] = L_707_[2]
	end
})
spawn(function()
	while wait(Sec) do
		pcall(function()
			if _G["Tự động_DevilFruit"] then
...
StatsUpg = L_1_[93]["Esp"]:AddToggle({
	...
	["Callback"] = function(L_708_arg0)
		local L_709_ = {}
		L_709_[1] = L_708_arg0
		_G["Tự động_Phòng thủ"] = L_709_[1]
	end
})
spawn(function()
	while wait(Sec) do
		pcall(function()
			if _G["Tự động_Phòng thủ"] then
				statsSetings("Phòng thủ", pSats)
			end
		end)
	end
end)
...
L_1_[59] = game:GetService("Người chơi")
L_1_[57] = L_1_[59]["Người chơi cục bộ"]
		...
		if _G["AutoFishing"] then
			pcall(function()
				...
				if L_718_[1] then
					...
					L_720_[7] = L_720_[6] and Vector3["new"](L_720_[6]["X"], math["tối đa"](L_720_[6]["Y"], L_720_[3]), L_720_[6]["Z"])
...
L_1_[62] = game:GetService("Người chơi")
L_1_[68] = L_1_[62]["Người chơi cục bộ"]
...
L_1_[31] = function()
	local L_723_ = {}
	L_723_[2] = L_1_[68]["PlayerGui"]:FindFirstChild("Nhiệm vụ") or L_1_[68]["PlayerGui"]:FindFirstChild("QuestGui")
...
TravelDress = L_1_[93]["Nhiệm vụ"]:AddToggle({
	["Name"] = "Tự động Nhiệm vụ Sea 2";
	["Description"] = "",
	["Default"] = false;
	...
	while wait(Sec) do
		pcall(function()
			if _G["TravelDres"] then
				if L_1_[45]["Data"]["Cấp"]["Giá trị"] >= 700 then
						...
						if Enemies:FindFirstChild("Ice Admiral") then
							for L_732_forvar0, L_733_forvar1 in pairs(Enemies:GetChildren()) do
								...
								if L_734_[2]["Name"] == "Ice Admiral" and L_1_[4]["Alive"](L_734_[2]) then
									repeat
										task["wait"]()
										L_1_[4]["Giết"](L_734_[2], _G["TravelDres"])
									until _G["TravelDres"] == false or L_734_[2]["Humanoid"]["Máu"] <= 0
...
Zou = L_1_[93]["Nhiệm vụ"]:AddToggle({
	["Name"] = "Tự động Nhiệm vụ Sea 3";
	["Description"] = "",
	["Default"] = false;
...
spawn(function()
	while wait(Sec) do
		pcall(function()
			if _G["AutoZou"] then
				if L_1_[45]["Data"]["Cấp"]["Giá trị"] >= 1500 then
					if L_1_[18]["Remotes"]["CommF_"]:InvokeServer("BartiloQuestProgress", "Bartilo") == 3 then
						if (L_1_[18]["Remotes"]["CommF_"]:InvokeServer("GetUnlockables"))["FlamingoAccess"] ~= nil then
							...
							if L_1_[18]["Remotes"]["CommF_"]:InvokeServer("ZQuestProgress", "Check") == 0 then
								...
								if L_737_[2] then
									repeat
										wait()
										L_1_[4]["Giết"](L_737_[2], _G["AutoZou"])
									until not _G["AutoZou"] or not L_737_[2]["Parent"] or L_737_[2]["Humanoid"]["Máu"] <= 0
									Check = 2
									repeat
										wait()
										L_1_[18]["Remotes"]["CommF_"]:InvokeServer("F_", "TravelZou")
							...
							elseif L_1_[18]["Remotes"]["CommF_"]:InvokeServer("ZQuestProgress", "Check") == 1 then
								...
								if L_738_[1] then
									repeat
										wait()
										L_1_[4]["Giết"](L_738_[1], _G["AutoZou"])
									until not _G["AutoZou"] or not L_738_[1]["Parent"] or L_738_[1]["Humanoid"]["Máu"] <= 0
								else
									repeat
										wait()
						...
						if L_1_[18]["Remotes"]["CommF_"]:InvokeServer("BartiloQuestProgress", "Bartilo") == 0 then
							if string["find"](L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Container"]["QuestTitle"]["Title"]["Text"], "Swan Pirates") and (string["find"](L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Container"]["QuestTitle"]["Title"]["Text"], "50") and L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == true) then
								local L_754_ = {}
								L_754_[1] = GetConnectionEnemies("Swan Hải tặc")
								if L_754_[1] then
									pcall(function()
										repeat
											wait()
											L_1_[4]["Giết"](L_754_[1], _G["AutoZou"])
										until not L_754_[1]["Parent"] or L_754_[1]["Humanoid"]["Máu"] <= 0 or _G["AutoZou"] == false or L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == false
									end)
								else
						...
						elseif L_1_[18]["Remotes"]["CommF_"]:InvokeServer("BartiloQuestProgress", "Bartilo") == 1 then
							...
							if L_755_[2] then
								repeat
									wait()
									L_1_[4]["Giết"](L_755_[2], _G["AutoZou"])
								until not L_755_[2]["Parent"] or L_755_[2]["Humanoid"]["Máu"] <= 0 or _G["AutoZou"] == false
							else
...
L_1_[93]["Nhiệm vụ"]:AddSection({
	"Tushita + Yama"
})
Q = L_1_[93]["Nhiệm vụ"]:AddToggle({
	["Name"] = "Tự động Tushita Sword",
	["Description"] = "",
	["Default"] = false;
	["Callback"] = function(L_756_arg0)
		local L_757_ = {}
		L_757_[2] = L_756_arg0
		_G["Tự động_Tushita"] = L_757_[2]
	end
})
spawn(function()
	while wait(Sec) do
		pcall(function()
			if _G["Tự động_Tushita"] then
				if workspace["Map"]["Turtle"]:FindFirstChild("TushitaGate") then
					if not GetBP("Holy Torch") then
						...
						until not _G["Tự động_Tushita"] or ((CFrame["new"](-10752, 417, -9366))["Position"] - L_1_[45]["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] <= 10
						wait(.7)
						repeat
							task["wait"]()
							_tp(CFrame["new"](-11672, 334, -9474))
						until not _G["Tự động_Tushita"] or ((CFrame["new"](-11672, 334, -9474))["Position"] - L_1_[45]["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] <= 10
						wait(.7)
						repeat
							task["wait"]()
							_tp(CFrame["new"](-12132, 521, -10655))
						until not _G["Tự động_Tushita"] or ((CFrame["new"](-12132, 521, -10655))["Position"] - L_1_[45]["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] <= 10
						wait(.7)
						repeat
							task["wait"]()
							_tp(CFrame["new"](-13336, 486, -6985))
						until not _G["Tự động_Tushita"] or ((CFrame["new"](-13336, 486, -6985))["Position"] - L_1_[45]["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] <= 10
						wait(.7)
						repeat
							task["wait"]()
							_tp(CFrame["new"](-13489, 332, -7925))
						until not _G["Tự động_Tushita"] or ((CFrame["new"](-13489, 332, -7925))["Position"] - L_1_[45]["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] <= 10
					end
				else
					local L_758_ = {}
					...
					if L_758_[1] then
						repeat
							task["wait"]()
							L_1_[4]["Giết"](L_758_[1], _G["Tự động_Tushita"])
						until L_758_[1]["Humanoid"]["Máu"] <= 0 or not _G["Tự động_Tushita"] or not L_758_[1]["Parent"]
					else
...
Q = L_1_[93]["Nhiệm vụ"]:AddToggle({
	["Name"] = "Tự động Yama Sword";
	["Description"] = "",
	["Default"] = false;
	["Callback"] = function(L_759_arg0)
		local L_760_ = {}
		L_760_[2] = L_759_arg0
		_G["Tự động_Yama"] = L_760_[2]
	end
})
spawn(function()
	while wait(Sec) do
		pcall(function()
			if _G["Tự động_Yama"] then
				...
				elseif L_1_[18]["Remotes"]["CommF_"]:InvokeServer("EliteHunter", "Progress") > 30 then
					...
					if (workspace["Map"]["Waterfall"]["SealedKatana"]["Handle"]["Position"] - L_1_[45]["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] >= 20 then
						...
						if L_761_[1] then
							repeat
								wait()
								L_1_[4]["Giết"](L_761_[1], _G["Tự động_Yama"])
							until L_761_[1]["Humanoid"]["Máu"] <= 0 or not L_761_[1]["Parent"] or not _G["Tự động_Yama"]
...
CheckSoul = L_1_[93]["Nhiệm vụ"]:AddParagraph({
	["Title"] = L_1_[2]({
		" Skull Guitar Nhiệm vụ",
		" "
	}),
	["Content"] = ""
})
	...
	while wait(.2) do
		pcall(function()
			...
			elseif GetWP("Skull Guitar") then
				CheckSoul:SetDesc(L_1_[2]({
					" Nhiệm vụ Number : Coll";
					"ect!!"
				}))
			else
				CheckSoul:SetDesc(L_1_[2]({
					" Nhiệm vụ Number : Không Q";
					"uest!!"
				}))
			end
		end)
...
L_1_[93]["Nhiệm vụ"]:AddToggle({
	["Name"] = "Tự động Skull Guitar",
	["Description"] = "",
	["Default"] = false,
	["Callback"] = function(L_762_arg0)
		local L_763_ = {}
		L_763_[2] = L_762_arg0
		_G["Tự động_Soul_Guitar"] = L_763_[2]
	end
})
task["sinh"](function()
	while wait() do
		if _G["Tự động_Soul_Guitar"] then
			pcall(function()
				local L_764_ = {}
...
function getRT(L_767_arg0)
	local L_768_ = {}
	L_768_[1] = L_767_arg0
	L_768_[2] = workspace["Map"]["Haunted Castle"]["Trophies"]["Nhiệm vụ"]
				...
				if World3 then
					...
					elseif (L_1_[18]["Remotes"]["CommF_"]:InvokeServer("GuitarPuzzleProgress", "Check"))["Swamp"] == false then
						...
						if L_775_[1] then
							repeat
								task["wait"]()
								L_1_[4]["Giết"](L_775_[1], _G["Tự động_Soul_Guitar"])
							until not _G["Tự động_Soul_Guitar"] or L_775_[1]["Humanoid"]["Máu"] <= 0 or not L_775_[1]["Parent"] or workspace["Map"]["Haunted Castle"]["SwampWater"]["Color"] ~= Color3["fromRGB"](117, 0, 0)
						else
	...
	while wait(Sec) do
		pcall(function()
			if _G["AutoMatSoul"] and GetWP("Skull Guitar") == false then
				if GetM("Bones") >= 500 and (GetM("Ectoplasm") >= 250 and GetM("Tối Fragment") >= 1) then
					...
					if GetM("Ectoplasm") <= 250 then
						if _G["AutoMatSoul"] and World2 then
							...
							if L_783_[3] then
								repeat
									task["wait"]()
									L_1_[4]["Giết"](L_783_[3], _G["AutoMatSoul"])
								until not _G["AutoMatSoul"] or not L_783_[3]["Parent"] or L_783_[3]["Humanoid"]["Máu"] <= 0
							else
					...
					elseif GetM("Tối Fragment") < 1 then
						if _G["AutoMatSoul"] and World2 then
							local L_784_ = {}
							...
							if L_784_[1] then
								repeat
									task["wait"]()
									L_1_[4]["Giết"](L_784_[1], _G["AutoMatSoul"])
								until _G["AutoMatSoul"] or L_784_[1]["Humanoid"]["Máu"] <= 0
							else
					...
					elseif GetM("Bones") <= 500 then
						if _G["AutoMatSoul"] and World3 then
							...
							if L_785_[3] then
								repeat
									task["wait"]()
									L_1_[4]["Giết"](L_785_[3], _G["AutoMatSoul"])
								until not _G["AutoMatSoul"] or L_785_[3]["Humanoid"]["Máu"] <= 0 or not L_785_[3]["Parent"] or L_785_[3]["Humanoid"]["Máu"] <= 0
							else
...
CheckCDK = L_1_[93]["Nhiệm vụ"]:AddParagraph({
	["Title"] = L_1_[2]({
		" Number Cursed dual ";
		"katana nhiệm vụ "
	}),
	["Content"] = "Nhiệm vụ Numbers :"
})
spawn(function()
	while wait(.2) do
		if QuestYama_1 == true then
			CheckCDK:SetDesc(L_1_[2]({
				" Nhiệm vụ Numbers : yam",
				"a nhiệm vụ 1"
			}))
		...
		elseif QuestTushita_1 == true then
			CheckCDK:SetDesc(L_1_[2]({
				" Nhiệm vụ Numbers: tush",
				"ita nhiệm vụ 2"
			}))
		elseif GetWP("Cursed Dual Katana") then
			CheckCDK:SetDesc(L_1_[2]({
				" Nhiệm vụ Numbers: CDK ";
				"done!!"
			}))
		end
	end
	...
	while wait(Sec) do
		pcall(function()
			if _G["CDK"] then
				...
				L_1_[18]["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "StartTrial", "Trùm")
				L_788_[1] = GetConnectionEnemies("Cursed Bộ xương Trùm")
				if L_788_[1] then
					repeat
						wait()
					...
					until not _G["CDK"] or not L_788_[1]["Parent"] or L_788_[1]["Humanoid"]["Máu"] <= 0
				else
				...
				if tostring(L_1_[18]["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "OpenDoor")) ~= "opened" then
					...
					elseif (L_1_[18]["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "Progress"))["Finished"] == false then
						if tonumber((L_1_[18]["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "Progress"))["Evil"]) == -3 then
							...
							repeat
								task["wait"]()
								if not workspace["Kẻ thù"]:FindFirstChild("Forest Hải tặc") then
									_tp(CFrame["new"](-13223.521484375, 428.19381713867, -7766.0678710938))
								else
									local L_791_ = {}
									L_791_[2] = GetConnectionEnemies("Forest Hải tặc")
									if L_791_[2] then
										_tp((workspace["Kẻ thù"]:FindFirstChild("Forest Hải tặc"))["HumanoidRootPart"]["CFrame"])
									end
								end
						...
						elseif tonumber((L_1_[18]["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "Progress"))["Evil"]) == -4 then
							...
							QuestYama_2 = true
							QuestYama_3 = false
							for L_792_forvar0, L_793_forvar1 in pairs((game:GetService("Người chơi"))["Người chơi cục bộ"]["QuestHaze"]:GetChildren()) do
								local L_794_ = {}
								...
								for L_795_forvar0, L_796_forvar1 in pairs(L_1_[22]) do
									...
									if string["find"](L_797_[1], L_794_[1]["Name"]) and L_794_[1]["Giá trị"] > 0 then
										if (L_797_[2]["Position"] - Root["Position"])["Magnitude"] <= 1000 and workspace["Kẻ thù"]:FindFirstChild(L_797_[1]) then
											for L_798_forvar0, L_799_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
												local L_800_ = {}
												L_800_[1], L_800_[2] = L_798_forvar0, L_799_forvar1
												if L_800_[2]:FindFirstChild("HumanoidRootPart") and (L_800_[2]:FindFirstChild("Humanoid") and ((L_800_[2]:FindFirstChild("Humanoid"))["Máu"] > 0 and L_800_[2]:FindFirstChild("HazeESP"))) then
													repeat
														wait()
														L_1_[4]["Giết"](L_800_[2], _G["CDK_YM"])
													until not _G["CDK_YM"] or tonumber((L_1_[18]["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "Progress"))["Evil"]) == 2 or not L_800_[2]:FindFirstChild("HazeESP") or L_800_[2]["Humanoid"]["Máu"] <= 0
												end
											end
										else
											_tp(L_797_[2])
						...
						elseif tonumber((L_1_[18]["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "Progress"))["Evil"]) == -5 then
							...
							if workspace["Map"]:FindFirstChild("HellDimension") then
								if (Root["Position"] - workspace["Map"]["HellDimension"]["Sinh"]["Position"])["Magnitude"] <= 1000 then
									...
									for L_813_forvar0, L_814_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
										local L_815_ = {}
										L_815_[1], L_815_[3] = L_813_forvar0, L_814_forvar1
										if ((L_815_[3]:FindFirstChild("HumanoidRootPart"))["Position"] - workspace["Map"]["HellDimension"]["Sinh"]["Position"])["Magnitude"] <= 300 then
											if L_815_[3]:FindFirstChild("HumanoidRootPart") and (L_815_[3]:FindFirstChild("Humanoid") and (L_815_[3]:FindFirstChild("Humanoid"))["Máu"] > 0) then
												repeat
													task["wait"]()
													L_1_[4]["Giết"](L_815_[3], _G["CDK_YM"])
												until not _G["CDK_YM"] or L_815_[3]["Humanoid"]["Máu"] <= 0 or not L_815_[3]["Parent"] or tonumber((L_1_[18]["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "Progress"))["Evil"]) == 3
											end
										end
									end
								end
		...
		pcall(function()
			if _G["CDK_YM"] then
				if tonumber((L_1_[18]["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "Progress"))["Evil"]) == -5 then
					if not workspace["Map"]:FindFirstChild("HellDimension") or (Root["Position"] - workspace["Map"]["HellDimension"]["Sinh"]["Position"])["Magnitude"] > 1000 then
						local L_816_ = {}
						...
						if L_816_[2] then
							...
							until L_816_[2]["Humanoid"]["Máu"] <= 0 or not _G["CDK_YM"] or not L_816_[2]["Parent"] or tonumber((L_1_[18]["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "Progress"))["Evil"]) == 3 or workspace["Map"]:FindFirstChild("HellDimension") and (Root["Position"] - workspace["Map"]["HellDimension"]["Sinh"]["Position"])["Magnitude"] <= 1000
						elseif L_1_[45]["Backpack"]:FindFirstChild("Hallow Essence") or L_1_[45]["Character"]:FindFirstChild("Hallow Essence") then
							...
							EquipWeapon("Hallow Essence")
						elseif L_1_[18]:FindFirstChild("Soul Reaper") and (L_1_[18]:FindFirstChild("Soul Reaper"))["Humanoid"]["Máu"] > 0 then
							_tp((L_1_[18]:FindFirstChild("Soul Reaper"))["HumanoidRootPart"]["CFrame"])
						else
							if L_1_[18]["Remotes"]["CommF_"]:InvokeServer("Bones", "Check") < 50 and (not workspace["Kẻ thù"]:FindFirstChild("Soul Reaper") and (not L_1_[18]:FindFirstChild("Soul Reaper") and not workspace["Map"]:FindFirstChild("HellDimension"))) then
								if workspace["Kẻ thù"]:FindFirstChild("Tái sinh Bộ xương") or workspace["Kẻ thù"]:FindFirstChild("Living Zombie") or workspace["Kẻ thù"]:FindFirstChild("Domenic Soul") or workspace["Kẻ thù"]:FindFirstChild("Posessed Mummy") then
									for L_817_forvar0, L_818_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
										local L_819_ = {}
										L_819_[3], L_819_[1] = L_817_forvar0, L_818_forvar1
										if L_819_[1]["Name"] == "Tái sinh Bộ xương" or L_819_[1]["Name"] == "Living Zombie" or L_819_[1]["Name"] == "Demonic Soul" or L_819_[1]["Name"] == "Posessed Mummy" then
											if L_819_[1]:FindFirstChild("HumanoidRootPart") and (L_819_[1]:FindFirstChild("Humanoid") and (L_819_[1]:FindFirstChild("Humanoid"))["Máu"] > 0) then
												repeat
													task["wait"]()
													L_1_[4]["Giết"](L_819_[1], _G["CDK_YM"])
												until not _G["CDK_YM"] or L_819_[1]["Humanoid"]["Máu"] <= 0 or not L_819_[1]["Parent"]
											end
										end
									end
								else
				...
				if tostring(L_1_[18]["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "OpenDoor")) ~= "opened" then
					...
					elseif (L_1_[18]["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "Progress"))["Finished"] == false then
						if tonumber((L_1_[18]["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "Progress"))["Good"]) == -3 then
							...
							until ((CFrame["new"](-4602.5107421875, 16.446542739868, -2880.998046875))["Position"] - (game:GetService("Người chơi"))["Người chơi cục bộ"]["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] <= 3 or not _G["CDK_TS"] or tonumber((L_1_[18]["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "Progress"))["Good"]) == 1
							if ((CFrame["new"](-4602.5107421875, 16.446542739868, -2880.998046875))["Position"] - (game:GetService("Người chơi"))["Người chơi cục bộ"]["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] <= 10 then
								wait(.7)
							...
							until ((CFrame["new"](4001.1853027344, 10.089399337769, -2654.86328125))["Position"] - (game:GetService("Người chơi"))["Người chơi cục bộ"]["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] <= 3 or not _G["CDK_TS"] or tonumber((L_1_[18]["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "Progress"))["Good"]) == 1
							if ((CFrame["new"](4001.1853027344, 10.089399337769, -2654.86328125))["Position"] - (game:GetService("Người chơi"))["Người chơi cục bộ"]["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] <= 10 then
								wait(.7)
								L_1_[18]["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "BoatQuest", workspace["NPCs"]:FindFirstChild("Luxury Boat Dealer"), "Check")
								wait(.5)
								L_1_[18]["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "BoatQuest", workspace["NPCs"]:FindFirstChild("Luxury Boat Dealer"))
							...
							until ((CFrame["new"](-9530.763671875, 7.2452087402344, -8375.5087890625))["Position"] - (game:GetService("Người chơi"))["Người chơi cục bộ"]["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] <= 3 or not _G["CDK_TS"] or tonumber((L_1_[18]["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "Progress"))["Good"]) == 1
							if ((CFrame["new"](-9530.763671875, 7.2452087402344, -8375.5087890625))["Position"] - (game:GetService("Người chơi"))["Người chơi cục bộ"]["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] <= 10 then
								wait(.7)
								L_1_[18]["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "BoatQuest", workspace["NPCs"]:FindFirstChild("Luxury Boat Dealer"), "Check")
								wait(.5)
								L_1_[18]["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "BoatQuest", workspace["NPCs"]:FindFirstChild("Luxury Boat Dealer"))
						...
						elseif tonumber((L_1_[18]["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "Progress"))["Good"]) == -5 then
							...
							QuestTushita_2 = false
							QuestTushita_3 = true
							if workspace["Kẻ thù"]:FindFirstChild("Cake Queen") then
								for L_822_forvar0, L_823_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
									local L_824_ = {}
									L_824_[1], L_824_[3] = L_822_forvar0, L_823_forvar1
									if L_824_[3]["Name"] == "Cake Queen" then
										if L_824_[3]:FindFirstChild("Humanoid") and (L_824_[3]:FindFirstChild("HumanoidRootPart") and L_824_[3]["Humanoid"]["Máu"] > 0) then
											repeat
												wait()
												L_1_[4]["Giết"](L_824_[3], _G["CDK_TS"])
											until not _G["CDK_TS"] or not L_824_[3]["Parent"] or L_824_[3]["Humanoid"]["Máu"] <= 0 or tonumber((L_1_[18]["Remotes"]["CommF_"]:InvokeServer("CDKQuest", "Progress"))["Good"]) == 3
										end
									end
								end
							elseif L_1_[18]:FindFirstChild("Cake Queen") and (L_1_[18]:FindFirstChild("Cake Queen"))["Humanoid"]["Máu"] > 0 then
								_tp((L_1_[18]:FindFirstChild("Cake Queen"))["HumanoidRootPart"]["CFrame"] * CFrame["new"](0, 30, 0))
							else
								if (game["Người chơi"]["Người chơi cục bộ"]["Character"]["HumanoidRootPart"]["Position"] - workspace["Map"]["HeavenlyDimension"]["Sinh"]["Position"])["Magnitude"] <= 1000 then
									...
									if Ex == 2 then
										repeat
											wait()
											game["Người chơi"]["Người chơi cục bộ"]["Character"]["HumanoidRootPart"]["CFrame"] = workspace["Map"]["HeavenlyDimension"]["Exit"]["CFrame"]
									...
									repeat
										...
										until ((CFrame["new"](-22529.6171875, 5275.7739257812, 3873.5712890625))["Position"] - game["Người chơi"]["Người chơi cục bộ"]["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] < 5
										wait(2)
										_G["DoneT1"] = true
									...
									repeat
										...
										until ((CFrame["new"](-22637.291015625, 5281.365234375, 3749.2885742188))["Position"] - game["Người chơi"]["Người chơi cục bộ"]["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] < 5
										wait(2)
										_G["DoneT2"] = true
									...
									repeat
										...
										until ((CFrame["new"](-22791.14453125, 5277.1655273438, 3764.5700683594))["Position"] - game["Người chơi"]["Người chơi cục bộ"]["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] < 5
										wait(2)
										_G["DoneT3"] = true
									until _G["DoneT3"] or _G["CDK_TS"] == false
									for L_837_forvar0, L_838_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
										local L_839_ = {}
										...
										if ((L_839_[1]:FindFirstChild("HumanoidRootPart"))["Position"] - (CFrame["new"](-22695.7012, 5270.93652, 3814.42847, .11794927, 3.32185834e-08, .99301964, -8.73070718e-08, 1, -2.30819008e-08, -0.99301964, -8.3975138e-08, .11794927))["Position"])["Magnitude"] <= 300 then
											if L_839_[1]:FindFirstChild("HumanoidRootPart") and (L_839_[1]:FindFirstChild("Humanoid") and (L_839_[1]:FindFirstChild("Humanoid"))["Máu"] > 0) then
												repeat
													wait()
													L_1_[4]["Giết"](L_839_[1], _G["CDK_TS"])
												until not _G["CDK_TS"] or L_839_[1]["Humanoid"]["Máu"] <= 0 or not L_839_[1]["Parent"]
											end
										end
									end
								end
...
L_1_[93]["Nhiệm vụ"]:AddButton({
	["Name"] = "Mua Legendary Sword";
	["Description"] = "",
	["Callback"] = function()
		...
		if _G["AutoPole"] then
			pcall(function()
				...
				if L_847_[2] then
					repeat
						task["wait"]()
						L_1_[4]["Giết"](L_847_[2], _G["AutoPole"])
					until not _G["AutoPole"] or not L_847_[2]["Parent"] or L_847_[2]["Humanoid"]["Máu"] <= 0
				else
	...
	while wait(Sec) do
		pcall(function()
			if _G["AutoPoleV2"] then
				...
				if GetBP("Pole (1st Form)") and (GetBP("Pole (1st Form)"))["Cấp"]["Giá trị"] <= 179 then
					_G["Cấp"] = true
				elseif GetBP("Pole (1st Form)") and (GetBP("Pole (1st Form)"))["Cấp"]["Giá trị"] >= 180 then
					_G["Cấp"] = false
				end
				...
				if (GetBP("Rumble Fruit"))["AwakenedMoves"]:FindFirstChild("Z") and ((GetBP("Rumble Fruit"))["AwakenedMoves"]:FindFirstChild("X") and ((GetBP("Rumble Fruit"))["AwakenedMoves"]:FindFirstChild("C") and ((GetBP("Rumble Fruit"))["AwakenedMoves"]:FindFirstChild("V") and (GetBP("Rumble Fruit"))["AwakenedMoves"]:FindFirstChild("F")))) then
					_G["SelectChip"] = nil
					_G["Raiding"] = false
					_G["Tự động_Awakener"] = false
					if L_1_[45]["Data"]["Fragments"]["Giá trị"] >= 5000 then
				...
				elseif L_1_[18]["Remotes"]["CommF_"]:InvokeServer("Awakener", "Check") == nil or L_1_[18]["Remotes"]["CommF_"]:InvokeServer("Awakener", "Check") == 0 then
					...
					L_850_[1] = L_1_[18]["Remotes"]["CommF_"]:InvokeServer("RaidsNpc", "Chọn", _G["SelectChip"])
					if L_850_[1] then
						L_850_[1]:Stop()
					end
					_G["Raiding"] = true
					_G["Tự động_Awakener"] = true
				end
			end
		end)
	end
		...
		pcall(function()
			if _G["AutoSaw"] then
				...
				if L_853_[2] then
					repeat
						task["wait"]()
						L_1_[4]["Giết"](L_853_[2], _G["AutoSaw"])
					until _G["AutoSaw"] == false or L_853_[2]["Humanoid"]["Máu"] <= 0
				else
...
spawn(function()
	while wait(.2) do
		pcall(function()
			if _G["AutoSaber"] and (L_1_[45]["Data"]["Cấp"]["Giá trị"] >= 200 and (not L_1_[45]["Backpack"]:FindFirstChild("Saber") and not L_1_[45]["Character"]:FindFirstChild("Saber"))) then
				if workspace["Map"]["Jungle"]["Final"]["Part"]["Transparency"] == 0 then
						...
						if workspace["Map"]["Desert"]["Burn"]["Part"]["Transparency"] == 0 then
							...
							if L_1_[18]["Remotes"]["CommF_"]:InvokeServer("ProQuestProgress", "SickMan") ~= 0 then
								...
								elseif L_1_[18]["Remotes"]["CommF_"]:InvokeServer("ProQuestProgress", "RichSon") == 0 then
									if workspace["Kẻ thù"]:FindFirstChild("Mob Leader") or L_1_[18]:FindFirstChild("Mob Leader") then
										...
										for L_856_forvar0, L_857_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
											local L_858_ = {}
											L_858_[2], L_858_[3] = L_856_forvar0, L_857_forvar1
											if L_858_[3]["Name"] == "Mob Leader" and L_1_[4]["Alive"](L_858_[3]) then
												repeat
													task["wait"]()
													L_1_[4]["Giết"](L_858_[3], _G["AutoSaber"])
												until L_858_[3]["Humanoid"]["Máu"] <= 0 or _G["AutoSaber"] == false
											end
										end
									end
					...
					if workspace["Kẻ thù"]:FindFirstChild("Saber Expert") or L_1_[18]:FindFirstChild("Saber Expert") then
						for L_859_forvar0, L_860_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
							local L_861_ = {}
							L_861_[2], L_861_[1] = L_859_forvar0, L_860_forvar1
							if L_861_[1]["Name"] == "Saber Expert" and L_1_[4]["Alive"](L_861_[1]) then
								repeat
									task["wait"]()
									L_1_[4]["Giết"](L_861_[1], _G["AutoSaber"])
								until L_861_[1]["Humanoid"]["Máu"] <= 0 or _G["AutoSaber"] == false
								if L_861_[1]["Humanoid"]["Máu"] <= 0 then
		...
		if _G["AutoColShad"] then
			pcall(function()
				...
				if L_864_[2] then
					repeat
						task["wait"]()
						L_1_[4]["Giết"](L_864_[2], _G["AutoColShad"])
					until _G["AutoColShad"] == false or not L_864_[2]["Parent"] or L_864_[2]["Humanoid"]["Máu"] <= 0
				else
			...
			if _G["AutoGetUsoap"] then
				for L_867_forvar0, L_868_forvar1 in pairs(workspace["Characters"]:GetChildren()) do
					...
					if L_869_[2]["Name"] ~= L_1_[45]["Name"] then
						if L_869_[2]["Humanoid"]["Máu"] > 0 and (L_869_[2]:FindFirstChild("HumanoidRootPart") and (L_869_[2]["Parent"] and (Root["Position"] - L_869_[2]["HumanoidRootPart"]["Position"])["Magnitude"] <= 230)) then
							repeat
								task["wait"]()
								EquipWeapon(_G["SelectWeapon"])
								_tp(L_869_[2]["HumanoidRootPart"]["CFrame"] * CFrame["new"](1, 1, 2))
							until _G["AutoGetUsoap"] == false or L_869_[2]["Humanoid"]["Máu"] <= 0 or not L_869_[2]["Parent"] or not L_869_[2]:FindFirstChild("HumanoidRootPart") or not L_869_[2]:FindFirstChild("Humanoid")
						end
					end
				end
			end
			...
			pcall(function()
				...
				elseif GetWP("Bisento") then
					...
					if L_872_[1] then
						repeat
							wait()
							L_1_[4]["Giết"](L_872_[1], _G["Greybeard"])
						until _G["Greybeard"] == false or not L_872_[1]["Parent"] or L_872_[1]["Humanoid"]["Máu"] <= 0
					else
		...
		if _G["WardenBoss"] then
			pcall(function()
				...
				if L_875_[2] then
					repeat
						wait()
						L_1_[4]["Giết"](L_875_[2], _G["WardenBoss"])
					until _G["WardenBoss"] == false or not L_875_[2]["Parent"] or L_875_[2]["Humanoid"]["Máu"] <= 0
				else
		...
		if _G["MarinesCoat"] then
			pcall(function()
				...
				if L_878_[2] then
					repeat
						wait()
						L_1_[4]["Giết"](L_878_[2], _G["MarinesCoat"])
					until _G["MarinesCoat"] == false or not L_878_[2]["Parent"] or L_878_[2]["Humanoid"]["Máu"] <= 0
				else
		...
		if _G["SwanCoat"] then
			pcall(function()
				...
				if L_881_[2] then
					repeat
						wait()
						L_1_[4]["Giết"](L_881_[2], _G["SwanCoat"])
					until _G["SwanCoat"] == false or not L_881_[2]["Parent"] or L_881_[2]["Humanoid"]["Máu"] <= 0
				else
		...
		while wait(.1) do
			if _G["IceBossRen"] then
				...
				if L_884_[1] then
					repeat
						task["wait"]()
						L_1_[4]["Giết"](L_884_[1], _G["IceBossRen"])
					until _G["IceBossRen"] == false or not L_884_[1]["Parent"] or L_884_[1]["Humanoid"]["Máu"] <= 0
				else
			...
			if _G["KeysRen"] then
				if L_1_[45]["Backpack"]:FindFirstChild(L_1_[138][3]) or L_1_[45]["Character"]:FindFirstChild(L_1_[138][3]) then
					...
					if L_887_[1] then
						repeat
							task["wait"]()
							L_1_[4]["Giết"](L_887_[1], _G["KeysRen"])
						until L_1_[45]["Backpack"]:FindFirstChild(L_1_[138][3]) or _G["KeysRen"] == false or not L_887_[1]["Parent"] or L_887_[1]["Humanoid"]["Máu"] <= 0
					else
		...
		pcall(function()
			if _G["AutoTridentW2"] then
				...
				if L_890_[2] then
					repeat
						task["wait"]()
						L_1_[4]["Giết"](L_890_[2], _G["AutoTridentW2"])
					until _G["AutoTridentW2"] == false or not L_890_[2]["Parent"] or L_890_[2]["Humanoid"]["Máu"] <= 0
				else
		...
		pcall(function()
			if _G["LongsWord"] then
				...
				if L_893_[2] then
					repeat
						task["wait"]()
						L_1_[4]["Giết"](L_893_[2], _G["LongsWord"])
					until _G["LongsWord"] == false or not L_893_[2]["Parent"] or L_893_[2]["Humanoid"]["Máu"] <= 0
				else
		...
		if _G["BlackSpikey"] then
			pcall(function()
				...
				if L_896_[1] then
					repeat
						wait()
						L_1_[4]["Giết"](L_896_[1], _G["BlackSpikey"])
					until _G["BlackSpikey"] == false or not L_896_[1]["Parent"] or L_896_[1]["Humanoid"]["Máu"] <= 0
				else
	...
	while wait(Sec) do
		pcall(function()
			if _G["DarkBladev3"] and World2 then
				if not GetBP("Tối Blade") then
					L_1_[18]["Remotes"]["CommF_"]:InvokeServer("LoadItem", "Tối Blade")
				end
				if GetBP("Fist of Darkness") > 1 then
					if not workspace["Kẻ thù"]:FindFirstChild("Darkbeard") then
		...
		pcall(function()
			if _G["AutoEcBoss"] then
				if GetM("Ectoplasm") >= 99 then
					L_1_[18]["Remotes"]["CommF_"]:InvokeServer("Ectoplasm", "Mua", 3)
				elseif GetM("Ectoplasm") <= 99 then
					...
					if L_901_[1] then
						repeat
							wait()
							L_1_[4]["Giết"](L_901_[1], _G["AutoEcBoss"])
						until not _G["AutoEcBoss"] or not L_901_[1]["Parent"] or L_901_[1]["Humanoid"]["Máu"] <= 0
					else
						L_1_[18]["Remotes"]["CommF_"]:InvokeServer("requestEntrance", Vector3["new"](923.21252441406, 126.9760055542, 32852.83203125))
						wait(.5)
...
Q = L_1_[93]["Nhiệm vụ"]:AddToggle({
	["Name"] = "Tự động Darkbeard",
	["Description"] = "",
	["Default"] = false,
	["Callback"] = function(L_902_arg0)
		local L_903_ = {}
		L_903_[1] = L_902_arg0
		_G["Tự động_Def_DarkCoat"] = L_903_[1]
	end
})
spawn(function()
	while wait(.1) do
		if _G["Tự động_Def_DarkCoat"] then
			pcall(function()
				if GetBP("Fist of Darkness") and not workspace["Kẻ thù"]:FindFirstChild("Darkbeard") then
					_tp(CFrame["new"](3677.08203125, 62.751937866211, -3144.8332519531))
				elseif GetConnectionEnemies("Darkbeard") then
					...
					if L_904_[1] then
						repeat
							wait()
							L_1_[4]["Giết"](L_904_[1], _G["Tự động_Def_DarkCoat"])
						until _G["Tự động_Def_DarkCoat"] == false or not L_904_[1]["Parent"] or L_904_[1]["Humanoid"]["Helath"] <= 0
					end
				elseif not GetBP("Fist of Darkness") and not GetConnectionEnemies("Darkbeard") then
					repeat
						wait(.1)
						_G["AutoFarmChest"] = true
					until not _G["Tự động_Def_DarkCoat"] or GetBP("Fist of Darkness") or GetConnectionEnemies("Darkbeard")
					_G["AutoFarmChest"] = false
				end
			end)
		end
...
Q = L_1_[93]["Nhiệm vụ"]:AddToggle({
	...
	["Callback"] = function(L_905_arg0)
		local L_906_ = {}
		L_906_[1] = L_905_arg0
		_G["Tự động_DonAcces"] = L_906_[1]
	end
})
spawn(function()
	while wait(.1) do
		if _G["Tự động_DonAcces"] then
			pcall(function()
				if (L_1_[18]["Remotes"]["CommF_"]:InvokeServer("GetUnlockables"))["FlamingoAccess"] == nil and L_1_[45]["Data"]["Cấp"]["Giá trị"] >= 1500 then
					FruitPrice = {}
					FruitStore = {}
					...
					for L_910_forvar0, L_911_forvar1 in pairs(L_1_[18]["Remotes"]["CommF_"]:InvokeServer("getInventoryFruits")) do
						...
						L_1_[18]["Remotes"]["CommF_"]:InvokeServer("Cousin", "Mua")
...
Q = L_1_[93]["Nhiệm vụ"]:AddToggle({
	["Name"] = "Tự động Swan Glasses",
	["Description"] = "";
	["Default"] = false,
	["Callback"] = function(L_922_arg0)
		local L_923_ = {}
		L_923_[1] = L_922_arg0
		_G["Tự động_SwanGG"] = L_923_[1]
	end
})
spawn(function()
	while wait(.2) do
		if _G["Tự động_SwanGG"] then
			pcall(function()
				local L_924_ = {}
				...
				if L_924_[2] then
					repeat
						wait()
						L_1_[4]["Giết"](L_924_[2], _G["Tự động_SwanGG"])
					until _G["Tự động_SwanGG"] == false or not L_924_[2]["Parent"] or L_924_[2]["Humanoid"]["Máu"] <= 0
				else
		...
		if _G["AutoBigmom"] then
			pcall(function()
				...
				if L_927_[2] then
					repeat
						task["wait"]()
						L_1_[4]["Giết"](L_927_[2], _G["AutoBigmom"])
					until not _G["AutoBigmom"] or not L_927_[2]["Parent"] or L_927_[2]["Humanoid"]["Máu"] <= 0
				else
...
Q = L_1_[93]["Nhiệm vụ"]:AddToggle({
	...
	["Callback"] = function(L_928_arg0)
		local L_929_ = {}
		L_929_[1] = L_928_arg0
		_G["Tự động_Cavender"] = L_929_[1]
	end
})
spawn(function()
	while wait(Sec) do
		pcall(function()
			if _G["Tự động_Cavender"] then
				local L_930_ = {}
				L_930_[1] = GetConnectionEnemies("Beautiful Hải tặc")
				if L_930_[1] then
					repeat
						wait()
						L_1_[4]["Giết"](L_930_[1], _G["Tự động_Cavender"])
					until not _G["Tự động_Cavender"] or L_930_[1]["Humanoid"]["Máu"] <= 0
				else
		...
		pcall(function()
			if _G["TwinHook"] then
				...
				if L_933_[1] then
					repeat
						wait()
						L_1_[4]["Giết"](L_933_[1], _G["TwinHook"])
					until not _G["TwinHook"] or L_933_[1]["Humanoid"]["Máu"] <= 0
				else
	...
	while wait(Sec) do
		if _G["AutoSerpentBow"] then
			...
			if L_936_[1] then
				repeat
					wait()
					L_1_[4]["Giết"](L_936_[1], _G["AutoSerpentBow"])
				until not _G["AutoSerpentBow"] or not L_936_[1]["Parent"] or L_936_[1]["Humanoid"]["Máu"] <= 0
			else
		...
		if _G["AutoKilo"] then
			pcall(function()
				...
				if L_939_[1] then
					repeat
						task["wait"]()
						L_1_[4]["Giết"](L_939_[1], _G["AutoKilo"])
					until not _G["AutoKilo"] or not L_939_[1]["Parent"] or L_939_[1]["Humanoid"]["Máu"] <= 0
				else
...
Q = L_1_[93]["Nhiệm vụ"]:AddToggle({
	["Name"] = "Tự động Rainbow Colors",
	["Description"] = "";
	["Default"] = false;
	["Callback"] = function(L_945_arg0)
		local L_946_ = {}
		L_946_[2] = L_945_arg0
		_G["Tự động_Rainbow_Haki"] = L_946_[2]
	end
})
spawn(function()
	pcall(function()
		while wait(Sec) do
			if _G["Tự động_Rainbow_Haki"] then
				if L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == false then
					if _G["GetQFast"] then
						if L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == false then
				...
				elseif L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == true and string["find"](L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Container"]["QuestTitle"]["Title"]["Text"], "Stone") then
					local L_947_ = {}
					L_947_[1] = GetConnectionEnemies("Stone")
					if L_947_[1] then
						repeat
							wait()
							L_1_[4]["Giết"](L_947_[1], _G["Tự động_Rainbow_Haki"])
						until _G["Tự động_Rainbow_Haki"] == false or L_947_[1]["Humanoid"]["Máu"] <= 0 or not L_947_[1]["Parent"] or L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == false
					else
				...
				elseif L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == true and string["find"](L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Container"]["QuestTitle"]["Title"]["Text"], "Hydra Leader") then
					local L_948_ = {}
					L_948_[2] = GetConnectionEnemies("Hydra Leader")
					if L_948_[2] then
						repeat
							task["wait"]()
							L_1_[4]["Giết"](L_948_[2], _G["Tự động_Rainbow_Haki"])
						until _G["Tự động_Rainbow_Haki"] == false or L_948_[2]["Humanoid"]["Máu"] <= 0 or not L_948_[2]["Parent"] or L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == false
					else
						local L_949_ = {}
				...
				elseif L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == true and string["find"](L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Container"]["QuestTitle"]["Title"]["Text"], "Kilo Admiral") then
					local L_950_ = {}
					L_950_[2] = GetConnectionEnemies("Kilo Admiral")
					if L_950_[2] then
						repeat
							task["wait"]()
							L_1_[4]["Giết"](L_950_[2], _G["Tự động_Rainbow_Haki"])
						until _G["Tự động_Rainbow_Haki"] == false or L_950_[2]["Humanoid"]["Máu"] <= 0 or not L_950_[2]["Parent"] or L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == false
					else
						_tp(CFrame["new"](2877.61743, 423.558685, -7207.31006, -0.989591599, 0, -0.143904909, 0, 1.00000012, 0, .143904924, 0, -0.989591479))
					end
				elseif L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == true and string["find"](L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Container"]["QuestTitle"]["Title"]["Text"], "Captain Elephant") then
					local L_951_ = {}
					L_951_[2] = GetConnectionEnemies("Captain Elephant")
					if L_951_[2] then
						repeat
							task["wait"]()
							L_1_[4]["Giết"](L_951_[2], _G["Tự động_Rainbow_Haki"])
						until _G["Tự động_Rainbow_Haki"] == false or L_951_[2]["Humanoid"]["Máu"] <= 0 or not L_951_[2]["Parent"] or L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == false
					else
						local L_952_ = {}
				...
				elseif L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == true and string["find"](L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Container"]["QuestTitle"]["Title"]["Text"], "Beautiful Hải tặc") then
					local L_953_ = {}
					L_953_[2] = GetConnectionEnemies("Captain Elephant")
					if L_953_[2] then
						repeat
							task["wait"]()
							L_1_[4]["Giết"](L_953_[2], _G["Tự động_Rainbow_Haki"])
						until _G["Tự động_Rainbow_Haki"] == false or L_953_[2]["Humanoid"]["Máu"] <= 0 or not L_953_[2]["Parent"] or L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == false
					else
...
spawn(function()
	while wait(.2) do
		pcall(function()
			if _G["obsFarm"] then
				if World1 then
					if workspace["Kẻ thù"]:FindFirstChild("Galley Captain") then
						if KenTest then
							repeat
								wait()
								L_1_[45]["Character"]["HumanoidRootPart"]["CFrame"] = (workspace["Kẻ thù"]:FindFirstChild("Galley Captain"))["HumanoidRootPart"]["CFrame"] * CFrame["new"](3, 0, 0)
							until _G["obsFarm"] == false or KenTest == false
						else
							repeat
								wait()
								L_1_[45]["Character"]["HumanoidRootPart"]["CFrame"] = (workspace["Kẻ thù"]:FindFirstChild("Galley Captain"))["HumanoidRootPart"]["CFrame"] * CFrame["new"](0, 50, 0)
				...
				elseif World2 then
					if workspace["Kẻ thù"]:FindFirstChild("Lava Hải tặc") then
						if KenTest then
							repeat
								wait()
								L_1_[45]["Character"]["HumanoidRootPart"]["CFrame"] = (workspace["Kẻ thù"]:FindFirstChild("Lava Hải tặc"))["HumanoidRootPart"]["CFrame"] * CFrame["new"](3, 0, 0)
							until _G["obsFarm"] == false or KenTest == false
						else
							repeat
								wait()
								L_1_[45]["Character"]["HumanoidRootPart"]["CFrame"] = (workspace["Kẻ thù"]:FindFirstChild("Lava Hải tặc"))["HumanoidRootPart"]["CFrame"] * CFrame["new"](0, 50, 0)
							until _G["obsFarm"] == false or KenTest
						end
					else
				...
				elseif World3 then
					if workspace["Kẻ thù"]:FindFirstChild("Độc Kẻ tấn công") then
						if KenTest then
							repeat
								wait()
								_tp((workspace["Kẻ thù"]:FindFirstChild("Độc Kẻ tấn công"))["HumanoidRootPart"]["CFrame"] * CFrame["new"](3, 0, 0))
							until _G["obsFarm"] == false or KenTest == false
						else
							repeat
								wait()
								_tp((workspace["Kẻ thù"]:FindFirstChild("Độc Kẻ tấn công"))["HumanoidRootPart"]["CFrame"] * CFrame["new"](0, 50, 0))
							until _G["obsFarm"] == false or KenTest
						end
					else
	...
	while wait(Sec) do
		if _G["AutoKenVTWO"] then
			pcall(function()
				...
				if L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == true and string["find"](L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Container"]["QuestTitle"]["Title"]["Text"], L_1_[2]({
					"Defeat 50 Forest Pir";
					"ates"
				})) then
					local L_961_ = {}
					L_961_[1] = GetConnectionEnemies("Forest Hải tặc")
					if L_961_[1] then
						repeat
							wait()
							L_1_[4]["Giết"](L_961_[1], _G["AutoKenVTWO"])
						until not _G["AutoKenVTWO"] or L_961_[1]["Humanoid"]["Máu"] <= 0 or L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == false
					else
						_tp(L_960_[2])
					end
				elseif L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == true then
					local L_962_ = {}
					L_962_[1] = GetConnectionEnemies("Captain Elephant")
					if L_962_[1] then
						repeat
							wait()
							L_1_[4]["Giết"](L_962_[1], _G["AutoKenVTWO"])
						until not _G["AutoKenVTWO"] or L_962_[1]["Humanoid"]["Máu"] <= 0 or L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == false
					else
						_tp(L_960_[4])
					end
				elseif L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == false then
				...
				if not L_1_[45]["Backpack"]:FindFirstChild("Fruit Bowl") or not L_1_[45]["Character"]:FindFirstChild("Fruit Bowl") then
					...
					if L_1_[45]["Backpack"]:FindFirstChild("Fruit Bowl") or L_1_[45]["Character"]:FindFirstChild("Fruit Bowl") then
						...
						elseif L_1_[45]["Character"]["HumanoidRootPart"]["CFrame"] == L_960_[3] then
							...
							wait(.1)
							L_1_[18]["Remotes"]["CommF_"]:InvokeServer("KenTalk2", "Mua")
						end
					end
				end
			end)
...
Bartilo = L_1_[93]["Nhiệm vụ"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động Done Bartilo Qu";
		"est"
	});
	["Description"] = "";
	["Default"] = false,
	["Callback"] = function(L_972_arg0)
		local L_973_ = {}
		L_973_[2] = L_972_arg0
		_G["Bartilo_Nhiệm vụ"] = L_973_[2]
	end
})
spawn(function()
	while wait(.1) do
		pcall(function()
			if _G["Bartilo_Nhiệm vụ"] and Lv >= 850 then
				local L_974_ = {}
				L_974_[2] = L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]
				if L_1_[18]["Remotes"]["CommF_"]:InvokeServer("BartiloQuestProgress", "Bartilo") == 0 then
					_G["Cấp"] = false
					if L_974_[2]["Visible"] == true then
						local L_975_ = {}
						L_975_[1] = GetConnectionEnemies("Swan Hải tặc")
						if L_975_[1] then
							local L_976_ = {}
							...
							if L_976_[2] then
								repeat
									task["wait"]()
									if not string["find"](L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Container"]["QuestTitle"]["Title"]["Text"], "Swan Hải tặc") then
										L_1_[18]["Remotes"]["CommF_"]:InvokeServer("AbandonQuest")
									else
										L_1_[4]["Giết"](L_976_[2], _G["Bartilo_Nhiệm vụ"])
									end
								until _G["Bartilo_Nhiệm vụ"] == false or not L_976_[2]["Parent"] or L_976_[2]["Humanoid"]["Máu"] <= 0 or L_974_[2]["Visible"] == false or not L_976_[2]:FindFirstChild("HumanoidRootPart")
							end
						else
						...
						until ((CFrame["new"](-461.533203, 72.3478546, 300.311096, .050853312, 0, -0.998706102, 0, 1, 0, .998706102, 0, .050853312))["Position"] - L_1_[45]["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] <= 20 or _G["Bartilo_Nhiệm vụ"] == false
				...
				elseif L_1_[18]["Remotes"]["CommF_"]:InvokeServer("BartiloQuestProgress", "Bartilo") == 1 then
					...
					if L_977_[2] then
						repeat
							task["wait"]()
							L_1_[4]["Giết"](L_977_[2], _G["Bartilo_Nhiệm vụ"])
						until _G["Bartilo_Nhiệm vụ"] == false or not L_977_[2]["Parent"] or L_977_[2]["Humanoid"]["Máu"] <= 0 or L_974_[2]["Visible"] == false or not L_977_[2]:FindFirstChild("HumanoidRootPart")
					else
				...
				elseif L_1_[18]["Remotes"]["CommF_"]:InvokeServer("BartiloQuestProgress", "Bartilo") == 2 then
					...
					until ((CFrame["new"](-1830.83972, 10.5578213, 1680.60229, .979988456, -2.02152783e-08, -0.199054286, 2.20792113e-08, 1, 7.1442483e-09, .199054286, -1.13962431e-08, .979988456))["Position"] - L_1_[45]["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] <= 1 or _G["Bartilo_Nhiệm vụ"] == false
					wait(.5)
...
CitizenQ = L_1_[93]["Nhiệm vụ"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động Done Citizen Qu";
		"est"
	});
	["Description"] = "";
	["Default"] = false;
		...
		pcall(function()
			if _G["CitizenQuest"] then
				if Lv >= 1800 and (L_1_[18]["Remotes"]["CommF_"]:InvokeServer("CitizenQuestProgress"))["KilledBandits"] == false then
					if string["find"](L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Container"]["QuestTitle"]["Title"]["Text"], "Forest Hải tặc") and (string["find"](L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Container"]["QuestTitle"]["Title"]["Text"], "50") and L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == true) then
						local L_980_ = {}
						L_980_[1] = GetConnectionEnemies("Forest Hải tặc")
						if L_980_[1] then
							repeat
								task["wait"]()
								L_1_[4]["Giết"](L_980_[1], _G["CitizenQuest"])
							until _G["CitizenQuest"] == false or not L_980_[1]["Parent"] or L_980_[1]["Humanoid"]["Máu"] <= 0 or L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == false
						else
				...
				elseif Lv >= 1800 and (L_1_[18]["Remotes"]["CommF_"]:InvokeServer("CitizenQuestProgress"))["KilledBoss"] == false then
					...
					if L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] and (string["find"](L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Container"]["QuestTitle"]["Title"]["Text"], "Captain Elephant") and L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == true) then
						if L_981_[2] then
							repeat
								task["wait"]()
								L_1_[4]["Giết"](L_981_[2], _G["CitizenQuest"])
							until _G["CitizenQuest"] == false or L_981_[2]["Humanoid"]["Máu"] <= 0 or not L_981_[2]["Parent"] or L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == false
						else
			...
			pcall(function()
				if L_1_[45]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == false then
					...
					if L_985_[2] then
						repeat
							wait()
							L_1_[4]["Giết"](L_985_[2], _G["DummyMan"])
						until not _G["DummyMan"] or not L_985_[2]["Parent"] or L_985_[2]["Humanoid"]["Máu"] <= 0
					else
...
SuperHuman = L_1_[93]["Nhiệm vụ"]:AddToggle({
	...
	["Callback"] = function(L_986_arg0)
		local L_987_ = {}
		L_987_[2] = L_986_arg0
		_G["Tự động_SuperHuman"] = L_987_[2]
	end
})
spawn(function()
	while wait(Sec) do
		pcall(function()
			if _G["Tự động_SuperHuman"] then
				local L_988_ = {}
				L_988_[2] = L_1_[45]["Data"]["Beli"]["Giá trị"]
				L_988_[1] = L_1_[45]["Data"]["Fragments"]["Giá trị"]
				if L_1_[45]:FindFirstChild("WeaponAssetCache") then
					if not GetBP("Superhuman") then
						...
						elseif GetBP("Black Leg") and (GetBP("Black Leg"))["Cấp"]["Giá trị"] < 299 then
							_G["Cấp"] = true
						elseif GetBP("Black Leg") and (GetBP("Black Leg"))["Cấp"]["Giá trị"] >= 300 then
							_G["Cấp"] = false
						end
						...
						elseif GetBP("Electro") and (GetBP("Electro"))["Cấp"]["Giá trị"] < 299 then
							_G["Cấp"] = true
						elseif GetBP("Electro") and (GetBP("Electro"))["Cấp"]["Giá trị"] >= 300 then
							_G["Cấp"] = false
						end
						...
						elseif GetBP("Fishman Karate") and (GetBP("Fishman Karate"))["Cấp"]["Giá trị"] < 299 then
							_G["Cấp"] = true
						elseif GetBP("Fishman Karate") and (GetBP("Fishman Karate"))["Cấp"]["Giá trị"] >= 300 then
							_G["Cấp"] = false
						end
						if not GetBP("Rồng Claw") then
							if L_988_[1] >= 1500 then
								L_1_[18]["Remotes"]["CommF_"]:InvokeServer("BlackbeardReward", "DragonClaw", "2")
							end
						elseif GetBP("Rồng Claw") and (GetBP("Rồng Claw"))["Cấp"]["Giá trị"] < 299 then
							_G["Cấp"] = true
						elseif GetBP("Rồng Claw") and (GetBP("Rồng Claw"))["Cấp"]["Giá trị"] >= 300 then
							_G["Cấp"] = false
						end
...
DeathStep = L_1_[93]["Nhiệm vụ"]:AddToggle({
	["Name"] = "Tự động DeathStep",
	["Description"] = "",
	["Default"] = false,
			...
			pcall(function()
				if L_1_[45]:FindFirstChild("WeaponAssetCache") then
					if not GetBP("Death Step") then
						...
						if GetBP("Black Leg") and (GetBP("Black Leg"))["Cấp"]["Giá trị"] >= 400 then
							L_1_[18]["Remotes"]["CommF_"]:InvokeServer("BuyDeathStep")
							_G["Cấp"] = false
						elseif GetBP("Black Leg") and (GetBP("Black Leg"))["Cấp"]["Giá trị"] < 399 then
							_G["Cấp"] = true
						end
						if GetBP("Black Leg") or (GetBP("Black Leg"))["Cấp"]["Giá trị"] >= 400 then
							if workspace["Map"]["IceCastle"]["Hall"]["LibraryDoor"]["PhoeyuDoor"]["Transparency"] == 0 then
								...
								elseif not GetBP("Library Key") then
									...
									if L_991_[1] then
										repeat
											wait()
											L_1_[4]["Giết"](L_991_[1], _G["AutoDeathStep"])
										until not L_991_[1]["Parent"] or L_991_[1]["Humanoid"]["Máu"] <= 0 or _G["AutoDeathStep"] == false or GetBP("Library Key") or GetBP("Death Step")
									else
										_tp(CFrame["new"](5668.9780273438, 28.519989013672, -6483.3520507813))
									end
								end
...
SharkManV2 = L_1_[93]["Nhiệm vụ"]:AddToggle({
	...
	["Callback"] = function(L_992_arg0)
		local L_993_ = {}
		L_993_[2] = L_992_arg0
		_G["Tự động_SharkMan_Karate"] = L_993_[2]
	end
})
spawn(function()
	while wait(Sec) do
		if _G["Tự động_SharkMan_Karate"] then
			pcall(function()
				if L_1_[45]:FindFirstChild("WeaponAssetCache") then
					if not GetBP("Sharkman Karate") then
						...
						if GetBP("Fishman Karate") and (GetBP("Fishman Karate"))["Cấp"]["Giá trị"] >= 400 then
							L_1_[18]["Remotes"]["CommF_"]:InvokeServer("BuySharkmanKarate")
							_G["Cấp"] = false
						elseif GetBP("Fishman Karate") and (GetBP("Fishman Karate"))["Cấp"]["Giá trị"] < 399 then
							_G["Cấp"] = true
						end
						if GetBP("Fishman Karate") or (GetBP("Fishman Karate"))["Cấp"]["Giá trị"] >= 400 then
							if GetBP("Water Key") then
								if string["find"](L_1_[18]["Remotes"]["CommF_"]:InvokeServer("BuySharkmanKarate"), "keys") then
									if GetBP("Water Key") then
										...
										until not _G["Tự động_SharkMan_Karate"] or Root["Position"] == (CFrame["new"](-2604.6958, 239.432526, -10315.1982, .0425701365, 0, -0.999093413, 0, 1, 0, .999093413, 0, .0425701365))["Position"]
										L_1_[18]["Remotes"]["CommF_"]:InvokeServer("BuySharkmanKarate")
									end
								end
							elseif not GetBP("Water Key") then
								...
								if L_994_[2] then
									repeat
										wait()
										L_1_[4]["Giết"](L_994_[2], _G["Tự động_SharkMan_Karate"])
									until not L_994_[2]["Parent"] or L_994_[2]["Humanoid"]["Máu"] <= 0 or _G["Tự động_SharkMan_Karate"] == false or GetBP("Water Key") or GetBP("Sharkman Karate")
								else
...
ElectricClaw = L_1_[93]["Nhiệm vụ"]:AddToggle({
	["Name"] = "Tự động ElectricClaw",
	["Description"] = "",
	["Default"] = false,
	["Callback"] = function(L_995_arg0)
		local L_996_ = {}
		L_996_[2] = L_995_arg0
		_G["Tự động_Electric_Claw"] = L_996_[2]
	end
})
spawn(function()
	while wait(Sec) do
		if _G["Tự động_Electric_Claw"] then
			pcall(function()
				if L_1_[45]:FindFirstChild("WeaponAssetCache") then
					if not GetBP("Electro") then
						L_1_[18]["Remotes"]["CommF_"]:InvokeServer("BuyElectro")
					end
					if GetBP("Electro") and (GetBP("Electro"))["Cấp"]["Giá trị"] >= 400 then
					...
					elseif GetBP("Electro") and (GetBP("Electro"))["Cấp"]["Giá trị"] < 400 then
						repeat
							_G["AutoFarm_Bone"] = true
							wait()
						until not _G["Tự động_Electric_Claw"] or GetBP("Electric Claw")
...
DragonTalon = L_1_[93]["Nhiệm vụ"]:AddToggle({
	["Name"] = "Tự động DragonTalon";
	["Description"] = "";
	["Default"] = false;
		...
		if _G["AutoDragonTalon"] then
			pcall(function()
				if L_1_[45]:FindFirstChild("WeaponAssetCache") then
					...
					if GetBP("Rồng Claw") and (GetBP("Rồng Claw"))["Cấp"]["Giá trị"] >= 400 then
						L_1_[18]["Remotes"]["CommF_"]:InvokeServer("Bones", "Mua", 1, 1)
						L_1_[18]["Remotes"]["CommF_"]:InvokeServer("BuyDragonTalon")
					elseif GetBP("Rồng Claw") and (GetBP("Rồng Claw"))["Cấp"]["Giá trị"] < 400 then
						repeat
							_G["AutoFarm_Bone"] = true
							wait()
						until not _G["AutoDragonTalon"] or GetBP("Rồng Talon")
						_G["AutoFarm_Bone"] = false
					end
				end
			end)
...
Godhuman = L_1_[93]["Nhiệm vụ"]:AddToggle({
	...
	["Callback"] = function(L_999_arg0)
		...
		_G["Tự động_God_Human"] = L_1000_[2]
	end
})
spawn(function()
	while wait() do
		pcall(function()
			if _G["Tự động_God_Human"] then
				if L_1_[18]["Remotes"]["CommF_"]:InvokeServer("BuyGodhuman", true) == L_1_[2]({
					...
					if GetM("Rồng Scale") == false or GetM("Rồng Scale") < 10 then
						if World3 then
							Lv = 1575
							_G["Cấp"] = true
						else
...
SanguineArt = L_1_[93]["Nhiệm vụ"]:AddToggle({
	["Name"] = "Tự động SanguineArt",
	["Description"] = "",
	["Default"] = false,
		...
		if _G["Snaguine"] then
			pcall(function()
				...
				if not GetBP("Sanguine Art") then
					...
					if GetM("Vampire Fang") <= 19 then
						if World2 then
							...
							if L_1003_[1] then
								repeat
									task["wait"]()
									L_1_[4]["Giết"](L_1003_[1], _G["Snaguine"])
								until not _G["Snaguine"] or L_1003_[1]["Humanoid"]["Máu"] <= 0 or not L_1003_[1]["Parent"]
							else
					...
					if GetM("Vampire Fang") >= 20 and GetM("Demonic Wisp") <= 19 then
						if World3 then
							...
							if L_1004_[1] then
								repeat
									task["wait"]()
									L_1_[4]["Giết"](L_1004_[1], _G["Snaguine"])
								until not _G["Snaguine"] or L_1004_[1]["Humanoid"]["Máu"] <= 0 or not L_1004_[1]["Parent"]
							else
								_tp(CFrame["new"](-9495.6806640625, 453.58624267578, 5977.3486328125))
							end
						else
					...
					if GetM("Vampire Fang") >= 20 and (GetM("Demonic Wisp") >= 20 and GetM("Tối Fragment") <= 1) then
						if World2 then
							local L_1005_ = {}
							...
							if L_1005_[2] then
								repeat
									task["wait"]()
									L_1_[4]["Giết"](black, _G["Snaguine"])
								until _G["Snaguine"] or black["Humanoid"]["Máu"] <= 0 or not black["Parent"]
							else
								_tp(CFrame["new"](3798.4575195313, 13.826690673828, -3399.806640625))
							end
						else
		...
		if _G["FarmChestM"] then
			pcall(function()
				if workspace["Map"]["MysticIsland"]["Chests"]:FindFirstChild("DiamondChest") or workspace["Map"]["MysticIsland"]["Chests"]:FindFirstChild("FragChest") then
					...
					L_1038_[4] = game:GetService("Người chơi")
					L_1038_[5] = L_1038_[4]["Người chơi cục bộ"]
...
L_1_[93]["Race"]:AddButton({
	...
	["Callback"] = function()
		...
		((L_1_[18]:WaitForChild("Remotes")):WaitForChild("CommF_")):InvokeServer("RaceV4Progress", "Dịch chuyển");
...
RaceMink = L_1_[93]["Race"]:AddToggle({
	["Name"] = "Tự động Upgrade Mink",
	["Description"] = "",
	["Default"] = false;
	["Callback"] = function(L_1046_arg0)
		local L_1047_ = {}
		L_1047_[2] = L_1046_arg0
		_G["Tự động_Mink"] = L_1047_[2]
	end
})
spawn(function()
	while wait(Sec) do
		pcall(function()
			if _G["Tự động_Mink"] then
				if L_1_[18]["Remotes"]["CommF_"]:InvokeServer("Alchemist", "1") ~= 2 then
					...
					elseif L_1_[18]["Remotes"]["CommF_"]:InvokeServer("Alchemist", "1") == 1 then
						...
						elseif not L_1_[45]["Backpack"]:FindFirstChild("Flower 3") and not L_1_[45]["Character"]:FindFirstChild("Flower 3") then
							local L_1048_ = {}
							L_1048_[2] = GetConnectionEnemies("Swan Hải tặc")
							if L_1048_[2] then
								repeat
									wait()
									L_1_[4]["Giết"](L_1048_[2], _G["Tự động_Mink"])
								until GetBP("Flower 3") or not L_1048_[2]["Parent"] or L_1048_[2]["Humanoid"]["Máu"] <= 0 or _G["Tự động_Mink"] == false
							else
...
RaceHuman = L_1_[93]["Race"]:AddToggle({
	["Name"] = "Tự động Upgrade Human",
	["Description"] = "",
	["Default"] = false;
	["Callback"] = function(L_1049_arg0)
		local L_1050_ = {}
		L_1050_[1] = L_1049_arg0
		_G["Tự động_Human"] = L_1050_[1]
	end
})
spawn(function()
	while wait(Sec) do
		pcall(function()
			if _G["Tự động_Human"] then
				if L_1_[18]["Remotes"]["CommF_"]:InvokeServer("Alchemist", "1") ~= -2 then
					if L_1_[18]["Remotes"]["CommF_"]:InvokeServer("Alchemist", "1") == 0 then
						L_1_[18]["Remotes"]["CommF_"]:InvokeServer("Alchemist", "2")
					elseif L_1_[18]["Remotes"]["CommF_"]:InvokeServer("Alchemist", "1") == 1 then
						...
						elseif not L_1_[45]["Backpack"]:FindFirstChild("Flower 3") and not L_1_[45]["Character"]:FindFirstChild("Flower 3") then
							local L_1051_ = {}
							L_1051_[1] = GetConnectionEnemies("Swan Hải tặc")
							if L_1051_[1] then
								repeat
									wait()
									L_1_[4]["Giết"](L_1051_[1], _G["Tự động_Human"])
								until L_1_[45]["Backpack"]:FindFirstChild("Flower 3") or not L_1051_[1]["Parent"] or L_1051_[1]["Humanoid"]["Máu"] <= 0 or _G["Tự động_Human"] == false
							else
								_tp(CFrame["new"](980.09851074219, 121.33129882812, 1287.2093505859))
							end
						end
				...
				elseif L_1_[18]["Remotes"]["CommF_"]:InvokeServer("Wenlocktoad", "1") == 1 then
					...
					if L_1052_[1] then
						repeat
							wait()
							L_1_[4]["Giết"](L_1052_[1], _G["Tự động_Human"])
						until L_1052_[1]["Humanoid"]["Máu"] <= 0 or not L_1052_[1]["Parent"] or not _G["Tự động_Human"]
					else
					...
					if L_1052_[4] then
						repeat
							wait()
							L_1_[4]["Giết"](L_1052_[4], _G["Tự động_Human"])
						until L_1052_[4]["Humanoid"]["Máu"] <= 0 or not L_1052_[4]["Parent"] or not _G["Tự động_Human"]
					else
						_tp(CFrame["new"](2006.9261474609, 448.95666503906, 853.98284912109))
					end
					...
					if L_1052_[3] then
						repeat
							wait()
							L_1_[4]["Giết"](L_1052_[3], _G["Tự động_Human"])
						until L_1052_[3]["Humanoid"]["Máu"] <= 0 or not L_1052_[3]["Parent"] or not _G["Tự động_Human"]
					else
						_tp(CFrame["new"](-1576.7166748047, 198.59265136719, 13.724286079407))
					end
				end
...
RaceSky = L_1_[93]["Race"]:AddToggle({
	["Name"] = "Tự động Upgrade Angel",
	["Description"] = "",
	["Default"] = false,
	["Callback"] = function(L_1053_arg0)
		local L_1054_ = {}
		L_1054_[2] = L_1053_arg0
		_G["Tự động_Skypiea"] = L_1054_[2]
	end
})
spawn(function()
	while wait(Sec) do
		pcall(function()
			if _G["Tự động_Skypiea"] then
				if L_1_[18]["Remotes"]["CommF_"]:InvokeServer("Alchemist", "1") ~= -2 then
					if L_1_[18]["Remotes"]["CommF_"]:InvokeServer("Alchemist", "1") == 0 then
						L_1_[18]["Remotes"]["CommF_"]:InvokeServer("Alchemist", "2")
					elseif L_1_[18]["Remotes"]["CommF_"]:InvokeServer("Alchemist", "1") == 1 then
						...
						elseif not L_1_[45]["Backpack"]:FindFirstChild("Flower 3") and not L_1_[45]["Character"]:FindFirstChild("Flower 3") then
							local L_1055_ = {}
							L_1055_[1] = GetConnectionEnemies("Swan Hải tặc")
							if L_1055_[1] then
								repeat
									wait()
									L_1_[4]["Giết"](L_1055_[1], _G["Tự động_Skypiea"])
								until L_1_[45]["Backpack"]:FindFirstChild("Flower 3") or not L_1055_[1]["Parent"] or L_1055_[1]["Humanoid"]["Máu"] <= 0 or _G["Tự động_Skypiea"] == false
							else
								_tp(CFrame["new"](980.09851074219, 121.33129882812, 1287.2093505859))
							end
						end
				...
				elseif L_1_[18]["Remotes"]["CommF_"]:InvokeServer("Wenlocktoad", "1") == 0 then
					L_1_[18]["Remotes"]["CommF_"]:InvokeServer("Wenlocktoad", "2")
				elseif L_1_[18]["Remotes"]["CommF_"]:InvokeServer("Wenlocktoad", "1") == 1 then
					for L_1056_forvar0, L_1057_forvar1 in pairs(game["Người chơi"]:GetChildren()) do
						local L_1058_ = {}
						L_1058_[3], L_1058_[1] = L_1056_forvar0, L_1057_forvar1
						if L_1058_[1]["Name"] ~= L_1_[45]["Name"] and tostring(L_1058_[1]["Data"]["Race"]["Giá trị"]) == "Skypiea" then
							repeat
								task["wait"]()
								_tp((L_1058_[1]["HumanoidRootPart"]["CFrame"] * CFrame["new"](0, 8, 0)) * CFrame["Angles"](math["rad"](-45), 0, 0))
							until L_1058_[1]["Humanoid"]["Máu"] <= 0 or _G["Tự động_Skypiea"] == false
						end
					end
				end
			end
...
RaceFish = L_1_[93]["Race"]:AddToggle({
	["Name"] = "Tự động Upgrade FishMan";
	["Description"] = "",
	["Default"] = false;
	["Callback"] = function(L_1059_arg0)
		local L_1060_ = {}
		L_1060_[2] = L_1059_arg0
		_G["Tự động_Fish"] = L_1060_[2]
	end
})
spawn(function()
	while wait(Sec) do
		pcall(function()
			if _G["Tự động_Fish"] then
				if L_1_[18]["Remotes"]["CommF_"]:InvokeServer("Alchemist", "1") ~= -2 then
					if L_1_[18]["Remotes"]["CommF_"]:InvokeServer("Alchemist", "1") == 0 then
						L_1_[18]["Remotes"]["CommF_"]:InvokeServer("Alchemist", "2")
					elseif L_1_[18]["Remotes"]["CommF_"]:InvokeServer("Alchemist", "1") == 1 then
						...
						elseif not L_1_[45]["Backpack"]:FindFirstChild("Flower 3") and not L_1_[45]["Character"]:FindFirstChild("Flower 3") then
							local L_1061_ = {}
							L_1061_[1] = GetConnectionEnemies("Swan Hải tặc")
							if L_1061_[1] then
								repeat
									wait()
									L_1_[4]["Giết"](L_1061_[1], _G["Tự động_Fish"])
								until L_1_[45]["Backpack"]:FindFirstChild("Flower 3") or not L_1061_[1]["Parent"] or L_1061_[1]["Humanoid"]["Máu"] <= 0 or _G["Tự động_Fish"] == false
							else
								_tp(CFrame["new"](980.09851074219, 121.33129882812, 1287.2093505859))
							end
						end
...
spawn(function()
	pcall(function()
		while wait(.2) do
			CheckTier:SetDesc(" Tiers - V4  :" .. (" " .. L_1_[45]["Data"]["Race"]["C"]["Giá trị"]))
		end
	end)
end)
PullLv = L_1_[93]["Race"]:AddToggle({
	["Name"] = "Tự động Pull Lever",
	["Description"] = "";
	["Default"] = false;
		...
		pcall(function()
			if _G["AcientOne"] then
				...
				for L_1070_forvar0 = 1, #L_1069_[2], 1 do
					if (L_1_[45]["Character"]:FindFirstChild("RaceEnergy"))["Giá trị"] == 1 then
						vim1:SendKeyEvent(true, "Y", false, game)
						L_1_[18]["Remotes"]["CommF_"]:InvokeServer("UpgradeRace", "Mua")
						_tp(CFrame["new"](-8987.041015625, 215.86206054688, 5886.7104492188))
					elseif (L_1_[45]["Character"]:FindFirstChild("RaceTransformed"))["Giá trị"] == false then
						local L_1071_ = {}
						L_1071_[1] = GetConnectionEnemies(L_1069_[2])
						if L_1071_[1] then
							repeat
								wait()
								L_1_[4]["Giết"](L_1071_[1], _G["AcientOne"])
							until _G["AcientOne"] == false or L_1071_[1]["Humanoid"]["Máu"] <= 0 or not L_1071_[1]["Parent"]
						else
							_tp(CFrame["new"](-9495.6806640625, 453.58624267578, 5977.3486328125))
						end
					end
...
L_1_[93]["Race"]:AddButton({
	["Name"] = L_1_[2]({
		"Dịch chuyển to Temple o";
		"f Time"
	});
	["Description"] = "";
	["Callback"] = function()
		local L_1072_ = {}
		L_1072_[1] = (game:GetService("Người chơi"))["Người chơi cục bộ"]
...
L_1_[93]["Race"]:AddButton({
	["Name"] = L_1_[2]({
		"Dịch chuyển to Ancient ";
		"One"
	});
	["Description"] = "";
	["Callback"] = function()
		local L_1074_ = {}
		L_1074_[3] = (game:GetService("Người chơi"))["Người chơi cục bộ"]
...
L_1_[93]["Race"]:AddButton({
	...
	["Callback"] = function()
		local L_1076_ = {}
		L_1076_[1] = (game:GetService("Người chơi"))["Người chơi cục bộ"]
...
spawn(function()
	while wait(Sec) do
		pcall(function()
			if _G["TPDoor"] then
				if tostring(L_1_[45]["Data"]["Race"]["Giá trị"]) == "Mink" then
					_tp(CFrame["new"](29020.66015625, 14889.426757812, -379.2682800293))
				elseif tostring(L_1_[45]["Data"]["Race"]["Giá trị"]) == "Fishman" then
					_tp(CFrame["new"](28224.056640625, 14889.426757812, -210.58720397949))
				elseif tostring(L_1_[45]["Data"]["Race"]["Giá trị"]) == "Cyborg" then
					_tp(CFrame["new"](28492.4140625, 14894.426757812, -422.11001586914))
				elseif tostring(L_1_[45]["Data"]["Race"]["Giá trị"]) == "Skypiea" then
					_tp(CFrame["new"](28967.408203125, 14918.075195312, 234.31198120117))
				elseif tostring(L_1_[45]["Data"]["Race"]["Giá trị"]) == "Ghoul" then
					_tp(CFrame["new"](28672.720703125, 14889.127929688, 454.59616088867))
				elseif tostring(L_1_[45]["Data"]["Race"]["Giá trị"]) == "Human" then
	...
	if FishmanTrial then
		for L_1082_forvar0, L_1083_forvar1 in next, workspace["SeaBeasts"]:GetChildren() do
			...
			if L_1084_[2]:FindFirstChild("HumanoidRootPart") and (L_1084_[2]["HumanoidRootPart"]["Position"] - FishmanTrial["Position"])["Magnitude"] <= 1500 then
				if L_1084_[2]["Máu"]["Giá trị"] > 0 then
					return L_1084_[2]
				end
			end
		end
...
spawn(function()
	while wait(Sec) do
		pcall(function()
			if _G["Complete_Trials"] then
				if tostring(L_1_[45]["Data"]["Race"]["Giá trị"]) == "Fishman" then
...
spawn(function()
	while wait(Sec) do
		pcall(function()
			if _G["Complete_Trials"] then
				if tostring(L_1_[45]["Data"]["Race"]["Giá trị"]) == "Cyborg" then
...
spawn(function()
	while wait(Sec) do
		pcall(function()
			if _G["Complete_Trials"] then
				if tostring(L_1_[45]["Data"]["Race"]["Giá trị"]) == "Skypiea" then
...
spawn(function()
	while wait(.1) do
		pcall(function()
			if _G["Complete_Trials"] then
				if tostring(L_1_[45]["Data"]["Race"]["Giá trị"]) == "Human" or tostring(L_1_[45]["Data"]["Race"]["Giá trị"]) == "Ghoul" then
					local L_1085_ = {}
					L_1085_[2] = {
						"Ancient Vampire";
						"Ancient Zombie"
					...
					if L_1085_[3] then
						repeat
							wait()
							L_1_[4]["Giết"](L_1085_[3], _G["Complete_Trials"])
						until _G["Complete_Trials"] == false or not L_1085_[3]["Parent"] or L_1085_[3]["Humanoid"]["Máu"] <= 0
					end
				end
			end
		end)
			...
			if _G["Defeating"] then
				for L_1088_forvar0, L_1089_forvar1 in pairs(workspace["Characters"]:GetChildren()) do
					...
					if L_1090_[1]["Name"] ~= L_1_[45]["Name"] then
						if L_1090_[1]["Humanoid"]["Máu"] > 0 and (L_1090_[1]:FindFirstChild("HumanoidRootPart") and (L_1090_[1]["Parent"] and (Root["Position"] - L_1090_[1]["HumanoidRootPart"]["Position"])["Magnitude"] <= 250)) then
							repeat
								task["wait"]()
								EquipWeapon(_G["SelectWeapon"])
								_tp(L_1090_[1]["HumanoidRootPart"]["CFrame"] * CFrame["new"](0, 0, 15))
								sethiddenproperty(L_1_[45], "SimulationRadius", math["huge"])
							until _G["Defeating"] == false or L_1090_[1]["Humanoid"]["Máu"] <= 0 or not L_1090_[1]["Parent"] or not L_1090_[1]:FindFirstChild("HumanoidRootPart") or not L_1090_[1]:FindFirstChild("Humanoid")
						end
					end
				end
			end
...
function printBeltName(L_1093_arg0)
	...
	if type(L_1094_[1]) == "table" and L_1094_[1]["Nhiệm vụ"]["BeltName"] then
		return L_1094_[1]["Nhiệm vụ"]["BeltName"]
	end
end
spawn(function()
	while wait(Sec) do
				...
				elseif debug == true and ((CFrame["new"](5865.0234375, 1208.3154296875, 871.15185546875))["Position"] - L_1_[45]["Character"]["HumanoidRootPart"]["Position"])["Magnitude"] <= 50 then
					if L_1095_[1] == "White" then
						...
						if L_1096_[1] then
							repeat
								task["wait"]()
								L_1_[4]["Giết"](L_1096_[1], _G["Dojoo"])
					...
					elseif L_1095_[1] == "Black" then
						repeat
							...
							if workspace["Map"]:FindFirstChild("PrehistoricIsland") or workspace["_WorldOrigin"]["Locations"]:FindFirstChild("Prehistoric Island") then
								_G["Prehis_Find"] = true
								if workspace["Map"]["PrehistoricIsland"]["Lõi"]["ActivationPrompt"]:FindFirstChild("ProximityPrompt", true) then
						...
						_G["Prehis_Find"] = false
						_G["Prehis_Skills"] = false
					elseif L_1095_[1] == "Orange" or L_1095_[1] == "Xanh" then
						return nil
					end
				end
...
BackTODoJo = function()
	for L_1107_forvar0, L_1108_forvar1 in pairs((game:GetService("Người chơi"))["Người chơi cục bộ"]["PlayerGui"]["Notifications"]:GetChildren()) do
		local L_1109_ = {}
...
DragonMobClear = function(L_1110_arg0, L_1111_arg1, L_1112_arg2)
	...
	if workspace["Kẻ thù"]:FindFirstChild(L_1113_[4]) then
		for L_1114_forvar0, L_1115_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
			local L_1116_ = {}
			L_1116_[2], L_1116_[3] = L_1114_forvar0, L_1115_forvar1
			if L_1116_[3]["Name"] == L_1113_[4] and L_1_[4]["Alive"](L_1116_[3]) then
				if L_1113_[3] then
					L_1_[4]["Giết"](L_1116_[3], L_1113_[3])
				end
			end
		end
	else
		...
		if _G["FarmBlazeEM"] then
			pcall(function()
				...
				if L_1117_[1] == true and not BackTODoJo() then
					if L_1117_[4] == 1 then
						if L_1117_[5] == "Hydra Enforcer" or L_1117_[5] == "Độc Kẻ tấn công" then
							repeat
								wait()
		...
		if _G["FarmBlazeEM"] then
			pcall(function()
				if workspace["EmberTemplate"]:FindFirstChild("Part") then
					game["Người chơi"]["Người chơi cục bộ"]["Character"]["HumanoidRootPart"]["CFrame"] = workspace["EmberTemplate"]["Part"]["CFrame"]
				end
			end)
		end
	end
...
spawn(function()
	while wait(Sec) do
		pcall(function()
			if _G["DragoV1"] then
				if GetM("Rồng Egg") <= 0 then
					repeat
						wait()
						_G["Prehis_Find"] = true
						_G["Prehis_Skills"] = true
						_G["Prehis_DE"] = true
					until not _G["DragoV1"] or GetM("Rồng Egg") >= 1
					_G["Prehis_Find"] = false
					_G["Prehis_Skills"] = false
					_G["Prehis_DE"] = false
				end
...
spawn(function()
	while wait(Sec) do
		if _G["AutoFireFlowers"] then
			...
			L_1126_[2] = GetConnectionEnemies("Forest Hải tặc")
			if L_1126_[2] then
				repeat
					wait()
					L_1_[4]["Giết"](L_1126_[2], _G["AutoFireFlowers"])
				until not _G["AutoFireFlowers"] or not L_1126_[2]["Parent"] or L_1126_[2]["Humanoid"]["Máu"] <= 0 or L_1126_[1]
			else
				_tp(CFrame["new"](-13206.452148438, 425.89199829102, -7964.5537109375))
			end
			if L_1126_[1] then
				for L_1127_forvar0, L_1128_forvar1 in pairs(L_1126_[1]:GetChildren()) do
					...
					if L_1129_[3]:IsA("Model") and L_1129_[3]["PrimaryPart"] then
						...
						L_1130_[4] = game["Người chơi"]["Người chơi cục bộ"]["Character"]["HumanoidRootPart"]["Position"]
		...
		pcall(function()
			if _G["TrainDrago"] then
				...
				for L_1139_forvar0 = 1, #L_1138_[2], 1 do
					if (L_1_[45]["Character"]:FindFirstChild("RaceEnergy"))["Giá trị"] == 1 then
						vim1:SendKeyEvent(true, "Y", false, game)
						L_1_[18]["Remotes"]["CommF_"]:InvokeServer("UpgradeRace", "Mua", 2)
					...
					elseif (L_1_[45]["Character"]:FindFirstChild("RaceTransformed"))["Giá trị"] == false then
						...
						if L_1140_[1] then
							repeat
								wait()
								L_1_[4]["Giết"](L_1140_[1], _G["TrainDrago"])
							until _G["TrainDrago"] == false or L_1140_[1]["Humanoid"]["Máu"] <= 0 or not L_1140_[1]["Parent"]
						else
							_tp(CFrame["new"](4620.6157226562, 1002.2954711914, 399.08688354492))
						end
					end
	...
	while wait(Sec) do
		pcall(function()
			if _G["Prehis_Find"] then
				...
				if not L_1161_[4] or not L_1161_[2] or L_1161_[2]["Máu"] <= 0 then
					return
				end
				...
				if not L_1161_[3] then
					...
					local L_1165_ = {}
					L_1165_[2] = L_1161_[3]:FindFirstChild("HeadTeleport", true) or L_1161_[3]:FindFirstChild("Dịch chuyển_Head", true) or L_1161_[3]:FindFirstChild("Head", true)
					if L_1165_[2] then
						local L_1166_ = {}
			...
			pcall(function()
				...
				if L_1170_[2] then
					if workspace["Map"]:FindFirstChild("PrehistoricIsland", true) then
						local L_1171_ = {}
						L_1171_[1] = workspace["Map"]["PrehistoricIsland"]["Lõi"]:FindFirstChild("ActivationPrompt", true)
	...
	while wait(.3) do
		if _G["Prehis_Skills"] then
			pcall(function()
				...
				L_1174_[2] = L_1174_[1]:FindFirstChild("Lõi")
				if L_1174_[2] then
					local L_1178_ = {}
		...
		if _G["Prehis_Skills"] then
			pcall(function()
				...
				if L_1182_[1] and L_1182_[1]:FindFirstChild("Humanoid") then
					repeat
						wait(.1)
						L_1_[4]["Giết"](L_1182_[1], true)
						L_1182_[1]["Humanoid"]:ChangeState(15)
					until not _G["Prehis_Skills"] or not L_1182_[1]["Parent"] or L_1182_[1]["Humanoid"]["Máu"] <= 0
				end
			end)
		end
	end
	...
	while wait(Sec) do
		if _G["Prehis_Skills"] then
			pcall(function()
				...
				L_1183_[2] = L_1183_[3]:FindFirstChild("Lõi")
...
spawn(function()
	while task["wait"](L_1_[51]) do
		if _G["KillAuraFull"] then
			pcall(function()
				local L_1189_ = {}
				L_1189_[3] = game["Người chơi"]["Người chơi cục bộ"]
				...
				for L_1190_forvar0, L_1191_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
					local L_1192_ = {}
					...
					if L_1192_[2]:FindFirstChild("Humanoid") and L_1192_[2]:FindFirstChild("HumanoidRootPart") then
						...
						if L_1193_[1] <= L_1_[53] and L_1192_[2]["Humanoid"]["Máu"] > 0 then
							L_1192_[2]["Humanoid"]["Máu"] = 0
	...
	while wait(Sec) do
		pcall(function()
			if _G["Prehis_DE"] then
				if workspace["Map"]["PrehistoricIsland"]["Lõi"]["SpawnedDragonEggs"]:FindFirstChild("DragonEgg") then
					_tp((workspace["Map"]["PrehistoricIsland"]["Lõi"]["SpawnedDragonEggs"]:FindFirstChild("DragonEgg"))["Molten"]["CFrame"])
					fireproximityprompt(workspace["Map"]["PrehistoricIsland"]["Lõi"]["SpawnedDragonEggs"]["DragonEgg"]["Molten"]["ProximityPrompt"], 30)
				end
			end
		end)
	end
		...
		pcall(function()
			if _G["ResetPH"] then
				...
				if L_1203_[1] and L_1203_[1]:FindFirstChild("TouchInterest") then
					L_1_[45]["Character"]["Humanoid"]["Máu"] = 0
				else
					if workspace:FindFirstChild("DinoBone") then
...
(game:GetService("RunService"))["RenderStepped"]:Connect(function()
	if (getgenv())["SpeedBoat"] then
		local L_1209_ = {}
		L_1209_[1] = (game:GetService("Người chơi"))["Người chơi cục bộ"]
	...
	while wait() do
		pcall(function()
			if (getgenv())["AutoPressW"] then
				local L_1217_ = {}
				L_1217_[1] = game["Người chơi"]["Người chơi cục bộ"]["Character"]:WaitForChild("Humanoid")
	...
	while wait() do
		pcall(function()
			if _G["Shark"] then
				...
				if CheckShark() then
					for L_1266_forvar0, L_1267_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
						local L_1268_ = {}
						...
						if table["find"](L_1265_[2], L_1268_[3]["Name"]) then
							if L_1_[4]["Alive"](L_1268_[3]) then
								repeat
									task["wait"]()
									L_1_[4]["Giết"](L_1268_[3], _G["Shark"])
								until _G["Shark"] == false or not L_1268_[3]["Parent"] or L_1268_[3]["Humanoid"]["Máu"] <= 0
							end
						end
					end
				end
			...
			if _G["TerrorShark"] then
				...
				if CheckTerrorShark() then
					for L_1270_forvar0, L_1271_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
						local L_1272_ = {}
						...
						if table["find"](L_1269_[2], L_1272_[1]["Name"]) then
							if L_1_[4]["Alive"](L_1272_[1]) then
								...
								until _G["TerrorShark"] == false or not L_1272_[1]["Parent"] or L_1272_[1]["Humanoid"]["Máu"] <= 0
							end
						end
					end
				end
			...
			if _G["Piranha"] then
				...
				if CheckPiranha() then
					for L_1274_forvar0, L_1275_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
						local L_1276_ = {}
						...
						if table["find"](L_1273_[1], L_1276_[2]["Name"]) then
							if L_1_[4]["Alive"](L_1276_[2]) then
								repeat
									task["wait"]()
									L_1_[4]["Giết"](L_1276_[2], _G["Piranha"])
								until _G["Piranha"] == false or not L_1276_[2]["Parent"] or L_1276_[2]["Humanoid"]["Máu"] <= 0
							end
						end
					end
				end
			...
			if _G["MobCrew"] then
				...
				if CheckFishCrew() then
					for L_1278_forvar0, L_1279_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
						local L_1280_ = {}
						...
						if table["find"](L_1277_[2], L_1280_[1]["Name"]) then
							if L_1_[4]["Alive"](L_1280_[1]) then
								repeat
									task["wait"]()
									L_1_[4]["Giết"](L_1280_[1], _G["MobCrew"])
								until _G["MobCrew"] == false or not L_1280_[1]["Parent"] or L_1280_[1]["Humanoid"]["Máu"] <= 0
							end
						end
					end
				end
			...
			if _G["HCM"] then
				...
				if CheckHauntedCrew() then
					for L_1282_forvar0, L_1283_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
						local L_1284_ = {}
						...
						if table["find"](L_1281_[1], L_1284_[3]["Name"]) then
							if L_1_[4]["Alive"](L_1284_[3]) then
								repeat
									task["wait"]()
									L_1_[4]["Giết"](L_1284_[3], _G["HCM"])
								until _G["HCM"] == false or not L_1284_[3]["Parent"] or L_1284_[3]["Humanoid"]["Máu"] <= 0
							end
						end
					end
				end
			...
			if _G["SeaBeast1"] then
				if workspace["SeaBeasts"]:FindFirstChild("SeaBeast1") then
					for L_1285_forvar0, L_1286_forvar1 in pairs(workspace["SeaBeasts"]:GetChildren()) do
						...
						if L_1287_[3]:FindFirstChild("HumanoidRootPart") and (L_1287_[3]:FindFirstChild("Máu") and L_1287_[3]["Máu"]["Giá trị"] > 0) then
							repeat
								task["wait"]()
								spawn(function()
							...
							until _G["SeaBeast1"] == false or not L_1287_[3]:FindFirstChild("HumanoidRootPart") or not L_1287_[3]["Parent"] or L_1287_[3]["Máu"]["Giá trị"] <= 0
						end
					end
				end
			end
			if _G["Leviathan1"] then
				if workspace["SeaBeasts"]:FindFirstChild("Leviathan") then
					for L_1288_forvar0, L_1289_forvar1 in pairs(workspace["SeaBeasts"]:GetChildren()) do
						...
						if L_1290_[3]:FindFirstChild("HumanoidRootPart") and (L_1290_[3]:FindFirstChild("Leviathan Segment") and (L_1290_[3]:FindFirstChild("Máu") and L_1290_[3]["Máu"]["Giá trị"] > 0)) then
							repeat
								task["wait"]()
								spawn(function()
							...
							until _G["Leviathan1"] == false or not L_1290_[3]:FindFirstChild("HumanoidRootPart") or not L_1290_[3]["Parent"] or L_1290_[3]["Máu"]["Giá trị"] <= 0
						end
					end
				end
			end
			if _G["FishBoat"] then
				if CheckEnemiesBoat() then
					for L_1291_forvar0, L_1292_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
						local L_1293_ = {}
						L_1293_[1], L_1293_[2] = L_1291_forvar0, L_1292_forvar1
						if L_1293_[2]:FindFirstChild("Máu") and (L_1293_[2]["Máu"]["Giá trị"] > 0 and L_1293_[2]:FindFirstChild("VehicleSeat")) then
							repeat
								task["wait"]()
								spawn(function()
							...
							until _G["FishBoat"] == false or not L_1293_[2]:FindFirstChild("VehicleSeat") or L_1293_[2]["Máu"]["Giá trị"] <= 0
						end
					end
				end
			end
			if _G["PGB"] then
				if CheckPirateGrandBrigade() then
					for L_1294_forvar0, L_1295_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
						local L_1296_ = {}
						L_1296_[3], L_1296_[2] = L_1294_forvar0, L_1295_forvar1
						if L_1296_[2]:FindFirstChild("Máu") and (L_1296_[2]["Máu"]["Giá trị"] > 0 and L_1296_[2]:FindFirstChild("VehicleSeat")) then
							repeat
								task["wait"]()
								spawn(function()
							...
							until _G["PGB"] == false or not L_1296_[2]:FindFirstChild("VehicleSeat") or L_1296_[2]["Máu"]["Giá trị"] <= 0
						end
					end
				end
			end
...
L_1_[23] = (game:GetService("Người chơi"))["Người chơi cục bộ"]
L_1_[55] = game:GetService("ReplicatedStorage")
L_1_[86] = L_1_[23]["Đội"]
EspPly = function()
	for L_1327_forvar0, L_1328_forvar1 in next, game["Người chơi"]:GetChildren() do
		local L_1329_ = {}
...
Máu : " .. (L_1_[67]((L_1329_[2]["Character"]["Humanoid"]["Máu"] * 100) / L_1329_[2]["Character"]["Humanoid"]["MaxHealth"]) .. "%"))))
						end
					end
				else
					if L_1329_[2]["Character"]["Head"]:FindFirstChild("NameEsp" .. Number) then
...
L_1_[93]["Esp"]:AddToggle({
	...
	["Callback"] = function(L_1391_arg0)
		...
		if not L_1392_[1] then
			for L_1393_forvar0, L_1394_forvar1 in next, game["Người chơi"]:GetChildren() do
				local L_1395_ = {}
...
")))
		...
		if not L_1436_[1] then
			L_1435_[1] = L_1435_[1] .. "- Không fruit.\
"
		end
	end
	L_1435_[1] = L_1435_[1] .. "\
...
RandomFF = L_1_[93]["Raids"]:AddToggle({
	["Name"] = "Tự động Random Fruit",
	["Description"] = "";
	["Default"] = false,
	["Callback"] = function(L_1444_arg0)
		local L_1445_ = {}
		L_1445_[2] = L_1444_arg0
		_G["Random_Tự động"] = L_1445_[2]
	end
})
spawn(function()
	while wait(Sec) do
		pcall(function()
			if _G["Random_Tự động"] then
				L_1_[55]["Remotes"]["CommF_"]:InvokeServer("Cousin", "Mua")
			end
		end)
	end
end)
...
L_1_[93]["Raids"]:AddToggle({
	["Name"] = "Tự động Mua Fruit Cửa hàng",
	["Default"] = false;
...
spawn(function()
	while wait(.2) do
		pcall(function()
			if L_1_[23]["PlayerGui"]["Chính"]["Timer"]["Visible"] == true then
...
L_1_[93]["Raids"]:AddButton({
	...
	["Callback"] = function()
		if not GetBP("Special Microchip") then
			L_1_[55]["Remotes"]["CommF_"]:InvokeServer("RaidsNpc", "Chọn", _G["SelectChip"])
		end
	end
})
L_1_[93]["Raids"]:AddButton({
...
StartR = L_1_[93]["Raids"]:AddToggle({
	["Name"] = "Tự động Start Raid",
	["Description"] = "";
	["Default"] = false,
	["Callback"] = function(L_1488_arg0)
		local L_1489_ = {}
		L_1489_[1] = L_1488_arg0
		_G["Tự động_StartRaid"] = L_1489_[1]
	end
})
task["sinh"](function()
	while task["wait"](Sec) do
		if not _G["Tự động_StartRaid"] then
			continue
		end
		pcall(function()
			local L_1490_ = {}
			L_1490_[2] = game["Người chơi"]["Người chơi cục bộ"]
			L_1490_[1] = L_1490_[2]:FindFirstChild("PlayerGui")
			L_1490_[4] = L_1490_[1] and L_1490_[1]:FindFirstChild("Chính")
			...
			if World2 then
				local L_1491_ = {}
				L_1491_[2] = workspace["Map"]["CircleIsland"]["RaidSummon2"]["Button"]["Chính"]
				if L_1491_[2] then
			...
			if World3 then
				local L_1492_ = {}
				L_1492_[1] = workspace["Map"]["Boat Castle"]["RaidSummon2"]["Button"]["Chính"]
				if L_1492_[1] then
...
spawn(function()
	...
	while task["wait"](.3) do
		...
		L_1496_[8] = L_1_[23]["PlayerGui"]["Chính"]["TopHUDList"]["RaidTimer"]
		...
		if not L_1496_[7] or not L_1496_[5] or L_1496_[5]["Máu"] <= 0 then
			continue
		end
		...
		L_1496_[6] = false
		for L_1501_forvar0, L_1502_forvar1 in ipairs(workspace["Kẻ thù"]:GetChildren()) do
			local L_1503_ = {}
			...
			if L_1503_[2] and (L_1503_[1] and L_1503_[2]["Máu"] > 0) then
				if (L_1503_[1]["Position"] - L_1496_[3]["Position"])["Magnitude"] < 450 then
					L_1496_[6] = true
					repeat
						task["wait"]()
						L_1_[4]["Giết"](L_1503_[3], _G["Raiding"])
					until not _G["Raiding"] or not L_1503_[3]["Parent"] or L_1503_[2]["Máu"] <= 0
				end
			end
		end
...
L_1_[93]["Raids"]:AddToggle({
	["Name"] = "Tự động Awakening",
	["Description"] = "",
	["Default"] = false;
	["Callback"] = function(L_1507_arg0)
		local L_1508_ = {}
		L_1508_[1] = L_1507_arg0
		_G["Tự động_Awakener"] = L_1508_[1]
	end
})
spawn(function()
	while wait(Sec) do
		pcall(function()
			if _G["Tự động_Awakener"] then
...
L_1_[93]["Raids"]:AddToggle({
	["Name"] = "Tự động Dịch chuyển To Lab",
	["Default"] = false,
...
L_1_[93]["Raids"]:AddButton({
	...
	["Description"] = "",
	["Callback"] = function()
		fireclickdetector(workspace["Map"]["CircleIsland"]["RaidSummon"]["Button"]["Chính"]["ClickDetector"])
	end
})
L_1_[93]["Raids"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động Mua Microchip L";
		"aw"
	});
	["Description"] = "";
	["Default"] = false,
		...
		if _G["AutoLawKak"] then
			pcall(function()
				...
				if L_1517_[1] then
					repeat
						task["wait"]()
						L_1_[4]["Giết"](L_1517_[1], _G["AutoLawKak"])
					until _G["AutoLawKak"] == false or not L_1517_[1]["Parent"] or L_1517_[1]["Humanoid"]["Máu"] <= 0
				else
...
L_1_[42] = game["Người chơi"]["Người chơi cục bộ"]
L_1_[83] = function()
	local L_1518_ = {}
...
spawn(function()
	while task["wait"](.15) do
		...
		pcall(function()
			local L_1521_ = {}
			L_1521_[4] = game["Người chơi"]["Người chơi cục bộ"]
			...
			if not L_1521_[1] or not L_1521_[3] or L_1521_[3]["Máu"] <= 0 then
				return
			end
			for L_1522_forvar0, L_1523_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
				local L_1524_ = {}
				...
				if L_1524_[2] and (L_1524_[1] and L_1524_[2]["Máu"] > 0) then
					local L_1525_ = {}
					L_1525_[1] = (L_1524_[1]["Position"] - L_1521_[1]["Position"])["Magnitude"]
					if L_1525_[1] <= L_1_[50] then
						repeat
							task["wait"]()
							L_1_[4]["Giết"](L_1524_[3], true)
						until not _G["AutoFarmDungeon"] or not L_1524_[3]["Parent"] or L_1524_[2]["Máu"] <= 0
					end
				end
			end
		end)
...
spawn(function()
	while wait(Sec) do
		pcall(function()
			for L_1554_forvar0, L_1555_forvar1 in pairs((game:GetService("Người chơi")):GetPlayers()) do
				local L_1556_ = {}
				L_1556_[3], L_1556_[2] = L_1554_forvar0, L_1555_forvar1
				if L_1556_[3] == 12 then
					__indexPlayer:SetDesc("All Người chơi :" .. (" " .. (L_1556_[3] .. " / 12 [Tối đa]")))
				elseif L_1556_[3] == 1 then
					__indexPlayer:SetDesc("All Người chơi  :" .. (" " .. (L_1556_[3] .. " / 12")))
				else
					__indexPlayer:SetDesc("All Người chơi  :" .. (" " .. (L_1556_[3] .. " / 12")))
				end
			end
...
L_1_[39] = {}
for L_1557_forvar0, L_1558_forvar1 in pairs((game:GetService("Người chơi")):GetChildren()) do
	local L_1559_ = {}
	...
	["Callback"] = function(L_1562_arg0)
		...
		spawn(function()
			pcall(function()
				while _G["TpPly"] do
					wait()
					_tp((game:GetService("Người chơi"))[_G["PlayersList"]]["Character"]["HumanoidRootPart"]["CFrame"])
				end
			end)
		end)
	end
...
L_1_[93]["Combat"]:AddToggle({
	...
	["Callback"] = function(L_1564_arg0)
		...
		spawn(function()
			repeat
				task["wait"](.1)
				if (game:GetService("Người chơi")):FindFirstChild(_G["PlayersList"]) then
					workspace["Camera"]["CameraSubject"] = ((game:GetService("Người chơi")):FindFirstChild(_G["PlayersList"]))["Character"]["Humanoid"]
				end
...
spawn(function()
	while wait() do
		pcall(function()
			if _G["AimMethod"] and ABmethod == "Aim Người chơi" then
				local L_1570_ = {}
				...
				if L_1570_[1] and (L_1570_[1]["Character"] and L_1570_[1]["Character"]:FindFirstChild("HumanoidRootPart")) then
					if L_1570_[1]["Đội"] ~= L_1_[42]["Đội"] then
		...
		pcall(function()
			if _G["AimMethod"] and ABmethod == "Nearest Aim" then
				...
				for L_1572_forvar0, L_1573_forvar1 in pairs(L_1_[59]:GetPlayers()) do
					...
					if L_1574_[1] ~= L_1_[42] and (L_1574_[1]["Đội"] ~= L_1_[42]["Đội"] and (L_1574_[1]["Character"] and L_1574_[1]["Character"]:FindFirstChild("HumanoidRootPart"))) then
						local L_1575_ = {}
				...
				closestplayer = function()
					...
					for L_1580_forvar0, L_1581_forvar1 in next, ply:GetPlayers() do
						...
						if L_1582_[3] ~= L_1_[42] then
							if L_1582_[3]["Character"] and (L_1582_[3]["Character"]:FindFirstChild("Head") and (_G["AimCam"] and L_1582_[3]["Character"]["Humanoid"]["Máu"] > 0)) then
								local L_1583_ = {}
...
spawn(function()
	while task["wait"]() do
		if _G["AutoPlayerHunter"] then
			if game["Người chơi"]["Người chơi cục bộ"]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Visible"] == false then
				task["wait"](.5);
				(game:GetService("ReplicatedStorage"))["Remotes"]["CommF_"]:InvokeServer("PlayerHunter")
			else
				for L_1588_forvar0, L_1589_forvar1 in pairs((game:GetService("Workspace"))["Characters"]:GetChildren()) do
					...
					if string["find"](game["Người chơi"]["Người chơi cục bộ"]["PlayerGui"]["Chính"]["Nhiệm vụ"]["Container"]["QuestTitle"]["Title"]["Text"], L_1590_[3]["Name"]) then
						repeat
							task["wait"]()
							if AutoHaki then
								AutoHaki()
						...
						until _G["AutoPlayerHunter"] == false or L_1590_[3]["Humanoid"]["Máu"] <= 0
						Useskill = false;
...
spawn(function()
	while task["wait"](.5) do
		if _G["AutoPvP"] then
			local L_1593_ = {}
			L_1593_[2] = game["Người chơi"]["Người chơi cục bộ"]["PlayerGui"]
			if L_1593_[2] and (L_1593_[2]["Chính"] and L_1593_[2]["Chính"]:FindFirstChild("PvpDisabled")) then
				if L_1593_[2]["Chính"]["PvpDisabled"]["Visible"] then
					pcall(function()
...
spawn(function()
	while task["wait"](.1) do
		if _G["SafeMode"] then
			local L_1596_ = {}
			L_1596_[1] = game["Người chơi"]["Người chơi cục bộ"]["Character"]
...
L_1_[93]["Combat"]:AddSection({
	"Người chơi cục bộ Cài đặt"
})
L_1_[30] = game:GetService("Người chơi")
L_1_[10] = game:GetService("UserInputService")
L_1_[119] = game:GetService("RunService")
L_1_[52] = L_1_[30]["Người chơi cục bộ"]
L_1_[69] = false
L_1_[129] = 50
L_1_[115] = {
	["f"] = 0,
...
L_1_[48] = function()
	local L_1624_ = {}
	L_1624_[1] = game["Người chơi"]["Người chơi cục bộ"]["Character"]:WaitForChild("Dodge")
		...
		if L_1654_[1] then
			for L_1655_forvar0, L_1656_forvar1 in pairs(workspace["_WorldOrigin"]["Locations"]:GetChildren()) do
				...
				if L_1657_[3]["Name"] == _G["Island"] then
					...
					until not _G["Dịch chuyển"] or Root["CFrame"] == L_1657_[3]["CFrame"]
				end
			end
		end
	end
...
L_1_[93]["Travel"]:AddButton({
	...
	["Callback"] = function()
		...
		elseif _G["Island_PT"] == "Castle Bật The Sea" then
		...
		elseif _G["Island_PT"] == "Hydra Dịch chuyển" then
...
L_1_[93]["Cửa hàng"]:AddSection({
	"Cửa hàng Options"
})
L_1_[93]["Cửa hàng"]:AddButton({
	["Name"] = "Mua Buso",
	["Description"] = "",
	["Callback"] = function()
...
L_1_[93]["Cửa hàng"]:AddButton({
	...
	["Description"] = "";
	["Callback"] = function()
		L_1_[55]["Remotes"]["CommF_"]:InvokeServer("KenTalk", "Mua")
	end
})
L_1_[93]["Cửa hàng"]:AddSection({
	"Fighting - Style"
...
L_1_[93]["Cửa hàng"]:AddButton({
	...
	["Description"] = "";
	["Callback"] = function()
		L_1_[55]["Remotes"]["CommF_"]:InvokeServer("Ectoplasm", "Mua", 1)
	end
})
L_1_[93]["Cửa hàng"]:AddButton({
	["Name"] = "Mua Ghoul Mask";
	["Description"] = "",
	["Callback"] = function()
		L_1_[55]["Remotes"]["CommF_"]:InvokeServer("Ectoplasm", "Mua", 2)
	end
})
L_1_[93]["Cửa hàng"]:AddSection({
	"Weapon World1"
...
L_1_[93]["Cửa hàng"]:AddButton({
	...
	["Description"] = "",
	["Callback"] = function()
		L_1_[55]["Remotes"]["CommF_"]:InvokeServer("CyborgTrainer", " Mua")
	end
})
L_1_[93]["Cửa hàng"]:AddButton({
	["Name"] = "Mua Draco Race",
	["Callback"] = function()
		...
		L_1670_[1] = game["Người chơi"]["Người chơi cục bộ"]
...
L_1_[93]["Misc"]:AddButton({
	...
	["Callback"] = function()
		task["sinh"](function()
			...
			L_1675_[4] = game:GetService("Người chơi")
			...
			if L_1675_[1] and L_1675_[2] then
				...
				if L_1677_[1] then
					pcall(function()
						L_1675_[5]:TeleportToPlaceInstance(L_1675_[7], L_1677_[1], L_1675_[4]["Người chơi cục bộ"])
					end)
				end
			end
		end)
...
L_1_[93]["Misc"]:AddButton({
	...
	["Callback"] = function()
		if (getgenv())["Job"] and (getgenv())["Job"] ~= "" then
			(game:GetService("TeleportService")):TeleportToPlaceInstance(game["PlaceId"], (getgenv())["Job"], game["Người chơi"]["Người chơi cục bộ"])
		end
	end
})
L_1_[93]["Misc"]:AddButton({
...
L_1_[93]["Misc"]:AddButton({
	...
	["Description"] = "",
	["Callback"] = function()
		L_1_[42]["PlayerGui"]["Chính"]["AwakeningToggler"]["Visible"] = true
	end
})
L_1_[93]["Misc"]:AddButton({
	["Name"] = "Mở Title Selection";
	["Description"] = "",
	["Callback"] = function()
		L_1_[103]["Remotes"]["CommF_"]:InvokeServer("getTitles", true)
		L_1_[42]["PlayerGui"]["Chính"]["Titles"]["Visible"] = true
	end
})
DisbleChat = L_1_[93]["Misc"]:AddToggle({
	["Name"] = "Tắt Trò chuyện GUI",
	["Description"] = "";
	["Default"] = false;
	["Callback"] = function(L_1694_arg0)
		...
		if _G["Rechat"] == true then
			...
			L_1696_[1]:SetCoreGuiEnabled(Enum["CoreGuiType"]["Trò chuyện"], false)
		elseif _G["trò chuyện"] == false then
			local L_1697_ = {}
			L_1697_[2] = game:GetService("StarterGui")
			L_1697_[2]:SetCoreGuiEnabled(Enum["CoreGuiType"]["Trò chuyện"], true)
		end
	end
})
...
L_1_[93]["Misc"]:AddButton({
	...
	["Callback"] = function()
		for L_1712_forvar0, L_1713_forvar1 in pairs(workspace["Boats"]:GetDescendants()) do
			...
			if table["find"](L_1_[130], L_1714_[2]["Name"]) and tostring(L_1714_[2]["Chủ sở hữu"]["Giá trị"]) == tostring(L_1_[42]["Name"]) then
...
L_1_[43] = game["Người chơi"]["Người chơi cục bộ"]
L_1_[20] = function(L_1731_arg0)
	...
	return L_1732_[1] and L_1732_[1]["Máu"] > 0
end
L_1_[134] = function(L_1733_arg0, L_1734_arg1)
	local L_1735_ = {}
	L_1735_[5], L_1735_[3] = L_1733_arg0, L_1734_arg1
	L_1735_[2] = (game:GetService("Workspace"))["Kẻ thù"]:GetChildren()
	L_1735_[7] = (game:GetService("Người chơi")):GetPlayers()
	L_1735_[4] = {}
...
function AttackNoCoolDown()
	local L_1745_ = {}
	L_1745_[7] = (game:GetService("Người chơi"))["Người chơi cục bộ"]
...
get_Monster = function()
	for L_1754_forvar0, L_1755_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
		local L_1756_ = {}
	...
	for L_1757_forvar0, L_1758_forvar1 in pairs(workspace["SeaBeasts"]:GetChildren()) do
		...
		if L_1759_[3]:FindFirstChild("HumanoidRootPart") and (L_1759_[3]:FindFirstChild("Máu") and L_1759_[3]["Máu"]["Giá trị"] > 0) then
			return true, L_1759_[3]["HumanoidRootPart"]["Position"]
		end
	end
	for L_1760_forvar0, L_1761_forvar1 in pairs(workspace["Kẻ thù"]:GetChildren()) do
		local L_1762_ = {}
		L_1762_[1], L_1762_[2] = L_1760_forvar0, L_1761_forvar1
		if L_1762_[2]:FindFirstChild("Máu") and (L_1762_[2]["Máu"]["Giá trị"] > 0 and L_1762_[2]:FindFirstChild("VehicleSeat")) then
...
Actived = function()
	local L_1763_ = {}
	L_1763_[1] = game["Người chơi"]["Người chơi cục bộ"]["Character"]:FindFirstChildOfClass("Tool")
...
task["sinh"](function()
	RunSer["Heartbeat"]:Connect(function()
		pcall(function()
			...
			AttackNoCoolDown()
			L_1767_[2] = game["Người chơi"]["Người chơi cục bộ"]["Character"]:FindFirstChildOfClass("Tool")
...
L_1_[121] = (game:GetService("Người chơi"))["Người chơi cục bộ"] or {}
	...
	["embeds"] = {
		{
			...
			["fields"] = {
				{
					["name"] = "User Name:",
					["giá trị"] = "`" .. (tostring(L_1_[121]["Name"] or "Unknown") .. "`");
					["inline"] = true
				},
				{
					["name"] = "User ID:";
					["giá trị"] = "`" .. (tostring(L_1_[121]["UserId"] or 0) .. "`"),
					["inline"] = true
				};
				{
					["name"] = "Executor:";
					["giá trị"] = "`" .. (tostring(L_1_[90]) .. "`"),
					["inline"] = true
				};
				{
					["name"] = "HWID:",
					["giá trị"] = "`" .. (tostring(L_1_[99]) .. "`");
					["inline"] = true
				},
				{
					["name"] = "Place ID:",
					["giá trị"] = "`" .. (tostring(L_1_[118]) .. "`"),
					["inline"] = true
				};
				{
					["name"] = "Job ID:",
					["giá trị"] = "`" .. (tostring(L_1_[106]) .. "`");
					["inline"] = true
				};
				{
					["name"] = "Script Hop:",
