...
-- Thông báo chào mừng
Notification.new("<Color=Yellow>TinhSuper Hub <Color=/>"):Display()
task.wait(1)
...
elseif (MyLevel >= 2675 and MyLevel <= 2749) or SelectMonster == "Ocean Prophet" then
    Mon = "Ocean Prophet"
    LevelQuest = 2
...
elseif (MyLevel >= 2750 and MyLevel <= 2800) or SelectMonster == "Grand Devotee" then
    Mon = "Grand Devotee"
    NameQuest = "SubmergedQuest3"
    NameMon = "Grand Devotee"
    CFrameQuest = CFrame["new"](9636.52441, -2087.844, 9609.52832)
                ...
                if hum and mobHRP and hum.Health > 0 then
                    ...
                    if distance <= 5000 then
                        repeat
                            ...
                            FarmPos = mobHRP.CFrame
                            MonFarm = v.Name

                        until not _G.AutoNear
                            or not v.Parent
                            or hum.Health <= 0
                            or not workspace.Enemies:FindFirstChild(v.Name)
...
if World3 then
    AutoFarm:Dropdown({
      ...
      -- UI Toggle (VI → EN)
AutoFarm:Toggle("Auto Farm Fruit Mastery", false, function(value)
    _G.AutoFarmFruits = value
    _G.UseSkill = value -- FIX: sync toggle with main loop
    StopTween(value)
end)
...
spawn(function()
    while task.wait() do
        if _G.AutoFarmFruits and _G.UseSkill then
            pcall(function()
                for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    if v.Name == MonFarm
...
spawn(function()
    while wait() do
        if _G.AutoFarmFruits and _G.selectFruitFarm == 'Farm Fruit Mastery (No Quest)' then
            pcall(function()
                CheckQuest()
                TP1(CFrameQuest)
            end)
            ...
            for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
                    if v.Name == Mon then
                        ...
                        until not _G.AutoFarmFruits
                        or not MasteryType == 'Farm Fruit Mastery (No Quest)'
                        or not v.Parent
                        or v.Humanoid.Health == 0
                        or not _G.selectFruitFarm == 'Farm Fruit Mastery (No Quest)'
...
spawn(function()
    while wait() do
        if _G.AutoFarmFruits and _G.selectFruitFarm == 'Farm Fruit Mastery (With Quest)' then
            pcall(function()
                CheckQuest()
                    ...
                    for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
                            if v.Name == Mon then
                                ...
                                until not _G.AutoFarmFruits
                                or not MasteryType == 'Farm Fruit Mastery (With Quest)'
                                or not v.Parent
                                or v.Humanoid.Health == 0
                                or not _G.selectFruitFarm == 'Farm Fruit Mastery (With Quest)'
...
-- Farm Fruit Mastery (Bone Island / Halloween)
spawn(function()
    while wait() do
        if _G.AutoFarmFruits and _G.selectFruitFarm == 'Farm Bone Mastery' then
            pcall(function()
                local BoneIslandCFrame = CFrame.new(-9508.5673828125, 142.1398468017578, 5737.3603515625)
                TP1(BoneIslandCFrame)
            end)
            ...
            for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
                    ...
                    or v.Name == "Posessed Mummy" then
                        ...
                        until not _G.AutoFarmFruits
                        or not MasteryType == 'Farm Bone Mastery'
                        or not v.Parent
                        or v.Humanoid.Health == 0
                        or not _G.selectFruitFarm == 'Farm Bone Mastery'
            ...
            -- Pull mobs from ReplicatedStorage
...
-- Farm Fruit Mastery (Cake Island)
spawn(function()
    while wait() do
        if _G.AutoFarmFruits and _G.selectFruitFarm == 'Farm Cake Mastery' then
            pcall(function()
                local CakeIslandCFrame = CFrame.new(-2130.80712890625, 69.95634460449219, -12327.83984375)
                TP1(CakeIslandCFrame)
            end)
            ...
            for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
                    ...
                    or v.Name == "Head Baker" then
                        ...
                        until not _G.AutoFarmFruits
                        or not MasteryType == 'Farm Cake Mastery'
                        or not v.Parent
                        or v.Humanoid.Health == 0
                        or not _G.selectFruitFarm == 'Farm Cake Mastery'
...
spawn(function()
   ...
   if World3 then
    ...
    spawn(function()
        ...
        AutoFarm:Toggle("Auto Farm Hallow Scythe", false, function(value)
    _G.Hallow = value
    StopTween(value)
	end)   
       spawn(function()
        ...
        while wait(0.1) do
            if _G.Pray then
                TP1(CFrame.new(
                    ...
                    -0.983064115, -2.48005533e-10, 0.18326205,
                    -1.78910387e-09, 1, -8.24392288e-09,
                    -0.18326205, -8.43218029e-09, -0.983064115
                ))
                wait()
                game:GetService("ReplicatedStorage")
                    .Remotes.CommF_:InvokeServer("gravestoneEvent", 1)
            end
        end
    end)
end)
