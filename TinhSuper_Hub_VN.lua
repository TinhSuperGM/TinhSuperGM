...
L_1_[93]["Info"]:AddSection("Thông Tin Máy Chủ")
...
-- UI đã Việt hóa (Options hiển thị tiếng Việt, nhưng Callback trả về giá trị gốc tiếng Anh)
L_1_[93]["Main"]:AddSection({
	"Farm Quái"
})

if World1 then
	local World1_Options_Display = {
		"Tên Cướp";
		"Khỉ";
		"Khỉ Đột";
		"Hải Tặc";
	...
	local World1_map = {
		...
		["Hải Tặc"] = "Pirate";
		["Tên Đầu Gấu"] = "Brute";
		["Kẻ Cướp Vùng Sa Mạc"] = "Desert Bandit";
		["Uỷ Viên Sa Mạc"] = "Desert Officer";
		["Băng Cướp Tuyết"] = "Snow Bandit";
		["Người Tuyết"] = "Snowman";
		["Phó Uỷ Viên Đê Tiện"] = "Chief Petty Officer";
		["Kẻ Cướp Trên Không"] = "Sky Bandit";
		["Chúa Tể Bóng Tối"] = "Dark Master";
		["Chiến Binh La Mã"] = "Toga Warrior";
		["Đấu Sĩ La Mã"] = "Gladiator";
		["Lính Quân Đội"] = "Military Soldier";
		["Gián Điệp Quân Đội"] = "Military Spy";
		["Chiến Binh Người Cá"] = "Fishman Warrior";
		["Thủ Lĩnh Người Người Cá"] = "Fishman Commando";
		["Vệ Sĩ Của Chúa"] = "God's Guard";
		["Người Hộ Vệ"] = "Shanda";
		["Biệt Đội Hoàng Gia"] = "Royal Squad";
		["Lính Hoàng Gia"] = "Royal Soldier";
		["Hải Tặc Galley"] = "Galley Pirate";
		["Đội Trưởng   Galley"] = "Galley Captain";
	}

	L_1_[93]["Main"]:AddDropdown({
		["Name"] = "Chọn Quái",
		["Default"] = false,
		["Options"] = World1_Options_Display,
		["Callback"] = function(L_399_arg0)
			(getgenv())["SelectMob"] = World1_map[L_399_arg0]
		end
	})
end

if World2 then
	local World2_Options_Display = {
		"Kẻ Tập Kích";
		"Lính Đánh Thuê";
		"Hải Tặc Thiên Nga";
		"Nhân Viên Nhà Máy";
	...
	local World2_map = {
		...
		["Hải Tặc Thiên Nga"] = "Swan Pirate";
		["Nhân Viên Nhà Máy"] = "Factory Staff";
		["Trung úy Hải Quân"] = "Marine Lieutenant";
		["Đội Trưởng Hải Quân"] = "Marine Captain";
		["Xác Sống"] = "Zombie";
		["Ma Cà Rồng"] = "Vampire";
		["Lính Mùa Đông"] = "Snow Trooper";
		["Chiến Binh Mùa Đông"] = "Winter Warrior";
		["Nhân Viên Phòng Thí Nghiệm"] = "Lab Subordinate";
		["Chiến Binh Mọc Sừng"] = "Horned Warrior";
		["Ninja Dung Nham"] = "Magma Ninja";
		["Hải Tặc Dung Nham"] = "Lava Pirate";
		["Thủy Thủ Đoàn"] = "Ship Deckhand";
		["Kỹ Sư Tàu"] = "Ship Engineer";
		["Bếp Phó"] = "Ship Steward";
		["Sỹ Quan Trên Tàu"] = "Ship Officer";
		["Chiến Binh Băng Giá"] = "Arctic Warrior";
		["Kẻ Ẩn Nấp Trong Tuyết"] = "Snow Lurker";
		["Thủy Binh"] = "Sea Soldier";
		["Võ Sĩ Thủy Quyền"] = "Water Fighter";
	}

	L_1_[93]["Main"]:AddDropdown({
		["Name"] = "Chọn Quái";
		["Default"] = false;
		["Options"] = World2_Options_Display;
		["Callback"] = function(L_401_arg0)
			(getgenv())["SelectMob"] = World2_map[L_401_arg0]
		end
	})
end

if World3 then
	local World3_Options_Display = {
		"Triệu Phú Cướp Biển";
		"Chiến Binh Long Tộc";
		"Cung Thủ Long Tộc";
		"Phụ Nữ Trên  Đảo";
		"Người Khổng Lồ Trên Đảo";
		"Đại Tá Hải Quân";
		"Tân Đô Đốc Hải Quân";
		"Lính Đột Kích Người Cá ";
		"Thuyền Trưởng Người Cá";
		"Sơn Tặc";
		"Hải Tặc Huyền Bí";
		"Lâm Tặc";
		"Ngự Lâm Tặc";
		...
		"Bếp Trưởng";
		"Chiến Binh Ca Cao";
		"Đấu Sĩ Sô-cô-la"; -- tương ứng với L_1_[2]({...})
		"Hải Tặc Kẹo Ngọt [Lv.2350]";
		"Phiến Quân Kẹo";
		"Hải Tặc Kẹo Ngọt [Lv.2400]";
		"Quỷ Tuyết";
		"Cư Dân Ở Đảo Ngoài Vòng Pháp Luật";
		"Chàng Trai Trê. Đảo";
		"Chiến Binh Mặt Trời";
		"Nhà Vô Địch Đảo Tiki"
	}

	local World3_map = {
		["Triệu Phú Cướp Biển"] = "Pirate Millionaire";
		["Chiến Binh Long Tộc"] = "Dragon Crew Warrior";
		["Cung Thủ Long Tộc"] = "Dragon Crew Archer";
		["Phụ Nữ Trên Đảo"] = "Female Islander";
		["Người Khổng Lồ Trên Đảo"] = "Giant Islander";
		["Đại Tá Hải Quân"] = "Marine Commodore";
		["Tân Đô Đốc Hải Quân"] = "Marine Rear Admiral";
		["Lính Đột Kích Người Cá"] = "Fishman Raider";
		["Thuyền Trưởng Người Cá"] = "Fishman Captain";
		["Sơn Tặc"] = "Forest Pirate";
		["Hải Tặc Huyền Bí"] = "Mythological Pirate";
		["Lâm Tăch"] = "Jungle Pirate";
		["Ngự Lâm Tặc"] = "Musketeer Pirate";
		["Ma Xương Tái Sinh"] = "Reborn Skeleton";
		["Xác Sống"] = "Living Zombie";
		["Quỷ Linh"] = "Demonic Soul";
		["Xác Ướp Quỷ Ám"] = "Posessed Mummy";
		["Lính Đậu Phộng"] = "Peanut Scout";
		["Tổng Thống Đậu Phộng"] = "Peanut President";
		["Đầu Bếp Kem"] = "Ice Cream Chef";
		["Tư Lệnh Kem"] = "Ice Cream Commander";
		["Thợ Làm Bánh Quy"] = "Cookie Crafter";
		["Lính Gác Bánh Ngọt"] = "Cake Guard";
		["Nhân Viên Làm Bánh"] = "Baking Staff";
		["Bếp Trưởng"] = "Head Baker";
		["Chiến Binh Ca Cao"] = "Cocoa Warrior";
		-- Giá trị gốc cho mục 'Chocolate Bar Battler' giữ nguyên biểu thức ban đầu
		["Đấu Sĩ Sô-cô-la"] = L_1_[2]({
			"Chocolate Bar Battle";
			"r"
		});
		["Hải Tặc Kẹo Ngọt [Lv.2350]"] = "Sweet Thief";
		["Phiến Quân Kẹo"] = "Candy Rebel";
		["Hải Tặc Kẹo Ngọt [Lv.2400]"] = "Candy Pirate";
		["Quỷ Tuyết"] = "Snow Demon";
		["Cư Dân Ở Đảo Ngoài Vòng Pháp Luật"] = "Isle Outlaw";
		["Chàng Trai Trên Đảo "] = "Island Boy";
		["Chiến Binh Mặt Trời"] = "Sun-kissed Warrior";
		["Nhà Vô Địch Đảo Tiki"] = "Isle Champion";
	}

	L_1_[93]["Main"]:AddDropdown({
		["Name"] = "Chọn Quái",
		["Default"] = false,
		["Options"] = World3_Options_Display,
		["Callback"] = function(L_403_arg0)
			(getgenv())["SelectMob"] = World3_map[L_403_arg0]
		end
	})
end
