...
L_1_[93] = {
	...
	["Prehistoric"] = L_1_[38]:MakeTab({
		["Title"] = "Sự Kiện Núi Lửa";
		["Icon"] = "tent"
	}),
	["Esp"] = L_1_[38]:MakeTab({
		["Title"] = "Chỉ số và định vị";
		["Icon"] = L_1_[2]({
			"rbxassetid://7040410";
			"130"
		})
...
L_1_[93]["Info"]:AddSection("Link Discord của tôi")
L_1_[93]["Info"]:AddDiscordInvite({
	["Name"] = "TinhSuper VN Hub [Beta]",
	["Description"] = L_1_[2]({
		"Cập nhật gần đây [8/1/2026]"
	}),
	["Logo"] = L_1_[2]({
		"rbxassetid://9197876",
		"3568989"
...
CastleRaids = L_1_[93]["Main"]:AddToggle({
	["Name"] = "Đánh Hải Tặc",
	["Description"] = "Sea 3 - Pháo đài trên biển";
	["Default"] = false;
...
Ecto = L_1_[93]["Main"]:AddToggle({
	["Name"] = "Tự động cày Chất Phóng Xạ",
	["Description"] = "",
	["Default"] = false,
...
BerryH = L_1_[93]["Main"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động nhặt Berry và đổi server"
	}),
	["Description"] = "";
	["Default"] = false,
...
L_1_[93]["Main"]:AddToggle({
	["Name"] = "Tự động farm quái trên tất cả đảo",
	["Default"] = false;
...
EliteH = L_1_[93]["Main"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động đánh Elite và đổi server"
	}),
	["Description"] = "";
	["Default"] = false;
...
L_1_[93]["Main"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động đánh Vua bột và đổi Server"
	}),
	["Default"] = false,
...
PhoD = L_1_[93]["Main"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động Mở khóa chip raid Phoenix"
	});
	["Description"] = "",
	["Default"] = false;
...
L_1_[137] = L_1_[93]["Main"]:AddToggle({
	["Name"] = "Cày thông thạo trái ác quỷ";
	["Description"] = "",
	["Default"] = false,
...
L_1_[29] = L_1_[93]["Main"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động cày thông thạo tất cả kiếm"
	}),
	["Description"] = "",
	["Default"] = false;
...
RandomAround = L_1_[93]["Settings"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động bật ở vị trí quay"
	});
	["Description"] = "Chịu, t dell hiểu :))",
	["Default"] = false;
...
SafeModes = L_1_[93]["Settings"]:AddToggle({
	["Name"] = "Chế độ Ác Mộng";
	["Description"] = "Chả hiểu chức năng là gì:) ae test xem",
	["Default"] = false,
...
DisableHitVFX = L_1_[93]["Settings"]:AddToggle({
	["Name"] = "Loại Bỏ hoạt ảnh tấn công";
	["Description"] = L_1_[2]({
...
StatsUpg = L_1_[93]["Esp"]:AddToggle({
	["Name"] = "Tự Động Nâng Điểm Trái Ác Quỷ",
	["Description"] = "",
	["Default"] = false,
...
StatsUpg = L_1_[93]["Esp"]:AddToggle({
	["Name"] = "Tự động nâng điểm Phòng Thủ",
	["Description"] = "",
	["Default"] = false;
...
FishingQ = L_1_[93]["Fish"]:AddToggle({
	["Name"] = "Tự động làm nhiệm vụ câu cá",
	["Description"] = "";
	["Default"] = false;
...
TravelDress = L_1_[93]["Quests"]:AddToggle({
	["Name"] = "Tự động làm nhiệm vụ lên sea 2";
	["Description"] = "",
	["Default"] = false;
...
Zou = L_1_[93]["Quests"]:AddToggle({
	["Name"] = "Tự động làm nhiệm vụ lên sea 3";
	["Description"] = "",
	["Default"] = false;
...
L_1_[93]["Quests"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động cày thông thạo Đàn đầu lâu"
	}),
	["Description"] = "",
	["Default"] = false;
...
Q = L_1_[93]["Quests"]:AddToggle({
	...
	["Description"] = "Nhiệm Vụ Cuối Cùng",
	["Default"] = false,
...
Q = L_1_[93]["Quests"]:AddToggle({
	["Name"] = "Tự động làm nhiệm vụ Yama",
	["Description"] = "3 nhiệm vụ mở khóa CDk";
	["Default"] = false;
...
Q = L_1_[93]["Quests"]:AddToggle({
	["Name"] = "Tự động Làm nhiệm vụ tushita";
	["Description"] = "3 nhiệm vụ mở khóa CDK";
	["Default"] = false;
...
Q = L_1_[93]["Quests"]:AddToggle({
	["Name"] = L_1_[2]({
		"Dịch chuyển đến người bán kiếm huyền thoại"
	});
	["Description"] = "";
	["Default"] = false;
...
Q = L_1_[93]["Quests"]:AddToggle({
	["Name"] = "Tự động lấy áo choàng Swan";
	["Description"] = "",
	["Default"] = false,
...
Q = L_1_[93]["Quests"]:AddToggle({
	["Name"] = "Tự động lấy áo choàng bóng tối",
	["Description"] = "",
	["Default"] = false,
...
Q = L_1_[93]["Quests"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động mở khóa cửa Swan"
	});
	["Description"] = "cần 1 trái trên 1M beli";
	["Default"] = false;
...
Q = L_1_[93]["Quests"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động di chuyển đến người bán màu sắc Haki"
	});
	["Description"] = "Đã không còn hoạt động vì không còn người bán";
	["Default"] = false,
...
Q = L_1_[93]["Quests"]:AddToggle({
	["Name"] = "Tự động hoàn thành Nhiệm Vụ Haki vũ trang cầu vòng",
	["Description"] = "";
	["Default"] = false;
...
Q = L_1_[93]["Quests"]:AddToggle({
	["Name"] = L_1_[2]({
		"Nhận nhiệm vụ lấy Haki vũ trang cầu vòng"
	}),
...
Bartilo = L_1_[93]["Quests"]:AddToggle({
	["Name"] = L_1_[2]({
		"Hoàn thành nhiệm vụ bartilo"
	});
	["Description"] = "Up tộc V2 hoặc lên sea 3";
	["Default"] = false,
...
CitizenQ = L_1_[93]["Quests"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động hoàn thành nhiệm vụ công dân"
	});
	["Description"] = "Nhặt trái cây - một phần trong nhiệm vụ Haki quan sát V2";
	["Default"] = false;
...
SharkManV2 = L_1_[93]["Quests"]:AddToggle({
	["Name"] = "Tự động lấy Karate cá mập",
	["Description"] = "",
	["Default"] = false;
...
SanguineArt = L_1_[93]["Quests"]:AddToggle({
	["Name"] = "Tự động mua Huyết Quỷ Thật",
	["Description"] = "Không bao gồm đánh Leviathan",
	["Default"] = false,
...
L_1_[93]["Race"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động di chuyển đến đảo bí ẩn"
	}),
	["Description"] = "";
	["Default"] = false,
...
L_1_[93]["Race"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động di chuyển đến nơi cao nhất"
	});
	["Description"] = "";
	["Default"] = false,
...
L_1_[93]["Race"]:AddToggle({
	["Name"] = L_1_[2]({
		"Dịch chuyển đến người bán trái ác quỷ trên đảo bí ẩn"
	}),
	["Description"] = "",
	["Default"] = false;
...
L_1_[93]["Race"]:AddButton({
	["Name"] = "Trò Chuyện Với Tảng Đá",
	["Description"] = "Tảng đá trên Pháo Đài - Up tộc V4";
	["Callback"] = function()
...
L_1_[93]["Race"]:AddToggle({
	["Name"] = "Nhìn Mặt trăng và bật tộc V3";
	["Description"] = "Có đảo bí ẩn, có tộc V3, đứng ở vị trí cao nhất trên đảo",
	["Default"] = false,
...
RaceMink = L_1_[93]["Race"]:AddToggle({
	["Name"] = "Tự động nâng tộc thỏ",
	["Description"] = "Chọn gear phù hợp cho tộc",
	["Default"] = false;
...
RaceSky = L_1_[93]["Race"]:AddToggle({
	["Name"] = "Tự động nâng tộc thiên thần",
	["Description"] = "Chọn gear phù hợp cho tộc",
	["Default"] = false,
...
PullLv = L_1_[93]["Race"]:AddToggle({
	...
	["Description"] = "Chỉ gạt cần sau khi đã nhặt gear";
	["Default"] = false;
...
Train = L_1_[93]["Race"]:AddToggle({
	...
	["Description"] = "Nhiệm vụ mua gear up v4";
	["Default"] = false;
...
L_1_[93]["Race"]:AddButton({
	["Name"] = L_1_[2]({
		"Dịch Chuyển đến ngôi đền thời gian";
	});
	["Description"] = "";
	["Callback"] = function()
		local L_1072_ = {}
...
L_1_[93]["Race"]:AddButton({
	["Name"] = L_1_[2]({
		"Dịch chuyển đến quả cầu cổ đại";
	});
	["Description"] = "Quả cầu đỏ mua gear up V4";
	["Callback"] = function()
		local L_1074_ = {}
...
L_1_[93]["Race"]:AddButton({
	["Name"] = L_1_[2]({
		"Dịch chuyển đến đồng hồ cổ đại",
	}),
	["Description"] = "Chọn gear sau khi hoàn thành trial";
	["Callback"] = function()
		local L_1076_ = {}
...
Doors = L_1_[93]["Race"]:AddToggle({
	["Name"] = L_1_[2]({
		"Dịch chuyển đến cổng tộc"
	}),
	["Description"] = "Di chuyển đến cửa tộc của bạn",
	["Default"] = false;
...
Trials = L_1_[93]["Race"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động hoàn thành nhiệm vụ trial"
	["Description"] = "Thỏ, Cá, Người, Thiên Thần, Quỷ, Người Máy",
	["Default"] = false;
...
AutoKill = L_1_[93]["Race"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động giết người chơi Trial"
	});
	["Description"] = "Áp dụng cho 6 tộc - trừ draco",
	["Default"] = false,
...
L_1_[93]["Prehistoric"]:AddButton({
	["Title"] = L_1_[2]({
		"Dịch chuyển đến Võ Đường Tộc Rồng";
	});
	["Callback"] = function()
...
BlazeEM = L_1_[93]["Prehistoric"]:AddToggle({
	["Name"] = "Hoàn thành nhiệm vụ thợ săn Blaze Ember",
	["Description"] = "",
	["Default"] = false,
...
Toggle = L_1_[93]["Prehistoric"]:AddToggle({
	["Name"] = L_1_[2]({
		"Di chuyển đến nới gắn gear"
	}),
	["Description"] = "Tương tự như đồng hồ cổ đại";
	["Default"] = false;
...
Toggle = L_1_[93]["Prehistoric"]:AddToggle({
	["Name"] = "Tự động nâng tộc Draco (V1)";
	["Description"] = "";
	["Default"] = false;
...
fireflower = L_1_[93]["Prehistoric"]:AddToggle({
	["Name"] = "Tự động nâng tộc Draco (V2)";
	["Description"] = "";
	["Default"] = false;
...
Toggle = L_1_[93]["Prehistoric"]:AddToggle({
	["Name"] = "Tự động nâng tộc Draco (V3)";
	["Description"] = "",
	["Default"] = false;
...
Toggle = L_1_[93]["Prehistoric"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động thắp đèn trial tộc [Thử Nghiệm]"
	});
	["Description"] = "Vì là bản thử nghiệm nên sẽ có thể bị lỗi";
	["Default"] = false;
...
dragoTpVolcano = L_1_[93]["Prehistoric"]:AddToggle({
	["Name"] = L_1_[2]({
		"Dịch chuyển đến nơi thức tỉnh tộc rồng"
	}),
	["Description"] = "";
	["Default"] = false,
...
L_1_[93]["Prehistoric"]:AddButton({
	["Name"] = "Chế Tạo Kiếm Rồng (Dragonheart)";
	["Description"] = "";
	["Callback"] = function()
		local L_1151_ = {}
		L_1151_[1] = {
...
L_1_[93]["Prehistoric"]:AddButton({
	["Name"] = L_1_[2]({
		"Chế Tạo Nam Châm Núi Lửa (Volcanic Magnet)",
	});
	["Callback"] = function()
		local L_1155_ = {}
...
L_1_[93]["Prehistoric"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động tìm đảo núi lửa"
	}),
	["Description"] = "Mua thuyền + lái thuyền";
	["Default"] = false,
...
Kaura = L_1_[93]["Prehistoric"]:AddToggle({
	["Name"] = "Đánh Tầm xa";
	["Description"] = "Giết quái xung quanh ngay lập tức",
	["Default"] = false;
...
Toggle = L_1_[93]["Prehistoric"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động hoàn thành đảo núi lửa"
	}),
	["Description"] = "";
	["Default"] = false;
...
L_1_[93]["SeaEvent"]:AddToggle({
	["Name"] = "Tự động nhấn W ( di chuyển đến trước )",
	["Default"] = false;
...
L_1_[93]["SeaEvent"]:AddToggle({
	["Name"] = "Thuyền đi xuyên tường - xuyên đá",
	["Default"] = false;
...
L_1_[93]["SeaEvent"]:AddButton({
	["Name"] = "Chế Tạo Vòng Cổ Răng Cá mập (SharkTooth)";
	["Description"] = "";
	["Callback"] = function()
		local L_1226_ = {}
		L_1226_[1] = {
...
L_1_[93]["SeaEvent"]:AddButton({
	["Name"] = "Chế Tạo Hàm Cá Mập (TerrorJaw)";
	["Description"] = "",
	["Callback"] = function()
		local L_1227_ = {}
		L_1227_[2] = {
...
L_1_[93]["SeaEvent"]:AddButton({
	["Name"] = "Chế Tạo Mỏ Neo Cá Mập (SharkAnchor)";
	["Description"] = "";
	["Callback"] = function()
		local L_1228_ = {}
		L_1228_[2] = {
...
L_1_[93]["SeaEvent"]:AddButton({
	["Name"] = "Chế Tạo Vương Miệng Leviathan (LeviathanCrown)",
	["Description"] = "",
	["Callback"] = function()
		local L_1229_ = {}
		L_1229_[1] = {
...
L_1_[93]["SeaEvent"]:AddButton({
	["Name"] = L_1_[2]({
		"Chế tạo Khiên Leviathan (LeviathanShield)";
	}),
	["Description"] = "";
	["Callback"] = function()
		local L_1230_ = {}
...
L_1_[93]["SeaEvent"]:AddButton({
	["Name"] = "Chế Tạo Thuyền Leviathan (LeviathanBoat)";
	["Description"] = "";
	["Callback"] = function()
		local L_1231_ = {}
		L_1231_[1] = {
...
L_1_[93]["SeaEvent"]:AddButton({
	["Name"] = L_1_[2]({
		"Chế tạo cuộn enchant Huyền Thoại (LegendaryScrols)";
	}),
	["Description"] = "",
	["Callback"] = function()
		local L_1232_ = {}
...
L_1_[93]["SeaEvent"]:AddButton({
	["Name"] = "Chế Tạo cuộn Enchant Thần Thoại (mythicalScroll)";
	["Description"] = "";
	["Callback"] = function()
		local L_1233_ = {}
		L_1233_[1] = {
...
L_1_[93]["SeaEvent"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động đánh thuyền viên người cá"
	}),
	["Description"] = "";
	["Default"] = false;
...
L_1_[93]["SeaEvent"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động làm nhiệm vụ tàu bị đắm"
	});
	["Description"] = "",
	["Default"] = false;
...
L_1_[93]["SeaEvent"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động tìm đảo Kitsune"
	}),
	["Description"] = "Mua thuyền + ra biển 6 + Chờ Trăng Tròn";
	["Default"] = false;
...
L_1_[93]["SeaEvent"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động nhặt lửa xanh"
	});
	["Description"] = "Lửa Azure - Kitsune";
	["Default"] = false;
...
L_1_[93]["SeaEvent"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động trade lửa xanh"
	}),
	["Description"] = "Lửa Azure - Lửa Kitsune";
	["Default"] = false;
...
L_1_[93]["SeaEvent"]:AddButton({
	["Name"] = "Mua Spy ( 1500 fragments cho Leviathan )",
	["Callback"] = function()
...
L_1_[93]["SeaEvent"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động di chuyển đến đảo Leviathan"
	}),
	["Description"] = "",
	["Default"] = false;
...
L_1_[93]["Esp"]:AddToggle({
	...
	["Description"] = "Đảo leviathan, đảo cáo quỷ, đảo bí ẩn, ...",
	["Default"] = false,
...
L_1_[93]["Esp"]:AddToggle({
	["Name"] = "Định vị người bán trái đảo bí ẩn",
	["Description"] = "Có đảo Bí Ẩn mới hoạt động",
	["Default"] = false,
...
TwF = L_1_[93]["Raids"]:AddToggle({
	...
	["Description"] = "Di chuyển đến nhặt trái";
	["Default"] = false,
...
L_1_[93]["Raids"]:AddToggle({
	["Name"] = "Tự động mua trái trong cửa hàng",
	["Default"] = false;
...
L_1_[93]["Raids"]:AddToggle({
	["Name"] = L_1_[2]({
		"Lấy trái dưới 1M beli khỏi Balo"
	});
	["Default"] = false,
...
L_1_[93]["Raids"]:AddButton({
	...
	["Description"] = "Áp dụng cho raid thường";
	["Callback"] = function()
...
Raiding = L_1_[93]["Raids"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động đánh quái và đến đảo tiếp theo"
	}),
	["Description"] = "";
	["Default"] = false,
...
L_1_[93]["Raids"]:AddToggle({
	["Name"] = "Di chuyển đến phòng thí nghiệm",
	["Default"] = false,
...
L_1_[93]["Combat"]:AddToggle({
	["Name"] = L_1_[2]({
		"DI chuyển đến người chơi đã chọn"
	}),
	["Description"] = "",
	["Default"] = false;
...
L_1_[93]["Combat"]:AddToggle({
	["Name"] = L_1_[2]({
		"Xem người chơi đã chọn"
	}),
	["Description"] = "Xem ở góc nhìn của họ",
	["Default"] = false;
...
L_1_[93]["Combat"]:AddDropdown({
	["Name"] = "chọn chế độ Aim",
	["Description"] = "Ghim theo người chơi - Dùng Skill là Trúng";
	["Options"] = {
		"Aim Player",
		"Nearest Aim"
	},
...
L_1_[93]["Combat"]:AddToggle({
	["Name"] = "AimBot Kỹ năng lên người chơi",
	["Description"] = "",
	["Default"] = false;
...
L_1_[93]["Combat"]:AddToggle({
	...
	["Description"] = "Luôn để tâm theo người chơi - đánh đại cũng trúng :))";
	["Default"] = false,
...
L_1_[93]["Combat"]:AddToggle({
	["Name"] = "Tự động nhận Nhiệm Vụ giết người chơi",
	["Description"] = "",
	["Default"] = false;
...
L_1_[93]["Combat"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự động giết người chơi trong nhiệm vụ"
	});
	["Default"] = false,
...
L_1_[93]["Combat"]:AddToggle({
	["Name"] = "Tự động đến khu vực an toàn";
	["Default"] = false;
...
L_1_[93]["Combat"]:AddToggle({
	["Name"] = "Tự động chấp nhận đồng minh",
	["Description"] = "";
	["Default"] = false,
...
L_1_[93]["Shop"]:AddButton({
	["Name"] = "Mua Võ Móng Vuốt Của Rồng V2";
	["Description"] = "";
	["Callback"] = function()
...
L_1_[93]["Shop"]:AddButton({
	["Name"] = Mua Súng Hỏa Mai Đặc Biệt";
	["Description"] = "",
	["Callback"] = function()
...
L_1_[93]["Misc"]:AddButton({
	["Name"] = L_1_[2]({
		"Đổi Máy Chủ Ít Người Chơi"
	});
	["Description"] = "Phù hợp treo Farm",
	["Callback"] = function()
		local L_1681_ = {}
...
L_1_[93]["Misc"]:AddButton({
	["Name"] = L_1_[2]({
		"Đổi Máy Chủ Có Độ Trễ Thấp"
	}),
	["Description"] = "Phù Hợp cho Pvp";
	["Callback"] = function()
		local L_1685_ = {}
...
L_1_[93]["Misc"]:AddButton({
	["Name"] = "Đổi Máy Chủ Bằng Code ( Jod Id )";
	["Callback"] = function()
...
HakiStat = L_1_[93]["Misc"]:AddDropdown({
	["Name"] = "Chọn mức độ bao phủ haki Vũ Trang",
	["Options"] = HakiSt;
	["Default"] = false,
...
L_1_[93]["Misc"]:AddButton({
	["Name"] = "Thay Đổi mức độ bao phủ Haki Vũ Trang";
	["Description"] = "",
	["Callback"] = function()
...
L_1_[93]["Misc"]:AddButton({
	...
	["Description"] = "Là Giả, Chỉ mỗi bạn nhìn thấy",
	["Callback"] = function()
