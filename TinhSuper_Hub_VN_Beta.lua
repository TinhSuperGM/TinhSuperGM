...
-- ===================== BOSS =====================
local BossDisplayMap = {
	["The Gorilla King"] = "Vua Khỉ Đột",
	["Bobby"] = "Bobby",
	["The Saw"] = "Lưỡi Cưa Tử Thần",
	["Yeti"] = "Quái Tuyết",
	["Mob Leader"] = "Thủ Lĩnh Băng Đảng",
	["Vice Admiral"] = "Phó Đô Đốc",
	["Saber Expert"] = "Kiếm Sĩ Saber",
	["Warden"] = "Quản Ngục",
	["Chief Warden"] = "Trưởng Quản Ngục",
	["Swan"] = "Swan",
	["Magma Admiral"] = "Đô Đốc Dung Nham",
	["Fishman Lord"] = "Chúa Tể Người Cá",
	["Wysper"] = "Wysper",
	["Thunder God"] = "Thần Sấm",
	["Cyborg"] = "Người Máy",
	["Ice Admiral"] = "Đô Đốc Băng",
	["Greybeard"] = "Râu Xám",
	...
	["Tide Keeper"] = "Người Giữ Thủy Triều",
	["Darkbeard"] = "Râu Đen",
	["Cursed Captain"] = "Thuyền Trưởng Bị Nguyền",
	["Order"] = "Mệnh Lệnh",

	["Stone"] = "Người Đá",
	["Hydra Leader"] = "Thủ Lĩnh Hydra",
	["Kilo Admiral"] = "Đô Đốc Kilo",
	["Captain Elephant"] = "Thuyền Trưởng Voi",
	["Beautiful Pirate"] = "Hải Tặc Mỹ Nhân",
	["Cake Queen"] = "Nữ Hoàng Bánh",
	["Dough King"] = "Vua Bột",
	["Longma"] = "Long Mã",
	["Soul Reaper"] = "Tử Thần Linh Hồn",
	["rip_indra True Form"] = "Rip Indra – Dạng Thật",
...
elseif World3 then
	BossList = {
		...
		"Beautiful Pirate","Cake Queen","Dough King","Longma",
		"Soul Reaper","rip_indra True Form","Tyrant of the Skies"
	}
end

BossDisplayList = {}
for _,v in pairs(BossList) do
	table.insert(BossDisplayList, BossDisplayMap[v] or v)
end

-- ===================== MATERIAL =====================
local MaterialDisplayMap = {
	["Leather + Scrap Metal"] = "Da + Kim Loại Phế",
	["Angel Wings"] = "Cánh Thiên Thần",
	["Magma Ore"] = "Quặng Dung Nham",
	["Fish Tail"] = "Đuôi Cá",
	["Radioactive Material"] = "Vật Chất Phóng Xạ",
	["Ectoplasm"] = "Ngoại Chất",
	["Mystic Droplet"] = "Giọt Huyền Bí",
	["Vampire Fang"] = "Nanh Ma Cà Rồng",
	["Scrap Metal"] = "Kim Loại Phế",
	["Demonic Wisp"] = "Ma Linh Quỷ",
	["Conjured Cocoa"] = "Ca Cao Ma Thuật",
...
elseif World3 then
	MaterialList = {
		"Scrap Metal","Demonic Wisp","Conjured Cocoa",
...
for _,v in pairs(MaterialList) do
	table.insert(MaterialDisplayList, MaterialDisplayMap[v] or v)
end
...
L_1_[38] = L_1_[16]:MakeWindow({
	["Title"] = "TinhSuper VN Hub [Beta]";
	["SubTitle"] = "bởi TinhSuper",
...
L_1_[93]["Info"]:AddSection("Thông Tin Chính")
...
L_1_[93]["Info"]:AddSection("Trạng thái máy chủ")
	...
	pcall(function()
		while true do
			...
			if L_192_[1] ~= L_1_[77] then
				Miragecheck:SetDesc("Trạng thái: " .. L_192_[1])
				L_1_[77] = L_192_[1]
			end
		end
	end)
...
spawn(function()
	...
	while task["wait"](1) do
		...
		if L_194_[2] ~= L_193_[1] then
			Kitsunecheck:SetDesc("Trạng thái: " .. L_194_[2])
			L_193_[1] = L_194_[2]
		end
	end
end)
...
task["spawn"](function()
	...
	while task["wait"](1) do
		...
		if L_196_[1] ~= L_195_[2] then
			CPrehistoriccheck:SetDesc("Trạng thái: " .. L_196_[1])
			L_195_[2] = L_196_[1]
		end
	end
end)
...
spawn(function()
	...
	while wait(1) do
		...
		if L_198_[2] ~= L_197_[2] then
			FrozenIsland:SetDesc("Trạng thái: " .. L_198_[2])
			L_197_[2] = L_198_[2]
		end
	end
end)
MobCakePrince = L_1_[93]["Info"]:AddParagraph({
	["Title"] = "Quái Katakuri đã chết",
	["Content"] = ""
})
spawn(function()
	while wait(1) do
...
spawn(function()
	...
	while wait(1) do
		...
		if L_202_[1] ~= L_201_[2] then
			CheckRip:SetDesc("Trạng thái: " .. L_202_[1])
			L_201_[2] = L_202_[1]
		end
	end
end)
...
spawn(function()
	...
	while wait(1) do
		...
		if L_204_[2] ~= L_203_[1] then
			CheckDoughKing:SetDesc("Trạng thái: " .. L_204_[2])
			L_203_[1] = L_204_[2]
		end
	end
end)
...
spawn(function()
	...
	while wait(1) do
		...
		if L_206_[3] ~= L_205_[1] then
			EliteHunter:SetDesc("Trạng thái: " .. (L_206_[3] .. (" | Đã giết: " .. L_206_[1])))
			L_205_[1] = L_206_[3]
		end
	end
end)
...
spawn(function()
	...
	while wait(1) do
		local L_209_ = {}
		L_209_[1] = L_1_[2]({
			"Không tìm thấy kiếm huyền thoại",
		})
...
local WeaponDropdown = L_1_[93]["Main"]:AddDropdown({
	["Name"] = "Chọn vũ khí",
	["Options"] = {
		"Cận chiến";
		"Kiếm";
...
local AttackDropdown = L_1_[93]["Main"]:AddDropdown({
	...
	["Callback"] = function(Value)
		local VNtoEN = {
			["Đánh thường"] = "Normal Attack",
			["Đánh nhanh"] = "Fast Attack",
			["Đánh siêu nhanh"] = "Super Fast Attack",
			["Đánh TinhSuper"] = "TinhSuper Attack"
		}

		_G.FastAttackTinhSuper_Mode = VNtoEN[Value]
	end
})
...
spawn(function()
	while task.wait(0.1) do
		pcall(function()
			if _G.FastAttackTinhSuper_Mode
				and AttackDelay[_G.FastAttackTinhSuper_Mode] then
				_G.Fast_Delay = AttackDelay[_G.FastAttackTinhSuper_Mode]
			end
		end)
	end
end)
...
local FarmLevel = L_1_[93]["Main"]:AddToggle({
	["Name"] = "Tự động cày cấp",
	["Description"] = "Tự động nhận nhiệm vụ và đánh quái theo level",
	["Default"] = false,
	["Callback"] = function(Value)
		_G.Level = Value
		if not Value then
	...
	while task.wait(Sec) do
		if _G.Level then
			pcall(function()
				...
				local inIsland = CheckSubmergedIsland()
				local questGui = plr.PlayerGui.Main.Quest
				local questTitle = questGui.Visible and questGui.Container.QuestTitle.Title.Text or ""

				if level >= 2600 and (not inIsland and not isTeleporting and not isInSea3) then
					isTeleporting = true
					local tpCFrame = CFrame.new(
						-16269.7041, 25.2288494, 1373.65955,
						0.997390985, 0, -0.0721890926,
						0, 1, 0,
						0.0721890852, 0, 0.997390926
					)
					...
					repeat
						...
						count += 1
					until not _G.Level
						or (hrp.Position - tpCFrame.Position).Magnitude <= 8
						or count > 20
					...
					repeat
						task.wait(0.5)
					until CheckSubmergedIsland()
						or tick() - startTick > 15
						or not _G.Level
...
local ClosetMons = L_1_[93]["Main"]:AddToggle({
	["Name"] = "Tự động đánh quái gần nhất",
	["Description"] = "Tự động tấn công quái ở gần bạn nhất",
	["Default"] = false,
	["Callback"] = function(Value)
...
local FactoryRaids = L_1_[93]["Main"]:AddToggle({
	["Name"] = "Tự động đánh Factory Raid",
	["Description"] = "Tự động tham gia và tiêu diệt Factory Core",
	["Default"] = false,
	["Callback"] = function(Value)
...
local CastleRaids = L_1_[93]["Main"]:AddToggle({
	["Name"] = "Tự động Raid Hải tặc",
	["Description"] = "Tự động tiêu diệt quái tại lâu đài Pirate",
	["Default"] = false,
	["Callback"] = function(Value)
			...
			pcall(function()
				...
				if (CFrame.new(-5539.3115234375, 313.80053710938, -2972.3723144531).Position - Root.Position).Magnitude <= 500 then
					...
					for i = 1, #EnemyList do
						if replicated:FindFirstChild(EnemyList[i]) then
							for _, v in pairs(replicated:GetChildren()) do
								if table.find(EnemyList, v.Name) then
									_tp(CastleTP)
								end
							end
						end
...
local Ecto = L_1_[93]["Main"]:AddToggle({
	["Name"] = "Tự động farm Ectoplasm",
	["Description"] = "Tự động đánh quái rơi Ectoplasm",
	["Default"] = false,
	["Callback"] = function(Value)
	...
	while wait(Sec) do
		pcall(function()
			if _G.AutoEctoplasm then
				...
				local Enemy = GetConnectionEnemies(TargetList)
...
ChestBP = L_1_[93]["Main"]:AddToggle({
	["Name"] = "Tự động nhặt rương TP";
	["Description"] = "Dễ ăn band từ 1 ngày đến 1 năm",
	["Default"] = false;
...
local mobDisplayMap = {
	...
	["Pirate"] = "Cướp Biển",
	["Brute"] = "Tên Đầu Gấu",
	["Desert Bandit"] = "Kẻ Cướp Vùng Sa Mạc",
	["Desert Officer"] = "Ủy Viên Sa Mạc",
	["Snow Bandit"] = "Băng Cướp Tuyết",
	["Snowman"] = "Người Tuyết",
	["Chief Petty Officer"] = "Phó Ủy Viên Đê Tiện",
	["Sky Bandit"] = "Kẻ Cướp Trên Không",
	["Dark Master"] = "Chúa Tể Bóng Tối",
	["Toga Warrior"] = "Chiến Binh La Mã",
	["Gladiator"] = "Đấu Sĩ La Mã",
	["Military Soldier"] = "Lính Quân Đội",
	["Military Spy"] = "Gián Điệp Quân Đội",
	["Fishman Warrior"] = "Chiến Binh Người Cá",
	["Fishman Commando"] = "Thủ Lĩnh Người Cá",
	["God's Guard"] = "Vệ Sĩ Của Chúa",
	["Shanda"] = "Người Hộ Vệ",
	["Royal Squad"] = "Biệt Đội Hoàng Gia",
	["Royal Soldier"] = "Lính Hoàng Gia",
	["Galley Pirate"] = "Hải Tặc Galley",
	["Galley Captain"] = "Đội Trưởng Galley",
	...
	["Marine Captain"] = "Đội Trưởng Hải Quân",
	["Zombie"] = "Xác Sống",
	["Vampire"] = "Ma Cà Rồng",
	["Snow Trooper"] = "Lính Mùa Đông",
	["Winter Warrior"] = "Chiến Binh Mùa Đông",
	["Lab Subordinate"] = "Nhân Viên Phòng Thí Nghiệm",
	["Horned Warrior"] = "Chiến Binh Mọc Sừng",
	["Magma Ninja"] = "Ninja Dung Nham",
	["Lava Pirate"] = "Hải Tặc Dung Nham",
	["Ship Deckhand"] = "Thủy Thủ Đoàn",
	["Ship Engineer"] = "Kỹ Sư Tàu",
	["Ship Steward"] = "Bếp Phó",
	["Ship Officer"] = "Sĩ Quan Trên Tàu",
	["Arctic Warrior"] = "Chiến Binh Băng Giá",
	["Snow Lurker"] = "Kẻ Ẩn Nấp Trong Tuyết",
	["Sea Soldier"] = "Thủy Binh",
	["Water Fighter"] = "Võ Sĩ Thủy Quyền",

	["Pirate Millionaire"] = "Triệu Phú Cướp Biển",
	["Dragon Crew Warrior"] = "Chiến Binh Long Tộc",
	["Dragon Crew Archer"] = "Cung Thủ Long Tộc",
	["Female Islander"] = "Phụ Nữ Trên Đảo",
	["Giant Islander"] = "Người Khổng Lồ Trên Đảo",
	["Marine Commodore"] = "Đại Tá Hải Quân",
	["Marine Rear Admiral"] = "Tân Đô Đốc Hải Quân",
	["Fishman Raider"] = "Lính Đột Kích Người Cá",
	["Fishman Captain"] = "Thuyền Trưởng Người Cá",
	["Forest Pirate"] = "Sơn Tặc",
	["Mythological Pirate"] = "Hải Tặc Huyền Bí",
	["Jungle Pirate"] = "Lâm Tặc",
	["Musketeer Pirate"] = "Ngự Lâm Tặc",
	["Reborn Skeleton"] = "Ma Xương Tái Sinh",
	["Living Zombie"] = "Xác Sống",
	["Demonic Soul"] = "Quỷ Linh",
	["Posessed Mummy"] = "Xác Ướp Quỷ Ám",
	["Peanut Scout"] = "Lính Đậu Phộng",
	["Peanut President"] = "Tổng Thống Đậu Phộng",
	["Ice Cream Chef"] = "Đầu Bếp Kem",
	["Ice Cream Commander"] = "Tư Lệnh Kem",
	["Cookie Crafter"] = "Thợ Làm Bánh Quy",
	["Cake Guard"] = "Lính Gác Bánh Ngọt",
	["Baking Staff"] = "Nhân Viên Làm Bánh",
	["Head Baker"] = "Bếp Trưởng",
	["Cocoa Warrior"] = "Chiến Binh Ca Cao",
	["Chocolate Bar Battle"] = "Đấu Sĩ Sô-cô-la",
	["Sweet Thief"] = "Hải Tặc Kẹo Ngọt [2350]",
	["Candy Rebel"] = "Phiến Quân Kẹo",
	["Candy Pirate"] = "Hải Tặc Kẹo Ngọt [2400]",
	["Snow Demon"] = "Quỷ Tuyết",
	["Isle Outlaw"] = "Kẻ Ngoài Vòng Pháp Luật",
	["Island Boy"] = "Chàng Trai Trên Đảo",
	["Sun-kissed Warrior"] = "Chiến Binh Mặt Trời",
	["Isle Champion"] = "Nhà Vô Địch Đảo Tiki"
}

local function BuildDropdown(worldMobList)
	local optionsVN = {}
	local reverse = {}

	for _, mobEN in ipairs(worldMobList) do
		local vn = mobDisplayMap[mobEN] or mobEN
...
L_1_[93]["Main"]:AddSection({
	"Đánh quái ở tất cả đảo"
})

local islandDisplayMap = {
	["Pirates"] = "Đảo Khởi Đầu Hải Tặc",
	["Marine"] = "Đảo Khởi Đầu Hải Quân",
	["Jungle"] = "Rừng",
	["Pirate Village"] = "Làng Hải Tặc",
	["Desert"] = "Sa Mạc",
	["Frozen Village"] = "Ngôi Làng Băng Giá",
	["Marine Fortress"] = "Pháo Đài Hải Quân",
	["Skylands Lower"] = "Đảo Trời (Thấp)",
	["Prison"] = "Nhà Tù",
	["Colosseum"] = "Đấu Trường",
	["Magma Village"] = "Làng Dung Nham",
	["Underwater City"] = "Thành Phố Dưới Nước",
	["Skylands Upper"] = "Đảo Trời (Cao)",

	["Kingdom of Rose"] = "Vương Quốc Hoa Hồng",
	["Green Zone"] = "Khu Vực Xanh",
	["Graveyard Island"] = "Đảo Nghĩa Địa",
	["Snow Mountain"] = "Núi Tuyết",
	["Hot and Cold (Cold)"] = "Nóng & Lạnh (Lạnh)",
	["Hot and Cold (Hot)"] = "Nóng & Lạnh (Nóng)",
	["Cursed Ship"] = "Tàu Bị Nguyền Rủa",
	["Ice Castle"] = "Lâu Đài Băng",
	["Forgotten Island"] = "Hoàng Đảo Bị Lãng Quên",

	["Port Town"] = "Thị Trấn Cảng",
	["Hydra Island"] = "Đảo Hydra",
	["Great Tree"] = "Cây Đại Thụ",
	["Floating Turtle"] = "Đảo Rùa",
	["Haunted Castle"] = "Lâu Đài Ma Ám",
	["Sea of Treats"] = "Biển Kẹo Ngọt",
	["Tiki Outpost"] = "Doanh Trại Tiki",
	["Submerged Island"] = "Thành Phố Dưới Biển"
}

local function BuildIslandDropdown(islands)
	local optionsVN = {}
	local reverse = {}

	for _, islandEN in ipairs(islands) do
		local vn = islandDisplayMap[islandEN] or islandEN
		table.insert(optionsVN, vn)
		reverse[vn] = islandEN
	end
...
if World1 then
	local opts, rev = BuildIslandDropdown({
		...
		"Frozen Village","Marine Fortress","Skylands Lower",
		"Prison","Colosseum","Magma Village",
		"Underwater City","Skylands Upper"
	})
...
if World2 then
	local opts, rev = BuildIslandDropdown({
		...
		"Snow Mountain","Hot and Cold (Cold)","Hot and Cold (Hot)",
...
Process = L_1_[93]["Main"]:AddParagraph({
	["Title"] = "Số Elite đã tiêu diệt được";
	["Content"] = ""
})
spawn(function()
	while wait(Sec) do
		pcall(function()
			Process:SetDesc("Số Elite đã tiêu diệt :  " .. L_1_[18]["Remotes"]["CommF_"]:InvokeServer("EliteHunter", "Progress"))
		end)
	end
end)
...
spawn(function()
	...
	while wait(1) do
		...
		if L_426_[3] ~= L_425_[2] then
			EliteHunter:SetDesc("Trạng Thái: " .. (L_426_[3] .. (" | Killed: " .. L_426_[1])))
			L_425_[2] = L_426_[3]
		end
	end
end)
...
spawn(function()
	while wait(.2) do
		pcall(function()
			...
			if L_479_[1] then
				MobKilled:SetDesc(" Đã giết: " .. 500 - L_479_[1])
			end
		end)
	end
end)
Cake = L_1_[93]["Main"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự Động Cày Hoàng Tử B",
		"ột"
	}),
	["Description"] = "Đánh Quái + Kill Hoàng Tử Bột",
	["Default"] = false,
...
DouD = L_1_[93]["Main"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự Động Mở Khóa Chip ra";
		"id Bột"
	}),
	["Description"] = "Làm Tất Cả";
	["Default"] = false;
...
spawn(function()
	while wait(.2) do
		pcall(function()
			CheckingBone:SetDesc(" Xương Hiện tại: " .. GetM("Bones"))
		end)
	end
end)
L_1_[93]["Main"]:AddToggle({
...
L_1_[93]["Main"]:AddToggle({
	["Name"] = "Tự Động Đánh Sứ Giả Tử Thần",
...
RanBone = L_1_[93]["Main"]:AddToggle({
	["Name"] = "Tự Động Đổi Xương - Random Xương",
	["Description"] = "",
	["Default"] = false;
...
task["spawn"](function()
	...
	while task["wait"](1) do
		...
		EyeStatus:SetDesc("Mắt: " .. (L_535_[1] .. "/4"))
...
FarmTyrant = L_1_[93]["Main"]:AddToggle({
	...
	["Description"] = "Cày Thêm Quái Nếu Chưa Đủ Mắt",
	["Default"] = false,
...
Test = L_1_[93]["Main"]:AddDropdown({
	...
	["Description"] = "",
	["Options"] = MaterialDisplayList,
	["Default"] = false,
	["Callback"] = function(L_562_arg0)
		-- Map ngược VN -> EN
		for i, v in pairs(MaterialDisplayMap) do
			if v == L_562_arg0 then
...
Toggle = L_1_[93]["Main"]:AddToggle({
	["Name"] = "Tự động farm nguyên liệu",
	["Description"] = "",
	["Default"] = false,
	["Callback"] = function(L_564_arg0)
		(getgenv())["AutoMaterial"] = L_564_arg0
	end
})
spawn(function()
	local L_566_ = {}
	...
	L_566_[1] = function(L_567_arg0, L_568_arg1)
		if L_567_arg0:FindFirstChild("Humanoid")
			and L_567_arg0:FindFirstChild("HumanoidRootPart")
			and L_567_arg0.Humanoid.Health > 0
			and L_567_arg0.Name == L_568_arg1 then
			...
			until not (getgenv())["AutoMaterial"]
				...
				or L_567_arg0.Humanoid.Health <= 0
		end
	end
		...
		if (getgenv())["AutoMaterial"] then
			pcall(function()
				if (getgenv())["SelectMaterial"] then
					MaterialMon((getgenv())["SelectMaterial"]) -- NHẬN TIẾNG ANH
					_tp(MPos)
				end
				for _, mob in ipairs(MMon) do
					for _, enemy in pairs(workspace.Enemies:GetChildren()) do
						L_566_[1](enemy, mob)
					end
				end
...
BossDropdown = L_1_[93]["Main"]:AddDropdown({
	["Name"] = "Chọn Boss",
	["Description"] = "",
	["Options"] = BossDisplayList,
	["Default"] = false,
	["Callback"] = function(L_582_arg0)
		for i, v in pairs(BossDisplayMap) do
			if v == L_582_arg0 then
				_G["FindBoss"] = i
				break
			end
		end
...
L_1_[93]["Main"]:AddSection({
	"Tự động cày thông thạo"
})

local MasteryIslandList = {
	"Cake",
	"Bone"
}

local MasteryIslandDisplayMap = {
	["Cake"] = "Biển Kẹo Ngọt - Farm Katakuri",
	["Bone"] = "Lâu Đài Bóng Tối - Farm Xương"
}

local MasteryIslandDisplayList = {}
for _, v in pairs(MasteryIslandList) do
	table.insert(MasteryIslandDisplayList, MasteryIslandDisplayMap[v] or v)
end

L_1_[74] = L_1_[93]["Main"]:AddDropdown({
	["Name"] = "Chọn đảo farm",
	["Description"] = "",
	["Options"] = MasteryIslandDisplayList,
	["Default"] = false,
	["Callback"] = function(L_604_arg0)
		for en, vn in pairs(MasteryIslandDisplayMap) do
			if vn == L_604_arg0 then
				SelectIsland = en
				break
			end
		end
...
L_1_[137] = L_1_[93]["Main"]:AddToggle({
	["Name"] = "Tự Động Cày Thông Thạo Trái Blox";
	["Description"] = "",
	["Default"] = false,
...
L_1_[93]["Settings"]:AddDropdown({
	["Name"] = "Số Lượng Quái Được Gom",
	["Description"] = "Tối Đa Quái";
	["Default"] = "6",
	["Options"] = {
		"2";
		"3";
...
BusuAura = L_1_[93]["Settings"]:AddToggle({
	["Name"] = "Tự Động Bật Haki Vũ Trang",
	["Description"] = "",
	["Default"] = true;
...
L_1_[93]["Settings"]:AddSlider({
	["Name"] = "Điều Chỉnh Độ Cao Khi Nhảy",
	["Min"] = 50;
	["Max"] = 500,
...
Byp = L_1_[93]["Settings"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự Động Dịch Chuyển Bằng R";
		"eset"
	}),
	["Description"] = "Dễ Bị Kick hoặc Khó thành Công",
	["Default"] = false,
...
SafeModes = L_1_[93]["Settings"]:AddToggle({
	["Name"] = "Chế Độ Hoảng Loạn";
	["Description"] = "Chịu, dell biết ý nghĩa",
	["Default"] = false,
...
local RodOptions = {
	["Cần Câu Thường"] = "Fishing Rod",
	["Cần Câu Vàng"] = "Gold Rod",
	["Cần Câu Cá Mập"] = "Shark Rod",
	["Cần Câu Vỏ Sò"] = "Shell Rod",
	["Cần Câu Kho Báu"] = "Treasure Rod"
}
local BaitOptions = {
	["Mồi Thường"] = "Basic Bait",
	["Mồi Rong Biển"] = "Kelp Bait",
	["Mồi Tốt"] = "Good Bait",
	["Mồi Vực Sâu"] = "Abyssal Bait",
	["Mồi Băng"] = "Frozen Bait",
	["Mồi Hiếm"] = "Epic Bait",
	["Mồi Ăn Thịt"] = "Carnivore Bait"
}
L_1_[93]["Fish"]:AddDropdown({
	...
	["Default"] = "Cần Câu Thường",
	["Callback"] = function(v)
		_G["SelectedRod"] = RodOptions[v]
	end
})
L_1_[93]["Fish"]:AddDropdown({
	["Name"] = "Chọn Mồi Câu",
...
-- Toggle tự động mua mồi
L_1_[93]["Fish"]:AddToggle({
...
FishingQ = L_1_[93]["Fish"]:AddToggle({
	["Name"] = "Tự Động Nhận Nhiệm Vụ Câu Cá",
	["Description"] = "";
	["Default"] = false;
...
QuestToggle = L_1_[93]["Fish"]:AddToggle({
	["Name"] = "Tự Động hoàn Thành Nhiệm Vụ Câu Cá";
	["Description"] = "";
	["Default"] = false;
...
TravelDress = L_1_[93]["Quests"]:AddToggle({
	["Name"] = "Hoàn Thành Nhiệm Vụ Lên Sea 2";
	["Description"] = "",
	["Default"] = false;
...
Zou = L_1_[93]["Quests"]:AddToggle({
	["Name"] = "Hoàn Thành Nhiệm Vụ Lên Sea 3";
	["Description"] = "",
	["Default"] = false;
...
L_1_[93]["Quests"]:AddSection({
	"Đàn Guitar Đầu Lâu/ Đồ Linh Tinh"
})
CheckSoul = L_1_[93]["Quests"]:AddParagraph({
	["Title"] = L_1_[2]({
		"Nhiệm Vụ Lấy Đàn Guit",
		"ar Đầu Lâu"
	}),
	["Content"] = "Skull Guitars"
})
spawn(function()
	while wait(.2) do
		pcall(function()
			...
			elseif GetWP("Skull Guitar") then
				CheckSoul:SetDesc(L_1_[2]({
					"Nhiệm Vụ Cần Làm: Cần ";
					"Mua Để Sỡ Hữu"
				}))
			else
				CheckSoul:SetDesc(L_1_[2]({
					"Nhiệm Vụ Cần Làm: Đã S";
					"ỡ Hữu! Không Còn Nhiệm Vụ"
				}))
			end
		end)
	end
...
L_1_[93]["Quests"]:AddToggle({
	["Name"] = "Tự Động Hoàn Thành Nhiệm Vụ Skull Guitars",
	["Description"] = "Có Trăng Tròn",
	["Default"] = false,
...
L_1_[93]["Quests"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự Động Cày Thông Thạ";
		"o Đàn Guitar Đầu lâu"
	}),
	["Description"] = "",
	["Default"] = false;
...
L_1_[93]["Quests"]:AddSection({
	"Nhiệm Vụ Song Kiếm Nguyền Rủa (CDK)"
})
...
Q = L_1_[93]["Quests"]:AddToggle({
	["Name"] = "Hoàn Thành Nhiệm Vụ Kiếm Yama",
	["Description"] = "";
	["Default"] = false;
...
Q = L_1_[93]["Quests"]:AddToggle({
	["Name"] = "Hoàn Thành Nhiệm Vụ Kiếm Tushita";
	["Description"] = "";
	["Default"] = false;
...
Q = L_1_[93]["Quests"]:AddToggle({
	["Name"] = "Tự Động Lấy Pole V2 [Thử Nghiệm]";
	["Description"] = "Một Số Chức Năng có thể bị lỗi hoặc không hoạt động",
	["Default"] = false;
...
Q = L_1_[93]["Quests"]:AddToggle({
	...
	["Description"] = "Chỉ Bỏ Chip Và Mua Tộc";
	["Default"] = false;
...
Q = L_1_[93]["Quests"]:AddToggle({
	["Name"] = "Tự Động Nâng Cấp Bisento V2";
	["Description"] = "",
	["Default"] = false;
...
Q = L_1_[93]["Quests"]:AddToggle({
	["Name"] = "Tự Động Lấy Áo CHoàng Thiên Nga";
	["Description"] = "Đánh Swan đảo Nhà Tù",
	["Default"] = false,
...
Q = L_1_[93]["Quests"]:AddToggle({
	...
	["Description"] = "Đánh Đô Đốc Băng Thức Tỉnh",
	["Default"] = false,
...
Q = L_1_[93]["Quests"]:AddToggle({
	["Name"] = "Tự Động Mở Khóa",
	["Description"] = "Chỉ Khi Có Chìa Khóa",
	["Default"] = false,
...
Q = L_1_[93]["Quests"]:AddToggle({
	["Name"] = "Tự Động Lấy Áo Choàng Đen";
	["Description"] = "",
	["Default"] = false;
...
Q = L_1_[93]["Quests"]:AddToggle({
	["Name"] = "Tự Động Lấy Kiếm Bóng Đêm";
	["Description"] = "";
	["Default"] = false,
...
Q = L_1_[93]["Quests"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự Động Mở Khóa Cửa Do",
		"nSwan"
	});
	["Description"] = "Cần một trái trên 1M beli";
	["Default"] = false;
...
L_1_[93]["Quests"]:AddSection({
	"Haki Vũ Trang Sắc Màu"
})
Q = L_1_[93]["Quests"]:AddToggle({
	["Name"] = L_1_[2]({
		"Dịch Chuyển Đến Người Ph";
		"a Màu Sắc"
	});
	["Description"] = "";
	["Default"] = false,
...
L_1_[93]["Quests"]:AddSection({
	L_1_[2]({
		"Haki Quan Sát / Haki Quan S";
		"át Cấp Cao (V2)"
	})
})
Q = L_1_[93]["Quests"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự Động Farm Điểm Né H",
		"aki"
	}),
	["Description"] = "";
	["Default"] = false,
...
Q = L_1_[93]["Quests"]:AddToggle({
	["Name"] = "Tự Động Nâng Haki Quan Sát V2";
	["Description"] = "",
	["Default"] = false,
...
Bartilo = L_1_[93]["Quests"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự Động Hoàn Thành Nhiệ";
		"m vụ Bartilo"
	});
	["Description"] = "Cần Cấp 850+";
	["Default"] = false,
...
CitizenQ = L_1_[93]["Quests"]:AddToggle({
	["Name"] = L_1_[2]({
		"Hoàn Thành Nhiệm Vụ Côn";
		"g Dân"
	});
	["Description"] = "Một Phần Trong Tiến Trình Lấy Haki Quan Sát V2";
	["Default"] = false;
...
Q = L_1_[93]["Quests"]:AddToggle({
	["Name"] = "Tự Động Đánh Hình Nộm huấn Luyện";
	["Description"] = "";
	["Default"] = false,
...
spawn(function()
	while wait(.2) do
		pcall(function()
			...
			moon = Getmoon()
			if moon == moon1 then
				FullMOOn:SetDesc("Trăng : 0 / 8")
			elseif moon == moon2 then
				FullMOOn:SetDesc("Trăng : 1 / 8")
			elseif moon == moon3 then
				FullMOOn:SetDesc("Trăng : 2 / 8")
			...
			elseif moon == moon7 then
				FullMOOn:SetDesc("Trăng : 6 / 8")
			elseif moon == moon8 then
				FullMOOn:SetDesc("Trăng : 7 / 8")
			end
		end)
	end
end)
...
L_1_[93]["Race"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự Động Di Chuyển Đến Người Bán Tr";
		"ái Blox Trên Đảo"
	}),
	["Description"] = "",
	["Default"] = false;
...
L_1_[93]["Race"]:AddButton({
	...
	["Description"] = "Đá Trên Pháo Đài - Up tộc V4";
	["Callback"] = function()
...
L_1_[93]["Race"]:AddToggle({
	["Name"] = "Khóa Mặt Trăng + Bật Tộc V3";
	["Description"] = "",
	["Default"] = false,
...
CheckTier = L_1_[93]["Race"]:AddParagraph({
	["Title"] = " Bánh Răng V4 hiện có ";
	["Content"] = ""
})
spawn(function()
	pcall(function()
		while wait(.2) do
			CheckTier:SetDesc(" Bánh Răng - V4  :" .. (" " .. L_1_[45]["Data"]["Race"]["C"]["Value"]))
		end
	end)
end)
PullLv = L_1_[93]["Race"]:AddToggle({
	["Name"] = "Tự Động Gạt Cần",
	["Description"] = "Đã Nhặt Bánh Răng";
	["Default"] = false;
...
Train = L_1_[93]["Race"]:AddToggle({
	["Name"] = "Tự Động Cày Tộc V4",
	["Description"] = "Bật Tộc + Mua Gear Để Up Tộc";
	["Default"] = false;
...
AutoKill = L_1_[93]["Race"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự Động Giết Người Chơi Cùn";
		"g Hoàn Thành Thử Thách"
	});
	["Description"] = "",
	["Default"] = false,
...
-- ===============================
-- 🚢 DANH SÁCH THUYỀN (HIỂN THỊ VI – GIÁ TRỊ EN)
-- ===============================
local BoatDisplayMap = {
	["Thuyền Vệ Binh"] = "Guardian",
	["Thuyền Đại Lữ Đoàn Hải Tặc"] = "PirateGrandBrigade",
	["Thuyền Đại Lữ Đoàn Hải Quân"] = "MarineGrandBrigade",
	["Thuyền Lữ Đoàn Hải Tặc"] = "PirateBrigade",
	["Thuyền Lữ Đoàn Hải Quân"] = "MarineBrigade",
	["Thuyền Thuyền Nhỏ Hải Tặc"] = "PirateSloop",
	["Thuyền Thuyền Nhỏ Hải Quân"] = "MarineSloop",
	["Thuyền Thợ Săn Quái Thú"] = "Beast Hunter"
}

L_1_[130] = {}
for _, v in pairs(BoatDisplayMap) do
	table.insert(L_1_[130], v) -- GIỮ NGUYÊN VALUE EN
end


-- ===============================
-- 📈 DANH SÁCH LEVEL (HIỂN THỊ VI – GIÁ TRỊ EN)
-- ===============================
local LevelDisplayMap = {
	["Cấp 1"] = "Lv 1",
	["Cấp 2"] = "Lv 2",
	["Cấp 3"] = "Lv 3",
	["Cấp 4"] = "Lv 4",
...
L_1_[89] = {}
for _, v in pairs(LevelDisplayMap) do
	table.insert(L_1_[89], v) -- GIỮ NGUYÊN VALUE EN
end
...
Q = L_1_[93]["SeaEvent"]:AddDropdown({
	...
	["Options"] = (function()
		local t = {}
		for k,_ in pairs(LevelDisplayMap) do
			table.insert(t, k) -- HIỂN THỊ VI
		end
		return t
	end)(),
	["Default"] = false,
	["Callback"] = function(v)
		_G["DangerSc"] = LevelDisplayMap[v] -- GIỮ EN
	end
})
...
Q = L_1_[93]["SeaEvent"]:AddDropdown({
	...
	["Options"] = (function()
		local t = {}
		for k,_ in pairs(BoatDisplayMap) do
			table.insert(t, k) -- HIỂN THỊ TIẾNG VIỆT
		end
		return t
	end)(),
	["Default"] = false,
	["Callback"] = function(v)
		_G["SelectedBoat"] = BoatDisplayMap[v] -- TRẢ VỀ EN
	end
})
...
L_1_[93]["Raids"]:AddSection({
	L_1_[2]({
		"Vật Phẩm Law/Kiếm Kok",
		"p"
	})
})
L_1_[93]["Raids"]:AddButton({
	["Name"] = "Mua Chip Raid Law",
	["Description"] = "";
	["Callback"] = function()
		...
		pcall(function()
			for L_1554_forvar0, L_1555_forvar1 in pairs((game:GetService("Players")):GetPlayers()) do
				...
				if L_1556_[3] == 12 then
					__indexPlayer:SetDesc("Tất Cả Người Chơi :" .. (" " .. (L_1556_[3] .. " / 12 [Đầy]")))
				elseif L_1556_[3] == 1 then
					__indexPlayer:SetDesc("Tất Cả Người Chơi  :" .. (" " .. (L_1556_[3] .. " / 12")))
				else
					__indexPlayer:SetDesc("Tất Cả Người Chơi  :" .. (" " .. (L_1556_[3] .. " / 12")))
				end
			end
...
L_1_[93]["Combat"]:AddToggle({
	["Name"] = L_1_[2]({
		"Xem Từ Góc Nhìn Của Người C";
		"hơi"
	}),
	["Description"] = "Xem Camera của người được chọn",
	["Default"] = false;
...
local AimBotOptions = {
	["AimBot Người Chơi Đã Chọn"] = "Aim Player",
	["AimBot Người Chơi Gần Nhất"] = "Nearest Aim"
}

L_1_[93]["Combat"]:AddDropdown({
	["Name"] = "Chọn chế độ AimBot",
	["Description"] = "Lựa chọn phương thức AimBot",
	["Options"] = {
		"AimBot Người Chơi Đã Chọn",
		"AimBot Người Chơi Gần Nhất"
	},
	["Default"] = false,
	["Callback"] = function(L_1566_arg0)
		ABmethod = AimBotOptions[L_1566_arg0]
	end
})
L_1_[93]["Combat"]:AddToggle({
	["Name"] = "AimBot Kỹ Năng",
...
L_1_[93]["Combat"]:AddSection({
	"Nhiệm Vụ Tiêu Diệt Người Chơi"
})
L_1_[93]["Combat"]:AddButton({
	["Name"] = "Nhận Nhiệm Vụ Tiêu Diệt Người Chơi",
	["Description"] = "";
	["Callback"] = function()
		pcall(function()
...
L_1_[93]["Combat"]:AddToggle({
	["Name"] = "Tự Động Nhận Nhiệm Vụ Tiêu Diệt Người Chơi",
	["Description"] = "",
	["Default"] = false;
...
L_1_[93]["Combat"]:AddToggle({
	["Name"] = L_1_[2]({
		"Tự Động Tiêu Diệt Người Chơi Củ";
		"a Nhiệm Vụ"
	});
	["Default"] = false,
...
L_1_[93]["Combat"]:AddToggle({
	["Name"] = "Tự Động Vào Chế Độ An Toàn";
	["Default"] = false;
...
L_1_[93]["Combat"]:AddToggle({
	["Name"] = "Tự Động Chấp Nhận Làm Đồng Minh",
	["Description"] = "";
	["Default"] = false,
...
L_1_[93]["Misc"]:AddTextBox({
	["Name"] = "Nhập id Server",
	["Placeholder"] = "Mã Nguồn ID Server",
	["ClearOnFocus"] = true;
...
L_1_[93]["Misc"]:AddButton({
	["Name"] = "Dịch Chuyển [Đến Mã Nguồn ID]";
	["Callback"] = function()
...
L_1_[93]["Misc"]:AddButton({
	["Name"] = "Sao Chép Mã Nguồn Id";
	["Description"] = "Mã Nguồn Id Của Server Bạn";
	["Callback"] = function()
		setclipboard(tostring(game["JobId"]))
	end
})
L_1_[93]["Misc"]:AddSection({
	"Giao Diện Người Chơi/ Khác"
})
L_1_[93]["Misc"]:AddButton({
	["Name"] = L_1_[2]({
		"Mở Menu Thức tỉnh Trái Bl",
		"ox"
	}),
	["Description"] = "",
	["Callback"] = function()
...
UnPortal = L_1_[93]["Misc"]:AddToggle({
	["Name"] = "Mở Khóa Tất Cả Cổng Dịch Chuyển";
	["Description"] = "",
	["Default"] = false,
...
briggt1 = L_1_[93]["Misc"]:AddToggle({
	["Name"] = "Bật Full Độ Sáng Màn Hình";
	["Description"] = "",
	["Default"] = false;
...
iceWalk = L_1_[93]["Misc"]:AddToggle({
	["Name"] = "Bật Khả Năng Đi Trên Băng",
	["Description"] = "Tạo Băng Để Di Chuyển Giống Trái Ice",
	["Default"] = false,
